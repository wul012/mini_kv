...
1. Add external control-plane smoke notes once Node consumes `KEYSJSON`.
2. Consider cursor pagination only after bounded `KEYSJSON` is consumed and real key volumes need it.
