...
4. Let Java v65 and mini-kv v74 progress in parallel on rollback approver and restore approval boundary fixtures before Node v182 rehearses the release approval decision packet.
5. Let Node v182 wait for Node v181, Java v65, and mini-kv v74, then generate the release approval decision rehearsal packet without writing the real ledger or executing release/deployment/rollback/restore.
