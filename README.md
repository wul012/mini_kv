...
- Repository fixture `fixtures/release/verification-manifest.json` documents the CMake configure/build, CTest, read-only command smoke, fixture inventory, version evidence, rollback evidence sample, runtime artifact bundle manifest, restore compatibility handoff sample, restore dry-run operator package, artifact digest compatibility matrix, and release artifact digest package expected before Node v170 consumes mini-kv deployment evidence intake
...
5. Let Node v172 wait for Java v61, mini-kv v70, and Node v171, then create the release window readiness packet.
