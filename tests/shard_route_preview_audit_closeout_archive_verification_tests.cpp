...
int main() {
    ...
    assert_contains(
        archive_verification,
        "\"archiveVerificationStage\":\"route-preview-verification-report-archive-closeout-verification-audit-closeout-archive-verification-java-echo-audit\"");
    assert_contains(archive_verification, "\"archiveVerificationStageSequence\":15");
    assert_contains(archive_verification, "\"archiveVerificationReleaseVersion\":\"v455\"");
    assert_contains(archive_verification, "\"publishedStageCount\":15");
    assert_contains(archive_verification, "\"plannedStageCount\":20");
    assert_contains(archive_verification, "\"sourceFrozenReleaseVersion\":\"v454\"");
    assert_contains(archive_verification, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v454.json\"");
    ...
    assert(occurrence_count(
           ...
           1);
    assert_contains(shard, "\"releaseVersion\":\"v455\"");
    assert_contains(
        shard,
    ...
    assert_contains(shard, "\"archiveVerificationReleaseVersion\":\"v455\"");
