...
int main() {
    ...
    assert_contains(result.response, "\"expected_binary_provenance_digest\":\"fnv1a64:6b0e9514847a3e7a\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:e0e0fb3648c2286e\"");
