...
int main() {
    ...
    assert_contains(result.response, "\"expected_binary_provenance_digest\":\"fnv1a64:68ec9a2a032906f4\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:49eb9963647aecbe\"");
