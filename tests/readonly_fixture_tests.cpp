...
int main() {
    ...
    assert_contains(result.response, "\"expected_binary_provenance_digest\":\"fnv1a64:4be577ac4f8347c6\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:e6ffb387b375879e\"");
