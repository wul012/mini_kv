...
int main() {
    ...
    assert_contains(result.response, "\"expected_binary_provenance_digest\":\"fnv1a64:c9da016a60b4a58e\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:23741de2828676be\"");
