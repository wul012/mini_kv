...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v249\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v248\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v248.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v248\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v248.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:b001b36a42e8e809\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v549-archive-verification-alignment-audit\"");
    assert_response_contains(result, "\"stageSequence\":49");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v249\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v249\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":49");
