...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v328\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v328.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-rollout-catalog-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":10");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v329\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v328\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v328.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-rollout-catalog-audit\"");
    assert_response_contains(result, "\"stageSequence\":129");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v329\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v329\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":129");
