...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v229\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v228\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v228.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v228\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v228.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:7a4fe3614ff923cd\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v505-readiness-handoff-archive-verification-route-batch-package\"");
    assert_response_contains(result, "\"stageSequence\":29");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v229\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v229\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":29");
