...
int main() {
    ...
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-node-consumer-handoff\"");
    assert_response_contains(result, "\"rolloutStageSequence\":13");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v291\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v290\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v290.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v290\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v290.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2193962195ba633a\"");
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-node-consumer-handoff\"");
    assert_response_contains(result, "\"stageSequence\":91");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v291\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v291\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":91");
