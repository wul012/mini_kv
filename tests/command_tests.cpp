...
int main() {
    ...
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-java-echo-handoff\"");
    assert_response_contains(result, "\"rolloutStageSequence\":14");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v292\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v291\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v291.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v291\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v291.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2193962195ba633a\"");
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-java-echo-handoff\"");
    assert_response_contains(result, "\"stageSequence\":92");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v292\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v292\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":92");
