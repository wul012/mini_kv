...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v199\"");
    ...
    assert_response_contains(result, "\"status\":\"node-route-catalog-cleanup-evidence-batch-closeout-read-only\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v198\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v198.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenWindowDigest\":\"fnv1a64:8fcbe53d8b1700b7\"");
    ...
    assert_response_contains(result, "\"boundaryCatalogIndex\":{\"catalogVersion\":\"read-only-boundary-fields.v27\"");
    assert_response_contains(result, "\"sourceNodePlan\":"
                                     "\"docs/plans3/"
                                     "v480-post-java-mini-kv-route-catalog-cleanup-evidence-batch-closeout-roadmap.md\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v198\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v198.json\"");
    assert_response_contains(result, "\"fieldCount\":778");
    assert_response_contains(result, "\"groupCount\":38");
