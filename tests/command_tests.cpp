...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v172\"");
    ...
    assert_response_contains(result, "\"status\":\"node-route-split-window-restore-drill-read-only\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v171\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v171.json\"");
    ...
    assert_response_contains(result, "\"sourceNodePlan\":\"docs/plans3/"
                                     "v446-post-managed-audit-restore-drill-route-group-split-roadmap.md\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v171\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v171.json\"");
    assert_response_contains(result, "\"windowStartNodeVersion\":\"Node v433\"");
    assert_response_contains(result, "\"windowEndNodeVersion\":\"Node v446\"");
    assert_response_contains(result, "\"splitRouteGroupCount\":14");
    ...
    assert_response_contains(result, "\"expectedWindowVersionCount\":14");
    assert_response_contains(result, "\"observedWindowVersionCount\":14");
    assert_response_contains(result, "\"windowRangeStart\":\"Node v433\"");
    assert_response_contains(result, "\"windowRangeEnd\":\"Node v446\"");
    ...
    assert_response_contains(result, "\"sourceFrozenWindowDigest\":\"fnv1a64:9f6aa583ef521d1a\"");
