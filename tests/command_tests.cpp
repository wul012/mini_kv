...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v269\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v268\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v268.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v268\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v268.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:efe3aa43bc5101cc\"");
    assert_response_contains(result, "\"continuityStage\":\"maintenance-refactor-boundary-catalog-group-table-split\"");
    assert_response_contains(result, "\"stageSequence\":69");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v269\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v269\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":69");
