...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v313\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v313.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-no-router-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":16");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v314\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v313\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v313.json\"");
    ...
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-no-router-audit\"");
    assert_response_contains(result, "\"stageSequence\":114");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v314\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v314\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":114");
