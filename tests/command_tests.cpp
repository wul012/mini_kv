...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v335\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v335.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-no-write-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":17");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v336\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v335\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v335.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-no-write-audit\"");
    assert_response_contains(result, "\"stageSequence\":136");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v336\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v336\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":136");
