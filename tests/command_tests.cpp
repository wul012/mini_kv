...
int main() {
    ...
    assert(result.response.find("command_count=38") != std::string::npos);
    ...
    assert_response_contains(result, "\"verificationStage\":\"route-preview-verification-report-archive-closeout-verification-source-closeout-index-audit\"");
    assert_response_contains(result, "\"verificationStageSequence\":9");
    assert_response_contains(result, "\"verificationReleaseVersion\":\"v389\"");
    assert_response_contains(result, "\"publishedStageCount\":9");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v388\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v388.json\"");
    ...
    assert_response_contains(result, "\"archiveCloseoutVerificationChainComplete\":false");
    assert_response_contains(result, "\"filesystemReadPerformed\":false");
    assert_response_contains(result, "\"runtimeArchiveWalkAllowed\":false");
    assert_response_contains(result, "\"activeRouterInstalled\":false");
    assert_response_contains(result, "\"writeRoutingAllowed\":false");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v388\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v388.json\"");
