...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v260\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v259\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v259.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v259\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v259.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:4ecbafd95ed78ab6\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v549-final-closeout-package\"");
    assert_response_contains(result, "\"stageSequence\":60");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v260\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v260\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":60");
