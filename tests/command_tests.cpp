...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-no-router-audit\"");
    assert_response_contains(result, "\"archiveStageSequence\":16");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v356\"");
    assert_response_contains(result, "\"publishedStageCount\":16");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v355\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v355.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v355\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v355.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v355\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v355.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:34814735ed068cec\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-no-router-audit\"");
    assert_response_contains(result, "\"stageSequence\":156");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v356\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v356\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":156");
