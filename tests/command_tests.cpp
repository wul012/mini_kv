...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v214\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v213\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v213.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v213\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v213.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:81d869972aeed221\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-stage-descriptor-split\"");
    assert_response_contains(result, "\"stageSequence\":14");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v214\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v214\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":14");
