...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v330\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v330.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-operator-handoff\"");
    assert_response_contains(result, "\"rolloutStageSequence\":12");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v331\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v330\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v330.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-operator-handoff\"");
    assert_response_contains(result, "\"stageSequence\":131");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v331\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v331\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":131");
