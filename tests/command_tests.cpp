...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v261\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v260\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v260.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v260\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v260.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:f30c2273908b1a76\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v549-final-closeout-package-audit\"");
    assert_response_contains(result, "\"stageSequence\":61");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v261\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v261\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":61");
