...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v324\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v324.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-tcp-smoke-contract\"");
    assert_response_contains(result, "\"rolloutStageSequence\":6");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v325\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v324\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v324.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-tcp-smoke-contract\"");
    assert_response_contains(result, "\"stageSequence\":125");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v325\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v325\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":125");
