...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v240\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v239\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v239.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v239\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v239.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:e27115beafa3626e\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v522-ci-catalog-health-audit\"");
    assert_response_contains(result, "\"stageSequence\":40");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v240\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v240\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":40");
