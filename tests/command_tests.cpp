...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-java-echo-audit\"");
    assert_response_contains(result, "\"archiveStageSequence\":12");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v352\"");
    assert_response_contains(result, "\"publishedStageCount\":12");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v351\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v351.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v351\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v351.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v351\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v351.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:85099e82c1bad69c\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-java-echo-audit\"");
    assert_response_contains(result, "\"stageSequence\":152");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v352\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v352\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":152");
