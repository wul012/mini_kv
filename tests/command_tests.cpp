...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v203\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v202\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v202.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v202\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v202.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:cd0c634b2fc44eff\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-archive-readiness-snapshot\"");
    assert_response_contains(result, "\"stageSequence\":3");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v203\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v203\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":3");
