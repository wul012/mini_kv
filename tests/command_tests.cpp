...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v299\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v299.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-command-catalog-alignment\"");
    assert_response_contains(result, "\"rolloutStageSequence\":2");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v300\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v299\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v299.json\"");
    ...
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-command-catalog-alignment\"");
    assert_response_contains(result, "\"stageSequence\":100");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v300\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v300\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":100");
