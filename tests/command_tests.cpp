...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v253\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v252\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v252.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v252\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v252.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:e07e3351e7c4c747\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v549-latest-sibling-clean-quality-reminder-audit\"");
    assert_response_contains(result, "\"stageSequence\":53");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v253\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v253\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":53");
