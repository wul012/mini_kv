...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v252\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v251\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v251.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v251\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v251.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:6ae0e5e1c1d08de9\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v549-latest-sibling-clean-quality-reminder\"");
    assert_response_contains(result, "\"stageSequence\":52");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v252\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v252\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":52");
