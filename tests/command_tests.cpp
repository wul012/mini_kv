...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-tcp-smoke-contract\"");
    assert_response_contains(result, "\"archiveStageSequence\":15");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v355\"");
    assert_response_contains(result, "\"publishedStageCount\":15");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v354\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v354.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v354\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v354.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v354\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v354.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:f525662d1524cae5\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-tcp-smoke-contract\"");
    assert_response_contains(result, "\"stageSequence\":155");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v355\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v355\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":155");
