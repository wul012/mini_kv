...
int main() {
    ...
    assert_response_contains(result, "\"publishedStageCount\":160");
    ...
    assert_response_contains(result, "\"publishedStageCount\":161");
    ...
    assert_response_contains(result, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-boundary-field-audit\"");
    assert_response_contains(result, "\"closeoutStageSequence\":16");
    assert_response_contains(result, "\"closeoutReleaseVersion\":\"v376\"");
    assert_response_contains(result, "\"publishedStageCount\":16");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v375\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v375.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v375\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v375.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:7e37f53d1d19c6a8\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-boundary-field-audit\"");
    assert_response_contains(result, "\"stageSequence\":176");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v376\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v376\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":176");
