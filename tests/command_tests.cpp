...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v236\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v235\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v235.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v235\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v235.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:801952cee74210ef\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v522-stability-evidence-report-readiness-audit\"");
    assert_response_contains(result, "\"stageSequence\":36");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v236\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v236\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":36");
