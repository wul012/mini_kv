...
int main() {
    ...
    assert_response_contains(result, "\"session_id_echo\":\"mini-kv-live-read-v88\"");
    ...
    assert_response_contains(result, "\"source_version\":\"0.88.0\"");
    assert_response_contains(result, "\"artifact_path_hint\":\"c/88/\"");
    assert_response_contains(result, "\"runtime_binary_hint\":\"cmake-build-v88/minikv_server and cmake-build-v88/minikv_client from the current CMake build\"");
    ...
    assert_response_contains(result, "\"provenance_digest\":\"fnv1a64:f9d8030cdd14ad18\"");
    assert_response_contains(result, "\"read_only\":true");
    ...
    assert_response_contains(result, "\"expected_binary_provenance_digest\":\"fnv1a64:f9d8030cdd14ad18\"");
    assert_response_contains(result, "\"check_digest\":\"fnv1a64:1e5d51ff30deb3e4\"");
    ...
    assert_response_contains(result, "\"current_artifact_path_hint\":\"c/88/\"");
    assert_response_contains(result, "\"marker_digest\":\"fnv1a64:864ac1bef831e551\"");
    ...
    assert_response_contains(result, "\"current_artifact_path_hint\":\"c/88/\"");
    assert_response_contains(result, "\"receipt_digest\":\"fnv1a64:4135035dd3fe95d2\"");
    ...
    assert_response_contains(result, "\"receipt_digest\":\"fnv1a64:8640a9d8be7767ee\"");
    ...
    assert_response_contains(result, "\"receipt_digest\":\"fnv1a64:4aa6d12fb067e2a6\"");
    ...
    assert_response_contains(result, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.88.0\"");
    ...
    assert_response_contains(result, "\"node_consumption\":\"Node v219 may verify the mini-kv command dispatch quality receipt, the v87 managed audit adapter non-authoritative storage receipt, the v86 managed audit adapter restore boundary receipt, runtime evidence retention, binary provenance digest alignment, live-read session echo, uptime bucket, read command digest, taxonomy digest, operator-window identity-neutral proof, CI evidence hints, and artifact retention evidence before managed audit adapter implementation precheck work; mini-kv must already be running and the read-only window must be open\"");
