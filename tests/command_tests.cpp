...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v308\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v308.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-history-fallback-freeze\"");
    assert_response_contains(result, "\"rolloutStageSequence\":11");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v309\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v308\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v308.json\"");
    ...
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-history-fallback-freeze\"");
    assert_response_contains(result, "\"stageSequence\":109");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v309\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v309\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":109");
