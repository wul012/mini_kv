...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-fixture-freeze\"");
    assert_response_contains(result, "\"archiveStageSequence\":13");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v353\"");
    assert_response_contains(result, "\"publishedStageCount\":13");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v352\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v352.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v352\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v352.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v352\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v352.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:67bc128aadc1681f\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-fixture-freeze\"");
    assert_response_contains(result, "\"stageSequence\":153");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v353\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v353\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":153");
