...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v334\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v334.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-no-router-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":16");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v335\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v334\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v334.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-no-router-audit\"");
    assert_response_contains(result, "\"stageSequence\":135");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v335\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v335\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":135");
