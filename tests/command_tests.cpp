...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v250\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v249\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v249.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v249\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v249.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:04af1f491dc7c7fd\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v549-archive-verification-route-readiness-snapshot\"");
    assert_response_contains(result, "\"stageSequence\":50");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v250\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v250\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":50");
