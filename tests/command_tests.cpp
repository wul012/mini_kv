...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v244\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v243\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v243.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v243\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v243.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:bd6eca1936c424c8\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v522-downstream-consumption-handoff-audit\"");
    assert_response_contains(result, "\"stageSequence\":44");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v244\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v244\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":44");
