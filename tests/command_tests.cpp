...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v327\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v327.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-rollout-catalog\"");
    assert_response_contains(result, "\"rolloutStageSequence\":9");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v328\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v327\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v327.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-rollout-catalog\"");
    assert_response_contains(result, "\"stageSequence\":128");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v328\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v328\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":128");
