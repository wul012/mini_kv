...
int main() {
    ...
    assert(result.response.find("command_count=37") != std::string::npos);
    ...
    assert_response_contains(result, "\"publishedStageCount\":130");
    ...
    assert_response_contains(result, "\"publishedStageCount\":131");
    ...
    assert_response_contains(result, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-consumer-handoff-audit\"");
    assert_response_contains(result, "\"closeoutStageSequence\":13");
    assert_response_contains(result, "\"closeoutReleaseVersion\":\"v373\"");
    assert_response_contains(result, "\"publishedStageCount\":13");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v372\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v372.json\"");
    ...
    assert_response_contains(result, "\"archiveCloseoutChainComplete\":false");
    assert_response_contains(result, "\"filesystemReadPerformed\":false");
    assert_response_contains(result, "\"runtimeArchiveWalkAllowed\":false");
    assert_response_contains(result, "\"activeRouterInstalled\":false");
    assert_response_contains(result, "\"writeRoutingAllowed\":false");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v372\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v372.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:69cd33783dfffba4\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-consumer-handoff-audit\"");
    assert_response_contains(result, "\"stageSequence\":173");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v373\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v373\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":173");
