...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v202\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v201\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v201.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v201\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v201.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:9a3abb5ab3aaeb1c\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-source-freeze-audit\"");
    assert_response_contains(result, "\"stageSequence\":2");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v202\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v202\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":2");
