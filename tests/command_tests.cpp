...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v198\"");
    ...
    assert_response_contains(result, "\"status\":\"node-route-catalog-cleanup-latest-evidence-package-audit-read-only\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v197\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v197.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenWindowDigest\":\"fnv1a64:836d9f0b3956fe30\"");
    ...
    assert_response_contains(result, "\"boundaryCatalogIndex\":{\"catalogVersion\":\"read-only-boundary-fields.v26\"");
