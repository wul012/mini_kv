...
int main() {
    ...
    assert(result.response.find("command_count=73") != std::string::npos);
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-operator-value-supply-profile-section-integrity-closeout-summary-read-only\"");
