...
int main() {
    ...
    assert(result.response.find("command_count=35") != std::string::npos);
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v339\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v339.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v339\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v339.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2193962195ba633a\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-closeout-summary\"");
    assert_response_contains(result, "\"stageSequence\":140");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v340\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v340\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":140");
