...
int main() {
    ...
    assert_response_contains(result, "\"draftTextPackageComparisonCloseoutAuditReleaseVersion\":\"v837\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v836\"");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v836.json\"");
