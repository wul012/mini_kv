...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v314\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v314.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-no-write-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":17");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v315\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v314\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v314.json\"");
    ...
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-no-write-audit\"");
    assert_response_contains(result, "\"stageSequence\":115");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v315\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v315\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":115");
