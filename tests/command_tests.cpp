...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v234\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v233\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v233.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v233\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v233.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:ebf4eddbb67bc47b\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v522-twenty-version-run-closeout-alignment-audit\"");
    assert_response_contains(result, "\"stageSequence\":34");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v234\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v234\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":34");
