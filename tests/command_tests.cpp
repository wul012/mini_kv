...
int main() {
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v338\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v338.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-closeout-audit\"");
    assert_response_contains(result, "\"stageSequence\":139");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v339\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v339\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":139");
