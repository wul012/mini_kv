...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-archive-maintenance-shardjson-embedding-audit-read-only\"");
    ...
    assert_response_contains(result, "\"maintenanceStage\":\"route-preview-archive-maintenance-shardjson-embedding-audit\"");
    assert_response_contains(result, "\"maintenanceStageSequence\":19");
    assert_response_contains(result, "\"maintenanceReleaseVersion\":\"v479\"");
    assert_response_contains(result, "\"sharedStageCatalogFormatterApplied\":true");
