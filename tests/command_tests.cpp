...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v217\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v216\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v216.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v216\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v216.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:e4fc4c802f59ad80\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v498-consumer-readiness-handshake-package\"");
    assert_response_contains(result, "\"stageSequence\":17");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v217\"");
    assert_response_contains(result, "\"nodeBatchCloseoutVersion\":\"Node v498\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v217\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":17");
