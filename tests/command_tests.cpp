...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v151\"");
    ...
    assert_response_contains(result, "\"status\":\"operator-service-lifecycle-template-read-only\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v150\"");
    ...
    assert_response_contains(result, "\"activePrototypePlanFreeze\":{\"frozenReleaseVersion\":\"v150\"");
    ...
    assert_response_contains(result, "\"liveReadGatePlanFreeze\":{\"frozenReleaseVersion\":\"v150\"");
