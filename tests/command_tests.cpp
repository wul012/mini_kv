...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v239\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v238\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v238.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v238\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v238.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:cb420f72e2db405d\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v522-ci-catalog-health-snapshot\"");
    assert_response_contains(result, "\"stageSequence\":39");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v239\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v239\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":39");
