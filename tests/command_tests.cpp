...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-archive-maintenance-retention-map-read-only\"");
    ...
    assert_response_contains(result, "\"maintenanceStage\":\"route-preview-archive-maintenance-retention-map\"");
    assert_response_contains(result, "\"maintenanceStageSequence\":14");
    assert_response_contains(result, "\"maintenanceReleaseVersion\":\"v474\"");
    assert_response_contains(result, "\"sharedStageCatalogFormatterApplied\":true");
