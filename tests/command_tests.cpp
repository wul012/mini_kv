...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-comparison-closeout-audit-write-route-rejection-read-only\"");
    ...
    assert_response_contains(result, "\"draftTextPackageComparisonCloseoutAuditReleaseVersion\":\"v858\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v857\"");
    assert_response_contains(result, "\"publishedStageCount\":23");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v857.json\"");
