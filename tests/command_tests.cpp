...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v326\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v326.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-sample-parity-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":8");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v327\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v326\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v326.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-sample-parity-audit\"");
    assert_response_contains(result, "\"stageSequence\":127");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v327\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v327\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":127");
