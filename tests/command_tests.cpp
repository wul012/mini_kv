...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v333\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v333.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-boundary-field-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":15");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v334\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v333\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v333.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-boundary-field-audit\"");
    assert_response_contains(result, "\"stageSequence\":134");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v334\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v334\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":134");
