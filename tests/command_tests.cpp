...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v256\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v255\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v255.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v255\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v255.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:c0381228f6fd3e32\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v549-archive-files-consumption-handoff\"");
    assert_response_contains(result, "\"stageSequence\":56");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v256\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v256\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":56");
