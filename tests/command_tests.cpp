...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v277\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v276\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v276.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v276\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v276.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2800b74d61d87fd5\"");
    assert_response_contains(result, "\"continuityStage\":\"maintenance-refactor-shard-readiness-runtime-gate-section-split\"");
    assert_response_contains(result, "\"stageSequence\":77");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v277\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v277\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":77");
