...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v213\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v212\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v212.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v212\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v212.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:1649e22a22a59fd8\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-downstream-consumption-handshake\"");
    assert_response_contains(result, "\"stageSequence\":13");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v213\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v213\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":13");
