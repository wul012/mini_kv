...
int main() {
    ...
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-operator-handoff\"");
    assert_response_contains(result, "\"rolloutStageSequence\":12");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v290\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v289\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v289.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v289\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v289.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2193962195ba633a\"");
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-operator-handoff\"");
    assert_response_contains(result, "\"stageSequence\":90");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v290\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v290\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":90");
