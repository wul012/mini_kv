...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v221\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v220\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v220.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v220\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v220.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:d9ecc44211f0fe02\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v505-readiness-handoff-archive-verification-route-alignment\"");
    assert_response_contains(result, "\"stageSequence\":21");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v221\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v221\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":21");
