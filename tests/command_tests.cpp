...
int main() {
    ...
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-no-write-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":17");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v295\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v294\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v294.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v294\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v294.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2193962195ba633a\"");
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-no-write-audit\"");
    assert_response_contains(result, "\"stageSequence\":95");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v295\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v295\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":95");
