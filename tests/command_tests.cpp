...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v169\"");
    ...
    assert_response_contains(result, "\"status\":\"node-route-split-window-audit-read-only\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v168\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v168.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v168\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v168.json\"");
    assert_response_contains(result, "\"auditedWindowSection\":\"nodeRouteSplitCompatibilityWindow\"");
    assert_response_contains(result, "\"expectedWindowVersionCount\":9");
    assert_response_contains(result, "\"observedWindowVersionCount\":9");
    assert_response_contains(result, "\"windowRangeStart\":\"Node v433\"");
    assert_response_contains(result, "\"windowRangeEnd\":\"Node v441\"");
    ...
    assert_response_contains(result, "\"sourceFrozenWindowDigest\":\"fnv1a64:d0d0ef2b2a0f5a0a\"");
