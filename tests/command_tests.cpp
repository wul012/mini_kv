...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v266\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v265\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v265.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v265\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v265.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:16f6535206b72859\"");
    assert_response_contains(result, "\"continuityStage\":\"maintenance-refactor-cmake-source-dir-test-helper\"");
    assert_response_contains(result, "\"stageSequence\":66");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v266\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v266\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":66");
