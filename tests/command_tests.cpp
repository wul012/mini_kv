...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-compared-package-evidence-intake-digest-match-summary-slot-read-only\"");
    ...
    assert_response_contains(result, "\"draftTextPackageComparedPackageEvidenceIntakeAuditReleaseVersion\":\"v869\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v868\"");
    assert_response_contains(result, "\"publishedStageCount\":9");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v868.json\"");
