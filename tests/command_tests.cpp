...
int main() {
    ...
    assert_response_contains(result, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-catalog-alignment\"");
    assert_response_contains(result, "\"auditStageSequence\":2");
    assert_response_contains(result, "\"auditReleaseVersion\":\"v402\"");
    assert_response_contains(result, "\"publishedStageCount\":2");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v401\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v401.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v401\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v401.json\"");
