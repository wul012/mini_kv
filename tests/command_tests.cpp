...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v264\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v263\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v263.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v263\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v263.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:1e9e1013daf0ea8b\"");
    assert_response_contains(result, "\"continuityStage\":\"maintenance-refactor-shard-readiness-history-fixture-loop\"");
    assert_response_contains(result, "\"stageSequence\":64");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v264\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v264\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":64");
