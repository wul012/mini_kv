...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-comparison-closeout-audit-execution-lock-control-read-only\"");
    ...
    assert_response_contains(result, "\"draftTextPackageComparisonCloseoutAuditReleaseVersion\":\"v856\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v855\"");
    assert_response_contains(result, "\"publishedStageCount\":21");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v855.json\"");
