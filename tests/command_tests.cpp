...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-compared-package-evidence-intake-offline-comparison-result-guard-read-only\"");
    ...
    assert_response_contains(result, "\"draftTextPackageComparedPackageEvidenceIntakeAuditReleaseVersion\":\"v866\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v865\"");
    assert_response_contains(result, "\"publishedStageCount\":6");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v865.json\"");
