...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-retention-audit\"");
    assert_response_contains(result, "\"archiveStageSequence\":6");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v346\"");
    assert_response_contains(result, "\"publishedStageCount\":6");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v345\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v345.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v345\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v345.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v345\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v345.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:68111a874e1be61a\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-retention-audit\"");
    assert_response_contains(result, "\"stageSequence\":146");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v346\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v346\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":146");
