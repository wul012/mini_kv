...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v331\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v331.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-node-consumer-handoff\"");
    assert_response_contains(result, "\"rolloutStageSequence\":13");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v332\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v331\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v331.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-node-consumer-handoff\"");
    assert_response_contains(result, "\"stageSequence\":132");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v332\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v332\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":132");
