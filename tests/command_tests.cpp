...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-compared-package-evidence-intake-policy-and-execution-lock-guard-read-only\"");
    ...
    assert_response_contains(result, "\"draftTextPackageComparedPackageEvidenceIntakeAuditReleaseVersion\":\"v876\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v875\"");
    assert_response_contains(result, "\"publishedStageCount\":16");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v875.json\"");
