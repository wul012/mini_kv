...
int main() {
    ...
    assert(result.response.find("command_count=67") != std::string::npos);
    ...
    assert_response_contains(result, "\"status\":\"route-preview-candidate-profile-section-closeout-summary-read-only\"");
