...
int main() {
    ...
    assert_response_contains(result, "\"verificationStage\":\"route-preview-verification-report-archive-closeout-verification-no-write-audit\"");
    assert_response_contains(result, "\"verificationStageSequence\":18");
    assert_response_contains(result, "\"verificationReleaseVersion\":\"v398\"");
    assert_response_contains(result, "\"publishedStageCount\":18");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v397\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v397.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v397\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v397.json\"");
