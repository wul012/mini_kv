...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v320\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v320.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-command-catalog-alignment\"");
    assert_response_contains(result, "\"rolloutStageSequence\":2");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v321\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v320\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v320.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-command-catalog-alignment\"");
    assert_response_contains(result, "\"stageSequence\":121");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v321\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v321\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":121");
