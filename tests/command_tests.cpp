...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-consumer-handoff-audit\"");
    assert_response_contains(result, "\"archiveStageSequence\":10");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v350\"");
    assert_response_contains(result, "\"publishedStageCount\":10");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v349\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v349.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v349\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v349.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v349\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v349.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:c513172d8269d288\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-consumer-handoff-audit\"");
    assert_response_contains(result, "\"stageSequence\":150");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v350\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v350\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":150");
