...
int main() {
    ...
    assert_response_contains(result, "\"verificationStage\":\"route-preview-verification-report-archive-closeout-verification-tcp-smoke-contract\"");
    assert_response_contains(result, "\"verificationStageSequence\":6");
    assert_response_contains(result, "\"verificationReleaseVersion\":\"v386\"");
    assert_response_contains(result, "\"publishedStageCount\":6");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v385\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v385.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v385\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v385.json\"");
