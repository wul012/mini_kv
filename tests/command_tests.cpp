...
int main() {
    ...
    assert_response_contains(result, "\"maintenanceStage\":\"route-preview-archive-maintenance-retention-audit\"");
    assert_response_contains(result, "\"maintenanceStageSequence\":15");
    assert_response_contains(result, "\"maintenanceReleaseVersion\":\"v475\"");
    assert_response_contains(result, "\"sharedStageCatalogFormatterApplied\":true");
