...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v315\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v315.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-no-execution-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":18");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v316\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v315\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v315.json\"");
    ...
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-no-execution-audit\"");
    assert_response_contains(result, "\"stageSequence\":116");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v316\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v316\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":116");
