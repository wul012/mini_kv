...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v235\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v234\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v234.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v234\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v234.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:97d3419bb7663fde\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v522-stability-evidence-report-readiness\"");
    assert_response_contains(result, "\"stageSequence\":35");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v235\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v235\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":35");
