...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v300\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v300.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-explain-contract\"");
    assert_response_contains(result, "\"rolloutStageSequence\":3");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v301\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v300\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v300.json\"");
    ...
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-explain-contract\"");
    assert_response_contains(result, "\"stageSequence\":101");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v301\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v301\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":101");
