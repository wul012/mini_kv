...
int main() {
    ...
    assert_response_contains(result, "\"verificationStage\":\"route-preview-verification-report-archive-closeout-verification-fixture-freeze\"");
    assert_response_contains(result, "\"verificationStageSequence\":7");
    assert_response_contains(result, "\"verificationReleaseVersion\":\"v387\"");
    assert_response_contains(result, "\"publishedStageCount\":7");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v386\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v386.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v386\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v386.json\"");
