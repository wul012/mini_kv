...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v220\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v219\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v219.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v219\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v219.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:78b10360a474df83\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-v211-v219-batch-package-audit\"");
    assert_response_contains(result, "\"stageSequence\":20");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v220\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v220\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":20");
