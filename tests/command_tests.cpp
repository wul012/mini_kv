...
int main() {
    ...
    assert_response_contains(result, "\"publishedStageCount\":170");
    ...
    assert_response_contains(result, "\"publishedStageCount\":171");
    ...
    assert_response_contains(result, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-no-router-audit\"");
    assert_response_contains(result, "\"closeoutStageSequence\":17");
    assert_response_contains(result, "\"closeoutReleaseVersion\":\"v377\"");
    assert_response_contains(result, "\"publishedStageCount\":17");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v376\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v376.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v376\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v376.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:ac8ca08205ce8f0b\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-no-router-audit\"");
    assert_response_contains(result, "\"stageSequence\":177");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v377\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v377\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":177");
