...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-java-echo-handoff\"");
    assert_response_contains(result, "\"archiveStageSequence\":11");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v351\"");
    assert_response_contains(result, "\"publishedStageCount\":11");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v350\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v350.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v350\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v350.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v350\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v350.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:3c51622ccdb38a8f\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-java-echo-handoff\"");
    assert_response_contains(result, "\"stageSequence\":151");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v351\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v351\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":151");
