...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v225\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v224\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v224.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v224\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v224.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:011a92d8d38f3557\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v505-readiness-handoff-archive-verification-route-release-catalog\"");
    assert_response_contains(result, "\"stageSequence\":25");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v225\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v225\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":25");
