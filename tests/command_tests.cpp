...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v204\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v203\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v203.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v203\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v203.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:bed1ac036b8f548e\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-archive-readiness-audit\"");
    assert_response_contains(result, "\"stageSequence\":4");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v204\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v204\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":4");
