...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v237\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v236\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v236.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v236\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v236.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:ffee5a44b8688bd6\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v522-stability-archive-package\"");
    assert_response_contains(result, "\"stageSequence\":37");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v237\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v237\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":37");
