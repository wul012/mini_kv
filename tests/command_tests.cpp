...
int main() {
    ...
    assert_response_contains(result, "\"publishedStageCount\":110");
    ...
    assert_response_contains(result, "\"publishedStageCount\":111");
    ...
    assert_response_contains(result, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-retention-audit\"");
    assert_response_contains(result, "\"closeoutStageSequence\":11");
    assert_response_contains(result, "\"closeoutReleaseVersion\":\"v371\"");
    assert_response_contains(result, "\"publishedStageCount\":11");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v370\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v370.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v370\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v370.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:f31e435e5f8ab4ad\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-retention-audit\"");
    assert_response_contains(result, "\"stageSequence\":171");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v371\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v371\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":171");
