...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v212\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v211\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v211.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v211\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v211.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:e116b578a611d13d\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-release-catalog-retention-audit\"");
    assert_response_contains(result, "\"stageSequence\":12");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v212\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v212\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":12");
