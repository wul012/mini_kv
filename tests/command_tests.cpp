...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v332\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v332.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-java-echo-handoff\"");
    assert_response_contains(result, "\"rolloutStageSequence\":14");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v333\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v332\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v332.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-java-echo-handoff\"");
    assert_response_contains(result, "\"stageSequence\":133");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v333\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v333\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":133");
