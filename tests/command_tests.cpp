...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-compared-package-evidence-intake-source-and-operator-handle-slot-read-only\"");
    ...
    assert_response_contains(result, "\"draftTextPackageComparedPackageEvidenceIntakeAuditReleaseVersion\":\"v873\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v872\"");
    assert_response_contains(result, "\"publishedStageCount\":13");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v872.json\"");
