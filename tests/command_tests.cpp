...
int main() {
    ...
    assert_response_contains(result, "\"publishedStageCount\":90");
    ...
    assert_response_contains(result, "\"publishedStageCount\":91");
    ...
    assert_response_contains(result, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-index-audit\"");
    assert_response_contains(result, "\"closeoutStageSequence\":9");
    assert_response_contains(result, "\"closeoutReleaseVersion\":\"v369\"");
    assert_response_contains(result, "\"publishedStageCount\":9");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v368\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v368.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v368\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v368.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:38573d7451372fd6\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-index-audit\"");
    assert_response_contains(result, "\"stageSequence\":169");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v369\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v369\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":169");
