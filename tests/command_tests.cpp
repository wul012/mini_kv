...
int main() {
    ...
    assert(result.response.find("command_count=34") != std::string::npos);
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v329\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v329.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-history-fallback-freeze\"");
    assert_response_contains(result, "\"rolloutStageSequence\":11");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v330\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v329\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v329.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-history-fallback-freeze\"");
    assert_response_contains(result, "\"stageSequence\":130");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v330\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v330\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":130");
