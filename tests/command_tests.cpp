...
int main() {
    ...
    assert_response_contains(result, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-catalog-alignment\"");
    assert_response_contains(result, "\"closeoutStageSequence\":2");
    assert_response_contains(result, "\"closeoutReleaseVersion\":\"v362\"");
    assert_response_contains(result, "\"publishedStageCount\":2");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v361\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v361.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v361\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v361.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:de79bbc43b243f12\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-catalog-alignment\"");
    assert_response_contains(result, "\"stageSequence\":162");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v362\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v362\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":162");
