...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v211\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v210\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v210.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v210\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v210.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:1ccb2dd05cd63996\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-release-catalog-retention\"");
    assert_response_contains(result, "\"stageSequence\":11");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v211\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v211\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":11");
