...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-retention-map\"");
    assert_response_contains(result, "\"archiveStageSequence\":5");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v345\"");
    assert_response_contains(result, "\"publishedStageCount\":5");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v344\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v344.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v344\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v344.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v344\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v344.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:a3ab2b889b3c75df\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-retention-map\"");
    assert_response_contains(result, "\"stageSequence\":145");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v345\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v345\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":145");
