...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v175\"");
    ...
    assert_response_contains(result, "\"status\":\"node-route-split-window-adapter-implementation-read-only\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v174\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v174.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v174\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v174.json\"");
    assert_response_contains(result, "\"windowStartNodeVersion\":\"Node v433\"");
    assert_response_contains(result, "\"windowEndNodeVersion\":\"Node v449\"");
    assert_response_contains(result, "\"splitRouteGroupCount\":17");
    assert_response_contains(result, "\"coveredNodeVersions\":[\"Node v433\",\"Node v434\",\"Node v435\","
                                     ...
                                     "\"Node v446\",\"Node v447\",\"Node v448\",\"Node v449\"]");
    ...
    assert_response_contains(result, "\"expectedWindowVersionCount\":17");
    assert_response_contains(result, "\"observedWindowVersionCount\":17");
    assert_response_contains(result, "\"windowRangeStart\":\"Node v433\"");
    assert_response_contains(result, "\"windowRangeEnd\":\"Node v449\"");
    ...
    assert_response_contains(result, "\"sourceFrozenWindowDigest\":\"fnv1a64:d582c3d04aed99e1\"");
    ...
    assert_response_contains(result, "\"boundaryCatalogIndex\":{\"catalogVersion\":\"read-only-boundary-fields.v9\"");
    assert_response_contains(result, "\"sourceNodePlan\":"
                                     "\"docs/plans3/"
                                     "v449-post-managed-audit-adapter-implementation-route-group-split-roadmap.md\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v174\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v174.json\"");
    assert_response_contains(result, "\"fieldCount\":420");
