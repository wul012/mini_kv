...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-sibling-import-rejection-read-only\"");
    ...
    assert_response_contains(result, "\"draftTextPackageReviewCloseoutAuditReleaseVersion\":\"v825\"");
