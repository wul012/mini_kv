...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v336\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v336.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-no-execution-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":18");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v337\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v336\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v336.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-no-execution-audit\"");
    assert_response_contains(result, "\"stageSequence\":137");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v337\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v337\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":137");
