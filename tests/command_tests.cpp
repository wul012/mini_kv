...
int main() {
    ...
    assert(result.response.find(
           ...
           std::string::npos);
    assert(result.response.find(
                "SHARDROUTEVERIFYREPORTARCHIVECLOSEOUTVERIFYAUDITJSON(category=read,mutates_store=no,touches_wal=no,stable=yes)") !=
           std::string::npos);
    assert(result.response.find(
    ...
    assert(result.response.find(
           ...
           std::string::npos);
    assert(result.response.find(
               "SHARDROUTECANDIDATEMATERIALREQUESTINTEGRITYJSON(category=read,mutates_store=no,touches_wal=no,stable=yes)") !=
           std::string::npos);
    assert(result.response.find(
               "SHARDROUTECANDIDATEMATERIALSUBMISSIONPRECHECKJSON(category=read,mutates_store=no,touches_wal=no,stable=yes)") !=
           std::string::npos);
    assert(result.response.find(
               "SHARDROUTECANDIDATEMATERIALSUBMISSIONPRECHECKINTEGRITYJSON(category=read,mutates_store=no,touches_wal=no,stable=yes)") !=
           std::string::npos);
    assert(result.response.find(
               "SHARDROUTECANDIDATEPROFILESECTIONJSON(category=read,mutates_store=no,touches_wal=no,stable=yes)") !=
           std::string::npos);
    assert(result.response.find(
               "SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTPROFILESECTIONJSON(category=read,mutates_store=no,touches_wal=no,stable=yes)") !=
           std::string::npos);
    assert(result.response.find(
               "SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTPROFILESECTIONINTEGRITYJSON(category=read,mutates_store=no,touches_wal=no,stable=yes)") !=
           std::string::npos);
    assert(result.response.find(
    ...
    assert(result.response.find(
           ...
           std::string::npos);
    assert(result.response.find(
               "SHARDROUTEVALUESUPPLYPROFILESECTIONINTEGRITYJSON(category=read,mutates_store=no,touches_wal=no,stable=yes)") !=
           std::string::npos);
    assert(result.response.find(
    ...
    assert(result.response.find(
           ...
           std::string::npos);
    assert(result.response.find(
               "SHARDROUTEPRODUCTIONLIVECAPTUREARCHIVEVERIFYNONPARTICIPATIONJSON(category=read,mutates_store=no,touches_wal=no,stable=yes)") !=
           std::string::npos);
    assert(result.response.find(
               "SHARDROUTEPRODUCTIONLIVECAPTURERELEASEEVIDENCEREVIEWNONPARTICIPATIONJSON(category=read,mutates_store=no,touches_wal=no,stable=yes)") !=
           std::string::npos);
    assert(result.response.find(
    ...
    assert(result.response.find(
           ...
           std::string::npos);
    assert(result.response.find(
               "SHARDROUTERELEASEWINDOWREADINESSPACKETSPLITNONPARTICIPATIONJSON(category=read,mutates_store=no,touches_wal=no,stable=yes)") !=
           std::string::npos);
    assert(result.response.find(
    ...
    assert(result.response.find(
               ...
               "\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
               "\"name\":\"SHARDROUTECANDIDATEMATERIALREQUESTINTEGRITYJSON\",\"category\":\"read\","
               "\"mutates_store\":false,\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
               "\"name\":\"SHARDROUTECANDIDATEMATERIALSUBMISSIONPRECHECKJSON\",\"category\":\"read\","
               "\"mutates_store\":false,\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
               "\"name\":\"SHARDROUTECANDIDATEMATERIALSUBMISSIONPRECHECKINTEGRITYJSON\",\"category\":\"read\","
               "\"mutates_store\":false,\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
               "\"name\":\"SHARDROUTECANDIDATEPROFILESECTIONJSON\",\"category\":\"read\","
               "\"mutates_store\":false,\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
    ...
    assert(result.response.find(
               ...
               "\"category\":\"read\",\"mutates_store\":false,\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
                "\"name\":\"SHARDROUTEVALUESUPPLYPROFILESECTIONJSON\","
                "\"category\":\"read\",\"mutates_store\":false,\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
               "\"name\":\"SHARDROUTEVALUESUPPLYPROFILESECTIONINTEGRITYJSON\","
               "\"category\":\"read\",\"mutates_store\":false,\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
    ...
    assert(result.response.find(
               ...
               "\"category\":\"read\",\"mutates_store\":false,\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
               "\"name\":\"SHARDROUTEPRODUCTIONLIVECAPTUREARCHIVEVERIFYNONPARTICIPATIONJSON\","
               "\"category\":\"read\",\"mutates_store\":false,\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
               "\"name\":\"SHARDROUTEPRODUCTIONLIVECAPTURERELEASEEVIDENCEREVIEWNONPARTICIPATIONJSON\","
               "\"category\":\"read\",\"mutates_store\":false,\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
    ...
    assert(result.response.find(
               ...
               "\"category\":\"read\",\"mutates_store\":false,\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
               "\"name\":\"SHARDROUTERELEASEWINDOWREADINESSPACKETSPLITNONPARTICIPATIONJSON\","
               "\"category\":\"read\",\"mutates_store\":false,\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
    ...
    assert(result.response.find(
               ...
               "\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
                "\"name\":\"SHARDROUTEVERIFYREPORTARCHIVECLOSEOUTVERIFYJSON\",\"category\":\"read\",\"mutates_store\":false,"
                "\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
                "\"name\":\"SHARDROUTEVERIFYREPORTARCHIVECLOSEOUTVERIFYAUDITJSON\",\"category\":\"read\",\"mutates_store\":false,"
                "\"touches_wal\":false") != std::string::npos);
    assert(result.response.find(
    ...
    assert_response_contains(result, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-release-package\"");
    ...
    assert_response_contains(result, "\"verificationStage\":\"route-preview-verification-report-archive-closeout-verification-release-package\"");
    ...
    assert_response_contains(result, "\"shardRoutePreviewVerificationReportArchiveCloseoutVerificationAudit\":{\"contract\":"
    ...
    assert_response_contains(result, "\"sourceVerificationCommand\":\"SHARDROUTEVERIFYREPORTARCHIVECLOSEOUTVERIFYJSON\"");
    assert_response_contains(result, "\"sourceVerificationReleaseVersion\":\"v400\"");
    assert_response_contains(result, "\"sourceVerificationFixturePath\":\"fixtures/release/shard-readiness-v400.json\"");
    ...
    assert_response_contains(result, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-release-package\"");
    ...
    assert_response_contains(result, "\"sourceVerificationVersionedFixturePath\":\"fixtures/release/shard-readiness-v400.json\"");
    ...
    assert_response_contains(result, "\"shardRoutePreviewOperatorValueSupplySignedApprovalCaptureArtifactPreflight\":{\"contract\":"
    ...
    assert_response_contains(result, "\"shardRoutePreviewOperatorValueSupplySignedApprovalCaptureArtifactDraftAuthoringReadiness\":{\"contract\":"
                                     "\"shard-route-preview-operator-value-supply-signed-approval-capture-artifact-draft-authoring-readiness.v1\"");
    assert_response_contains(result, "\"command\":\"SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTAUTHORINGREADINESSJSON\"");
    ...
    assert_response_contains(result, "\"shardRoutePreviewOperatorValueSupplySignedApprovalCaptureArtifactDraftTextPackageReviewPreflight\":{\"contract\":"
    ...
    assert_response_contains(result, "\"shardRoutePreviewOperatorValueSupplySignedApprovalCaptureArtifactDraftTextPackageReviewCloseoutAudit\":{\"contract\":"
                                     "\"shard-route-preview-operator-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit.v1\"");
    assert_response_contains(result, "\"command\":\"SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTTEXTPACKAGEREVIEWCLOSEOUTAUDITJSON\"");
    ...
    assert_response_contains(result, "\"contract\":\"shard-route-preview-candidate-document-request-package-closeout.v1\"");
    assert_response_contains(result, "\"command\":\"SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTTEXTPACKAGECANDIDATEDOCUMENTREQUESTPACKAGECLOSEOUTJSON\"");
    assert_response_contains(result, "\"sourceComparedPackageEvidenceIntakeAuditReleaseVersion\":\"v880\"");
    assert_response_contains(result, "\"sourceComparedPackageEvidenceIntakeAuditFixturePath\":\"fixtures/release/shard-readiness-v880.json\"");
    ...
    assert_response_contains(result, "\"contract\":\"shard-route-preview-candidate-material-request-fixture-integrity.v1\"");
    ...
    assert_response_contains(result, "\"sourceCandidateMaterialRequestFixturePath\":\"fixtures/release/shard-readiness-v965.json\"");
    ...
    assert_response_contains(result, "\"contract\":\"shard-route-preview-candidate-document-material-submission-precheck.v1\"");
    ...
    assert_response_contains(result, "\"sourceCandidateMaterialRequestIntegrityFixturePath\":\"fixtures/release/shard-readiness-v975.json\"");
    ...
    assert_response_contains(result,
                             "\"command\":\"SHARDROUTECANDIDATEMATERIALSUBMISSIONPRECHECKINTEGRITYJSON\"");
    ...
    assert_response_contains(result,
                             "\"contract\":\"shard-route-preview-candidate-document-profile-section-renderer-split.v1\"");
    ...
    assert_response_contains(
        result,
        "\"command\":\"SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTPROFILESECTIONJSON\"");
    assert_response_contains(result,
    ...
    assert(result.response ==
           "ERR usage: SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTPROFILESECTIONJSON");
    ...
    result = processor.execute("SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTPROFILESECTIONINTEGRITYJSON extra");
    assert(result.response ==
    ...
    assert_response_contains(
        result,
        "\"contract\":\"shard-route-preview-signed-approval-artifact-draft-text-package-profile-section-renderer-split.v1\"");
    assert_response_contains(
        result,
        "\"command\":\"SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTTEXTPACKAGEPROFILESECTIONJSON\"");
    assert_response_contains(
        result,
    ...
    assert_response_contains(result, "\"sourceDraftTextPackageComparisonCloseoutAuditReleaseVersion\":\"v860\"");
    assert_response_contains(result, "\"sourceComparedPackageEvidenceIntakeAuditReleaseVersion\":\"v880\"");
    assert_response_contains(result, "\"signedApprovalArtifactDraftTextPackageProfileSectionReleaseVersion\":\"v1110\"");
    ...
    assert_response_contains(
        result,
        "\"contract\":\"shard-route-preview-operator-value-supply-profile-section-renderer-split.v1\"");
    ...
    assert_response_contains(result, "\"sourceNodeProductionLiveProbeReadOnlyWindowReadinessPacketReleaseVersion\":\"Node v1606\"");
    ...
    assert_response_contains(result, "\"sourceNodeProductionLiveProbeReadOnlyWindowLiveCaptureCloseoutReleaseVersion\":\"Node v1631\"");
    assert_response_contains(result, "\"sourceNodeRequiresFreshMiniKvEvidence\":false");
    ...
    assert_response_contains(result, "\"plannedProductionLiveCaptureArchiveVerificationNonParticipationCheckCount\":35");
    ...
    assert(result.response ==
           "ERR usage: SHARDROUTEPRODUCTIONLIVECAPTURERELEASEEVIDENCEREVIEWNONPARTICIPATIONJSON");

    result = processor.execute("SHARDROUTECATALOGENTRYGROUPSPLITNONPARTICIPATIONJSON");
    assert_response_contains(result, "\"contract\":\"shard-route-preview-catalog-entry-group-split-non-participation.v1\"");
    ...
    assert_response_contains(
        result, "\"nodeSandboxEndpointCredentialResolverStableBarrelImportedByMiniKv\":false");
    assert_response_contains(result,
    ...
    assert_response_contains(
        result, "\"command\":\"SHARDROUTERELEASEWINDOWREADINESSPACKETSPLITNONPARTICIPATIONJSON\"");
    assert_response_contains(
        result,
    ...
    assert_response_contains(
        result,
        "\"plannedReleaseWindowReadinessPacketSplitNonParticipationCheckCount\":15");
    assert_response_contains(
        result,
        "\"completedReleaseWindowReadinessPacketSplitNonParticipationCheckCount\":15");
    assert_response_contains(
        result,
    ...
    assert(result.response ==
           "ERR usage: SHARDROUTERELEASEWINDOWREADINESSPACKETSPLITNONPARTICIPATIONJSON");
    ...
    assert_response_contains(result, "\"sourceNodeRequiresFreshJavaEvidence\":false");
    assert_response_contains(
        result, "\"sourceReleaseWindowReadinessPacketSplitCommand\":\"SHARDROUTERELEASEWINDOWREADINESSPACKETSPLITNONPARTICIPATIONJSON\"");
    ...
    assert_response_contains(result, "\"nodeDisabledFakeHarnessContractUpstreamEchoPublicEntrypointImportedByMiniKv\":false");
    ...
    assert_response_contains(result, "\"nodeDisabledFakeHarnessContractUpstreamEchoVerificationExecutedByMiniKv\":false");
    ...
    assert_response_contains(result,
                             "\"command\":\"SHARDPRODUCTIONSHARDEXECUTIONOWNERRECEIPTREQUESTPACKETJSON\"");
    ...
    assert_response_contains(result,
                             "\"productionShardExecutionOwnerReceiptRequestPacketReleaseVersion\":\"v1596\"");
    ...
    assert_response_contains(
        result,
        "\"productionShardExecutionOwnerReceiptRequestPacketValidationPassed\":true");
    ...
    assert_response_contains(
        result,
        "\"command\":\"SHARDPRODUCTIONSHARDEXECUTIONEXTERNALARTIFACTDRYRUNCLOSEOUTJSON\"");
    ...
    assert(result.response.find("SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTINSTRUCTIONPREFLIGHTJSON") !=
           std::string::npos);
    assert(result.response.find("SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTTEXTPACKAGEREVIEWPREFLIGHTJSON") !=
           std::string::npos);
    assert(result.response.find("SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTTEXTPACKAGEREVIEWCLOSEOUTAUDITJSON") !=
           std::string::npos);
