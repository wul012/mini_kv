...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v216\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v215\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v215.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v215\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v215.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:b745fa9e79265743\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-stage-descriptor-audit\"");
    assert_response_contains(result, "\"stageSequence\":16");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v216\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v216\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":16");
