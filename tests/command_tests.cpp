...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-comparison-closeout-audit-review-digest-recheck-control-read-only\"");
    ...
    assert_response_contains(result, "\"draftTextPackageComparisonCloseoutAuditReleaseVersion\":\"v843\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v842\"");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v842.json\"");
