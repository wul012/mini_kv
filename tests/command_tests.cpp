...
int main() {
    ...
    assert_response_contains(result, "\"maintenanceStage\":\"route-preview-archive-maintenance-source-fixture-index-audit\"");
    assert_response_contains(result, "\"maintenanceStageSequence\":13");
    assert_response_contains(result, "\"maintenanceReleaseVersion\":\"v473\"");
    assert_response_contains(result, "\"sharedStageCatalogFormatterApplied\":true");
