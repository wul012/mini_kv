...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v197\"");
    ...
    assert_response_contains(result, "\"status\":\"node-route-catalog-cleanup-latest-evidence-package-read-only\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v196\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v196.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenWindowDigest\":\"fnv1a64:116ec6b912bb4026\"");
    ...
    assert_response_contains(result, "\"boundaryCatalogIndex\":{\"catalogVersion\":\"read-only-boundary-fields.v25\"");
    assert_response_contains(result, "\"sourceNodePlan\":"
                                     "\"docs/plans3/"
                                     "v479-post-java-mini-kv-latest-route-catalog-cleanup-evidence-archive-verification-route-roadmap.md\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v196\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v196.json\"");
    assert_response_contains(result, "\"fieldCount\":735");
    assert_response_contains(result, "\"groupCount\":36");
