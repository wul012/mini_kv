...
int main() {
    ...
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-command-explain-contract\"");
    assert_response_contains(result, "\"rolloutStageSequence\":3");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v281\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v280\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v280.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v280\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v280.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2193962195ba633a\"");
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-command-explain-contract\"");
    assert_response_contains(result, "\"stageSequence\":81");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v281\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v281\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":81");
