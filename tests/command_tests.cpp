...
int main() {
    ...
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-checkjson-contract\"");
    assert_response_contains(result, "\"rolloutStageSequence\":4");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v282\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v281\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v281.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v281\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v281.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2193962195ba633a\"");
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-checkjson-contract\"");
    assert_response_contains(result, "\"stageSequence\":82");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v282\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v282\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":82");
