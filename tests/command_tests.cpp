...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v304\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v304.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-fixture-freeze\"");
    assert_response_contains(result, "\"rolloutStageSequence\":7");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v305\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v304\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v304.json\"");
    ...
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-fixture-freeze\"");
    assert_response_contains(result, "\"stageSequence\":105");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v305\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v305\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":105");
