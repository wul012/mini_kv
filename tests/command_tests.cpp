...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v265\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v264\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v264.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v264\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v264.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:84d8aaf28b495b68\"");
    assert_response_contains(result, "\"continuityStage\":\"maintenance-refactor-cmake-linked-test-helper\"");
    assert_response_contains(result, "\"stageSequence\":65");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v265\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v265\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":65");
