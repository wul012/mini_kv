...
int main() {
    ...
    assert_response_contains(result, "\"session_id_echo\":\"mini-kv-live-read-v84\"");
    ...
    assert_response_contains(result, "\"source_version\":\"0.84.0\"");
    assert_response_contains(result, "\"artifact_path_hint\":\"c/84/\"");
    assert_response_contains(result, "\"runtime_binary_hint\":\"cmake-build-v84/minikv_server and cmake-build-v84/minikv_client from the current CMake build\"");
    ...
    assert_response_contains(result, "\"provenance_digest\":\"fnv1a64:c682f9c827129e40\"");
    assert_response_contains(result, "\"read_only\":true");
    ...
    assert_response_contains(result, "\"expected_binary_provenance_digest\":\"fnv1a64:c682f9c827129e40\"");
    assert_response_contains(result, "\"check_digest\":\"fnv1a64:357cc7e9eec3f223\"");
    ...
    assert_response_contains(result, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.84.0\"");
    ...
    assert_response_contains(result, "\"notes\":[\"runtime_smoke_evidence\",\"live_read_session_hint\",\"binary_provenance_hint\",\"retention_provenance_check\",\"read_only_aggregate\","
