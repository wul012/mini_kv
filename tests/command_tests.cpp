...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-archive-maintenance-checkjson-contract-read-only\"");
    ...
    assert_response_contains(result, "\"maintenanceStage\":\"route-preview-archive-maintenance-checkjson-contract\"");
    assert_response_contains(result, "\"maintenanceStageSequence\":8");
    assert_response_contains(result, "\"maintenanceReleaseVersion\":\"v468\"");
    assert_response_contains(result, "\"sharedStageCatalogFormatterApplied\":true");
