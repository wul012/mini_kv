...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-index-audit\"");
    assert_response_contains(result, "\"archiveStageSequence\":4");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v344\"");
    assert_response_contains(result, "\"publishedStageCount\":4");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v343\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v343.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v343\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v343.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v343\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v343.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2ff62b23da30ba9d\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-index-audit\"");
    assert_response_contains(result, "\"stageSequence\":144");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v344\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v344\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":144");
