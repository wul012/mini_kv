...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v316\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v316.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-release-package\"");
    assert_response_contains(result, "\"rolloutStageSequence\":19");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v317\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v316\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v316.json\"");
    ...
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-release-package\"");
    assert_response_contains(result, "\"stageSequence\":117");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v317\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v317\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":117");
