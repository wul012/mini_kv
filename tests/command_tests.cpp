...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v259\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v258\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v258.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v258\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v258.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:47524b3712b54719\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v549-node-v550-route-exposure-readiness-audit\"");
    assert_response_contains(result, "\"stageSequence\":59");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v259\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v259\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":59");
