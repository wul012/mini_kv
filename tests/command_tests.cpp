...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v201\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v200\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v200.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v200\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v200.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:d1e889711b5d8574\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-ledger-intake\"");
    assert_response_contains(result, "\"stageSequence\":1");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v201\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v201\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":1");
