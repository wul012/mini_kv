...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v149\"");
    ...
    assert_response_contains(result, "\"status\":\"frozen-evidence-handoff-read-only\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v148\"");
    ...
    assert_response_contains(result, "\"activePrototypePlanFreeze\":{\"frozenReleaseVersion\":\"v148\"");
