...
int main() {
    ...
    assert_response_contains(result, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-no-write-audit\"");
    assert_response_contains(result, "\"auditStageSequence\":18");
    assert_response_contains(result, "\"auditReleaseVersion\":\"v418\"");
    assert_response_contains(result, "\"publishedStageCount\":18");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v417\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v417.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v417\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v417.json\"");
