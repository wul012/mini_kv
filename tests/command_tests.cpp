...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v174\"");
    ...
    assert_response_contains(result, "\"status\":\"node-route-split-window-route-quality-read-only\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v173\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v173.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v173\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v173.json\"");
    assert_response_contains(result, "\"windowStartNodeVersion\":\"Node v433\"");
    assert_response_contains(result, "\"windowEndNodeVersion\":\"Node v448\"");
    assert_response_contains(result, "\"splitRouteGroupCount\":16");
    ...
    assert_response_contains(result, "\"expectedWindowVersionCount\":16");
    assert_response_contains(result, "\"observedWindowVersionCount\":16");
    assert_response_contains(result, "\"windowRangeStart\":\"Node v433\"");
    assert_response_contains(result, "\"windowRangeEnd\":\"Node v448\"");
    ...
    assert_response_contains(result, "\"sourceFrozenWindowDigest\":\"fnv1a64:33a60bc1d66fd286\"");
