...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-compared-package-evidence-intake-detached-signature-envelope-observation-slot-read-only\"");
    ...
    assert_response_contains(result, "\"draftTextPackageComparedPackageEvidenceIntakeAuditReleaseVersion\":\"v871\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v870\"");
    assert_response_contains(result, "\"publishedStageCount\":11");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v870.json\"");
