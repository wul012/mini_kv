...
int main() {
    ...
    assert_response_contains(result, "\"publishedStageCount\":120");
    ...
    assert_response_contains(result, "\"publishedStageCount\":121");
    ...
    assert_response_contains(result, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-consumer-handoff\"");
    assert_response_contains(result, "\"closeoutStageSequence\":12");
    assert_response_contains(result, "\"closeoutReleaseVersion\":\"v372\"");
    assert_response_contains(result, "\"publishedStageCount\":12");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v371\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v371.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v371\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v371.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:827d3e6a37f521e4\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-consumer-handoff\"");
    assert_response_contains(result, "\"stageSequence\":172");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v372\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v372\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":172");
