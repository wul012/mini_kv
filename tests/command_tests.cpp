...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-archive-maintenance-command-dispatch-audit-read-only\"");
    ...
    assert_response_contains(result, "\"maintenanceStage\":\"route-preview-archive-maintenance-command-dispatch-audit\"");
    assert_response_contains(result, "\"maintenanceStageSequence\":18");
    assert_response_contains(result, "\"maintenanceReleaseVersion\":\"v478\"");
    assert_response_contains(result, "\"sharedStageCatalogFormatterApplied\":true");
