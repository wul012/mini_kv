...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-archive-maintenance-source-release-freeze-read-only\"");
    ...
    assert_response_contains(result, "\"maintenanceStage\":\"route-preview-archive-maintenance-source-release-freeze\"");
    assert_response_contains(result, "\"maintenanceStageSequence\":2");
    assert_response_contains(result, "\"maintenanceReleaseVersion\":\"v462\"");
    assert_response_contains(result, "\"sharedStageCatalogFormatterApplied\":true");
