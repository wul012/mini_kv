...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v208\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v207\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v207.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v207\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v207.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:16dd9ba05e5b3fe4\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-archive-verification-route-audit\"");
    assert_response_contains(result, "\"stageSequence\":8");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v208\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v208\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":8");
