...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v309\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v309.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-operator-handoff\"");
    assert_response_contains(result, "\"rolloutStageSequence\":12");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v310\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v309\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v309.json\"");
    ...
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-operator-handoff\"");
    assert_response_contains(result, "\"stageSequence\":110");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v310\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v310\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":110");
