...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v228\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v227\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v227.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v227\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v227.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2b6e2366ce59bc20\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v505-readiness-handoff-archive-verification-route-checkpoint-audit\"");
    assert_response_contains(result, "\"stageSequence\":28");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v228\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v228\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":28");
