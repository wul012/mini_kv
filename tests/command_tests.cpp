...
int main() {
    ...
    assert_response_contains(result, "\"session_id_echo\":\"mini-kv-live-read-v87\"");
    ...
    assert_response_contains(result, "\"source_version\":\"0.87.0\"");
    assert_response_contains(result, "\"artifact_path_hint\":\"c/87/\"");
    assert_response_contains(result, "\"runtime_binary_hint\":\"cmake-build-v87/minikv_server and cmake-build-v87/minikv_client from the current CMake build\"");
    ...
    assert_response_contains(result, "\"provenance_digest\":\"fnv1a64:fa1d03b1b7c5830a\"");
    assert_response_contains(result, "\"read_only\":true");
    ...
    assert_response_contains(result, "\"expected_binary_provenance_digest\":\"fnv1a64:fa1d03b1b7c5830a\"");
    assert_response_contains(result, "\"check_digest\":\"fnv1a64:9b48b7a3ff284eff\"");
    ...
    assert_response_contains(result, "\"current_artifact_path_hint\":\"c/87/\"");
    assert_response_contains(result, "\"marker_digest\":\"fnv1a64:47be69db09df05d1\"");
    ...
    assert_response_contains(result, "\"current_artifact_path_hint\":\"c/87/\"");
    assert_response_contains(result, "\"receipt_digest\":\"fnv1a64:6730b44a5679b94e\"");
    ...
    assert_response_contains(result, "\"receipt_digest\":\"fnv1a64:111f0daf1283eab6\"");
    ...
    assert_response_contains(result, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.87.0\"");
    ...
    assert_response_contains(result, "\"notes\":[\"runtime_smoke_evidence\",\"live_read_session_hint\",\"binary_provenance_hint\",\"retention_provenance_check\",\"retention_provenance_replay_marker\",\"managed_audit_adapter_restore_boundary_receipt\",\"managed_audit_adapter_non_authoritative_storage_receipt\",\"read_only_aggregate\","
