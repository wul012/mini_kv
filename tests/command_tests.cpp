...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v321\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v321.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-explain-contract\"");
    assert_response_contains(result, "\"rolloutStageSequence\":3");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v322\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v321\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v321.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-explain-contract\"");
    assert_response_contains(result, "\"stageSequence\":122");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v322\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v322\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":122");
