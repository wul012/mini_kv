...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-comparison-closeout-audit-acceptance-grant-rejection-read-only\"");
    ...
    assert_response_contains(result, "\"draftTextPackageComparisonCloseoutAuditReleaseVersion\":\"v855\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v854\"");
    assert_response_contains(result, "\"publishedStageCount\":20");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v854.json\"");
