...
int main() {
    ...
    assert_response_contains(result, "\"publishedStageCount\":180");
    ...
    assert_response_contains(result, "\"publishedStageCount\":181");
    ...
    assert_response_contains(result, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-no-write-audit\"");
    assert_response_contains(result, "\"closeoutStageSequence\":18");
    assert_response_contains(result, "\"closeoutReleaseVersion\":\"v378\"");
    assert_response_contains(result, "\"publishedStageCount\":18");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v377\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v377.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v377\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v377.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:d0e5eaecd7466a6d\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-no-write-audit\"");
    assert_response_contains(result, "\"stageSequence\":178");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v378\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v378\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":178");
