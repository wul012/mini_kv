...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v317\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v317.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-release-package-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":20");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v318\"");
    assert_response_contains(result, "\"publishedStageCount\":20");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v317\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v317.json\"");
    ...
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-release-package-audit\"");
    assert_response_contains(result, "\"stageSequence\":118");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v318\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v318\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":118");
