...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-compared-package-evidence-intake-detached-signature-envelope-observation-guard-read-only\"");
    ...
    assert_response_contains(result, "\"draftTextPackageComparedPackageEvidenceIntakeAuditReleaseVersion\":\"v872\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v871\"");
    assert_response_contains(result, "\"publishedStageCount\":12");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v871.json\"");
