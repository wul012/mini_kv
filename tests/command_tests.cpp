...
int main() {
    ...
    assert_response_contains(result, "\"publishedStageCount\":80");
    ...
    assert_response_contains(result, "\"publishedStageCount\":81");
    ...
    assert_response_contains(result, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-index\"");
    assert_response_contains(result, "\"closeoutStageSequence\":8");
    assert_response_contains(result, "\"closeoutReleaseVersion\":\"v368\"");
    assert_response_contains(result, "\"publishedStageCount\":8");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v367\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v367.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v367\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v367.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:27ac4e8d0e9cffa7\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-index\"");
    assert_response_contains(result, "\"stageSequence\":168");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v368\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v368\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":168");
