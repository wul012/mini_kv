...
int main() {
    ...
    assert_response_contains(result, "\"node_consumption\":\"Node v272 may verify the mini-kv v119 credential resolver pre-implementation plan intake non-participation receipt");
