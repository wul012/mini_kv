...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v238\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v237\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v237.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v237\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v237.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:241dc6d5438fd5ee\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v522-stability-archive-package-audit\"");
    assert_response_contains(result, "\"stageSequence\":38");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v238\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v238\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":38");
