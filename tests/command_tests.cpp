...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v245\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v244\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v244.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v244\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v244.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:1a55e1d39f2827ac\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v522-final-closeout-package\"");
    assert_response_contains(result, "\"stageSequence\":45");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v245\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v245\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":45");
