...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v207\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v206\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v206.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v206\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v206.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:1e5f3dc941b1a90e\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-archive-verification-route-checkpoint\"");
    assert_response_contains(result, "\"stageSequence\":7");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v207\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v207\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":7");
