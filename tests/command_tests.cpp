...
int main() {
    ...
    assert_response_contains(result, "\"draftTextPackageComparisonCloseoutAuditReleaseVersion\":\"v838\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v837\"");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v837.json\"");
