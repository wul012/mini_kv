...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v310\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v310.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-node-consumer-handoff\"");
    assert_response_contains(result, "\"rolloutStageSequence\":13");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v311\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v310\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v310.json\"");
    ...
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-node-consumer-handoff\"");
    assert_response_contains(result, "\"stageSequence\":111");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v311\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v311\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":111");
