...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-manifest\"");
    assert_response_contains(result, "\"archiveStageSequence\":1");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v341\"");
    assert_response_contains(result, "\"publishedStageCount\":1");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v340\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v340.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v340\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v340.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v340\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v340.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:43e9e09af4d02e62\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-manifest\"");
    assert_response_contains(result, "\"stageSequence\":141");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v341\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v341\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":141");
