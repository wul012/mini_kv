...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v230\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v229\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v229.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v229\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v229.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:443a838e25455f28\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v505-readiness-handoff-archive-verification-route-batch-package-audit\"");
    assert_response_contains(result, "\"stageSequence\":30");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v230\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v230\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":30");
