...
int main() {
    ...
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-no-router-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":16");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v294\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v293\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v293.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v293\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v293.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2193962195ba633a\"");
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-no-router-audit\"");
    assert_response_contains(result, "\"stageSequence\":94");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v294\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v294\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":94");
