...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-consumer-handoff\"");
    assert_response_contains(result, "\"archiveStageSequence\":9");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v349\"");
    assert_response_contains(result, "\"publishedStageCount\":9");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v348\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v348.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v348\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v348.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v348\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v348.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2c9eac6c48d4776d\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-consumer-handoff\"");
    assert_response_contains(result, "\"stageSequence\":149");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v349\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v349\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":149");
