...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v251\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v250\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v250.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v250\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v250.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:dd4981f4ab14209f\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v549-archive-verification-route-readiness-audit\"");
    assert_response_contains(result, "\"stageSequence\":51");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v251\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v251\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":51");
