...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v337\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v337.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-release-package\"");
    assert_response_contains(result, "\"rolloutStageSequence\":19");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v338\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v337\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v337.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-release-package\"");
    assert_response_contains(result, "\"stageSequence\":138");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v338\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v338\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":138");
