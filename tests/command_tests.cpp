...
int main() {
    ...
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-boundary-field-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":15");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v293\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v292\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v292.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v292\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v292.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2193962195ba633a\"");
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-boundary-field-audit\"");
    assert_response_contains(result, "\"stageSequence\":93");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v293\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v293\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":93");
