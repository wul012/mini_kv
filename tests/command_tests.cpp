...
int main() {
    ...
    assert_response_contains(result, "\"publishedStageCount\":50");
    ...
    assert_response_contains(result, "\"publishedStageCount\":51");
    ...
    assert_response_contains(result, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-cli-smoke-contract\"");
    assert_response_contains(result, "\"closeoutStageSequence\":5");
    assert_response_contains(result, "\"closeoutReleaseVersion\":\"v365\"");
    assert_response_contains(result, "\"publishedStageCount\":5");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v364\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v364.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v364\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v364.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:fcb0fb568757a6ce\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-cli-smoke-contract\"");
    assert_response_contains(result, "\"stageSequence\":165");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v365\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v365\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":165");
