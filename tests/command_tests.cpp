...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-continuity-audit\"");
    assert_response_contains(result, "\"archiveStageSequence\":8");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v348\"");
    assert_response_contains(result, "\"publishedStageCount\":8");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v347\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v347.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v347\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v347.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v347\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v347.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:06a7a5ba45eba419\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-continuity-audit\"");
    assert_response_contains(result, "\"stageSequence\":148");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v348\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v348\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":148");
