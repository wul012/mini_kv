...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v150\"");
    ...
    assert_response_contains(result, "\"status\":\"live-read-gate-prerequisite-read-only\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v149\"");
    ...
    assert_response_contains(result, "\"activePrototypePlanFreeze\":{\"frozenReleaseVersion\":\"v149\"");
