...
int main() {
    ...
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-cli-smoke-contract\"");
    assert_response_contains(result, "\"rolloutStageSequence\":5");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v283\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v282\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v282.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v282\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v282.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:2193962195ba633a\"");
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-cli-smoke-contract\"");
    assert_response_contains(result, "\"stageSequence\":83");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v283\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v283\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":83");
