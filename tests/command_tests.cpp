...
int main() {
    ...
    assert_response_contains(result, "\"archiveStage\":\"route-preview-verification-report-archive-cli-smoke-contract\"");
    assert_response_contains(result, "\"archiveStageSequence\":14");
    assert_response_contains(result, "\"archiveReleaseVersion\":\"v354\"");
    assert_response_contains(result, "\"publishedStageCount\":14");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v353\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v353.json\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v353\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v353.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v353\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v353.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:44ee802faccd7e83\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-cli-smoke-contract\"");
    assert_response_contains(result, "\"stageSequence\":154");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v354\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v354\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":154");
