...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v215\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v214\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v214.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v214\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v214.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:05b61e656f9925b7\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-stage-descriptor-freeze\"");
    assert_response_contains(result, "\"stageSequence\":15");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v215\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v215\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":15");
