...
int main() {
    ...
    assert_response_contains(result, "\"publishedStageCount\":100");
    ...
    assert_response_contains(result, "\"publishedStageCount\":101");
    ...
    assert_response_contains(result, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-retention-map\"");
    assert_response_contains(result, "\"closeoutStageSequence\":10");
    assert_response_contains(result, "\"closeoutReleaseVersion\":\"v370\"");
    assert_response_contains(result, "\"publishedStageCount\":10");
    assert_response_contains(result, "\"plannedStageCount\":20");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v369\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v369.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v369\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v369.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:1a17d2e62f244c81\"");
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-retention-map\"");
    assert_response_contains(result, "\"stageSequence\":170");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v370\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v370\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":170");
