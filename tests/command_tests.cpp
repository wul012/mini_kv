...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v307\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v307.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-rollout-catalog-audit\"");
    assert_response_contains(result, "\"rolloutStageSequence\":10");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v308\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v307\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v307.json\"");
    ...
    assert_response_contains(result, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-rollout-catalog-audit\"");
    assert_response_contains(result, "\"stageSequence\":108");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v308\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v308\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":108");
