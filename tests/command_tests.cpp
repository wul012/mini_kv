...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v246\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v245\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v245.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v245\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v245.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:a4303386b8081c3e\"");
    assert_response_contains(result, "\"continuityStage\":\"post-closeout-continuity-node-v522-final-closeout-package-audit\"");
    assert_response_contains(result, "\"stageSequence\":46");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v246\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v246\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":46");
