...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v173\"");
    ...
    assert_response_contains(result, "\"status\":\"node-route-split-window-dry-run-adapter-read-only\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v172\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v172.json\"");
    ...
    assert_response_contains(result, "\"sourceNodePlan\":\"docs/plans3/"
                                     "v447-post-managed-audit-dry-run-adapter-route-group-split-roadmap.md\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v172\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v172.json\"");
    assert_response_contains(result, "\"windowStartNodeVersion\":\"Node v433\"");
    assert_response_contains(result, "\"windowEndNodeVersion\":\"Node v447\"");
    assert_response_contains(result, "\"splitRouteGroupCount\":15");
    ...
    assert_response_contains(result, "\"expectedWindowVersionCount\":15");
    assert_response_contains(result, "\"observedWindowVersionCount\":15");
    assert_response_contains(result, "\"windowRangeStart\":\"Node v433\"");
    assert_response_contains(result, "\"windowRangeEnd\":\"Node v447\"");
    ...
    assert_response_contains(result, "\"sourceFrozenWindowDigest\":\"fnv1a64:85f0acb5a011256f\"");
