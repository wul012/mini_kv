...
int main() {
    ...
    assert_response_contains(result, "\"releaseVersion\":\"v272\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v271\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v271.json\"");
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v271\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v271.json\"");
    assert_response_contains(result, "\"sourceFrozenDigest\":\"fnv1a64:e4ad76d27f327696\"");
    assert_response_contains(result, "\"continuityStage\":\"maintenance-refactor-boundary-field-facade-simplification\"");
    assert_response_contains(result, "\"stageSequence\":72");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v272\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v272\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":72");
