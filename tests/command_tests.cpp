...
int main() {
    ...
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v325\"");
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v325.json\"");
    assert_response_contains(result, "\"rolloutStage\":\"route-preview-verification-report-fixture-freeze\"");
    assert_response_contains(result, "\"rolloutStageSequence\":7");
    assert_response_contains(result, "\"rolloutReleaseVersion\":\"v326\"");
    ...
    assert_response_contains(result, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v325\"");
    assert_response_contains(result, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v325.json\"");
    ...
    assert_response_contains(
        result,
        "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-fixture-freeze\"");
    assert_response_contains(result, "\"stageSequence\":126");
    assert_response_contains(result, "\"stageReleaseVersion\":\"v326\"");
    ...
    assert_response_contains(result, "\"trackedPostCloseoutRangeEnd\":\"v326\"");
    assert_response_contains(result, "\"trackedPostCloseoutReleaseCount\":126");
