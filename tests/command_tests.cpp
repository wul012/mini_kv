...
int main() {
    ...
    assert_response_contains(
        result,
        "\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-comparison-closeout-audit-sibling-mutation-rejection-read-only\"");
    ...
    assert_response_contains(result, "\"draftTextPackageComparisonCloseoutAuditReleaseVersion\":\"v859\"");
    assert_response_contains(result, "\"sourceFrozenReleaseVersion\":\"v858\"");
    assert_response_contains(result, "\"publishedStageCount\":24");
    ...
    assert_response_contains(result, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v858.json\"");
