...
int main() {
    ...
    assert_contains(json,
                    "\"instructionPreflightStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-instruction-preflight-value-shape-slot\"");
    assert_contains(json, "\"instructionPreflightReleaseVersion\":\"v777\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v776\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v776.json\"");
    ...
    assert_contains(json, "\"draftInstructionSlotPreparedCount\":17");
    ...
    assert(digest.find("v777-route-preview-value-supply-signed-approval-capture-artifact-draft-instruction-preflight-value-shape-slot") !=
           std::string::npos);
