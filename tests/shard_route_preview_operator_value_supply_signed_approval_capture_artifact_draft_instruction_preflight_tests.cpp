...
int main() {
    ...
    assert_contains(json,
                    "\"instructionPreflightStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-instruction-preflight-review-digest-slot\"");
    assert_contains(json, "\"instructionPreflightReleaseVersion\":\"v764\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v763\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v763.json\"");
    ...
    assert_contains(json, "\"draftInstructionSlotPreparedCount\":4");
    ...
    assert(digest.find("v764-route-preview-value-supply-signed-approval-capture-artifact-draft-instruction-preflight-review-digest-slot") !=
           std::string::npos);
