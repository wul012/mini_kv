...
int main() {
    ...
    assert_contains(json,
                    "\"instructionPreflightStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-instruction-preflight-approval-grant-embargo-slot\"");
    assert_contains(json, "\"instructionPreflightReleaseVersion\":\"v781\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v780\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v780.json\"");
    ...
    assert_contains(json, "\"draftInstructionSlotPreparedCount\":21");
    ...
    assert(digest.find("v781-route-preview-value-supply-signed-approval-capture-artifact-draft-instruction-preflight-approval-grant-embargo-slot") !=
           std::string::npos);
