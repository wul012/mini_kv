...
int main() {
    ...
    assert_contains(json,
                    "\"instructionPreflightStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-instruction-preflight-operator-identity-slot\"");
    assert_contains(json, "\"instructionPreflightReleaseVersion\":\"v765\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v764\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v764.json\"");
    ...
    assert_contains(json, "\"draftInstructionSlotPreparedCount\":5");
    ...
    assert(digest.find("v765-route-preview-value-supply-signed-approval-capture-artifact-draft-instruction-preflight-operator-identity-slot") !=
           std::string::npos);
