...
int main() {
    ...
    assert_contains(json,
                    "\"instructionPreflightStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-instruction-preflight-redacted-value-digest-slot\"");
    assert_contains(json, "\"instructionPreflightReleaseVersion\":\"v776\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v775\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v775.json\"");
    ...
    assert_contains(json, "\"draftInstructionSlotPreparedCount\":16");
    ...
    assert(digest.find("v776-route-preview-value-supply-signed-approval-capture-artifact-draft-instruction-preflight-redacted-value-digest-slot") !=
           std::string::npos);
