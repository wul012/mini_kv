...
int main() {
    ...
    assert_contains(json,
                    "\"instructionPreflightStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-instruction-preflight-zero-value-import-embargo-slot\"");
    assert_contains(json, "\"instructionPreflightReleaseVersion\":\"v782\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v781\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v781.json\"");
    ...
    assert_contains(json, "\"draftInstructionSlotPreparedCount\":22");
    ...
    assert(digest.find("v782-route-preview-value-supply-signed-approval-capture-artifact-draft-instruction-preflight-zero-value-import-embargo-slot") !=
           std::string::npos);
