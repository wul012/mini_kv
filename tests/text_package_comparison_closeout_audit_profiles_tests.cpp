...
int main() {
    namespace profiles =
        minikv::shard_route_preview_operator_value_supply_signed_approval_capture_artifact_draft_text_package_comparison_closeout_audit_profiles;

    const auto records = profiles::signed_approval_capture_artifact_draft_text_package_comparison_closeout_audit_profiles();
    ...
    assert(profiles::planned_signed_approval_capture_artifact_draft_text_package_comparison_closeout_audit_profile_count() == 25);
    ...
    const auto all =
        profiles::format_signed_approval_capture_artifact_draft_text_package_comparison_closeout_audit_profiles_json(99);
