...
int main() {
    ...
    assert_contains(verification_json, "\"rolloutStage\":\"route-preview-verification-operator-handoff\"");
    assert_contains(verification_json, "\"rolloutStageSequence\":12");
    assert_contains(verification_json, "\"rolloutReleaseVersion\":\"v310\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v309\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v309.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-operator-handoff\"");
    assert_contains(rollout, "\"rolloutStageSequence\":12");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v310\"");
