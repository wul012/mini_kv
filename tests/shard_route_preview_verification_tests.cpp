...
int main() {
    ...
    assert_contains(verification_json, "\"rolloutStage\":\"route-preview-verification-fixture-freeze\"");
    assert_contains(verification_json, "\"rolloutStageSequence\":7");
    assert_contains(verification_json, "\"rolloutReleaseVersion\":\"v305\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v304\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v304.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-fixture-freeze\"");
    assert_contains(rollout, "\"rolloutStageSequence\":7");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v305\"");
