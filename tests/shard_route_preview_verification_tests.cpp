...
int main() {
    ...
    assert_contains(verification_json, "\"rolloutStage\":\"route-preview-verification-closeout-audit\"");
    assert_contains(verification_json, "\"rolloutStageSequence\":21");
    assert_contains(verification_json, "\"rolloutReleaseVersion\":\"v319\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v318\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v318.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-closeout-audit\"");
    assert_contains(rollout, "\"rolloutStageSequence\":21");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v319\"");
    assert_contains(rollout, "\"publishedStageCount\":21");
