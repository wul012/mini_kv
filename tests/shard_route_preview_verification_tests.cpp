...
int main() {
    ...
    assert_contains(verification_json, "\"rolloutStage\":\"route-preview-verification-rollout-catalog\"");
    assert_contains(verification_json, "\"rolloutStageSequence\":9");
    assert_contains(verification_json, "\"rolloutReleaseVersion\":\"v307\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v306\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v306.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-rollout-catalog\"");
    assert_contains(rollout, "\"rolloutStageSequence\":9");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v307\"");
