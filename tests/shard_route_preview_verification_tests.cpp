...
int main() {
    ...
    assert_contains(verification_json, "\"rolloutStage\":\"route-preview-verification-node-consumer-handoff\"");
    assert_contains(verification_json, "\"rolloutStageSequence\":13");
    assert_contains(verification_json, "\"rolloutReleaseVersion\":\"v311\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v310\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v310.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-node-consumer-handoff\"");
    assert_contains(rollout, "\"rolloutStageSequence\":13");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v311\"");
