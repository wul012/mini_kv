...
int main() {
    ...
    assert_contains(verification_json, "\"rolloutStage\":\"route-preview-verification-sample-parity-audit\"");
    assert_contains(verification_json, "\"rolloutStageSequence\":8");
    assert_contains(verification_json, "\"rolloutReleaseVersion\":\"v306\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v305\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v305.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-sample-parity-audit\"");
    assert_contains(rollout, "\"rolloutStageSequence\":8");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v306\"");
