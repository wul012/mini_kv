...
int main() {
    assert(minikv::shard_route_preview_operator_value_supply_approval_template_slots::
               planned_value_supply_approval_template_slot_count() == 25);

    const std::string slots =
        minikv::shard_route_preview_operator_value_supply_approval_template_slots::
            format_value_supply_approval_template_slots_json(1);
    ...
    minikv::test_support::assert_contains(
        slots,
        "\"sourcePrecheckCode\":\"VALUE_SUPPLY_PRECHECK_REQUIREMENT_CATALOG_SPLIT\"");
    ...
    minikv::test_support::assert_contains(slots, "\"approvalPacketAccepted\":false");
    ...
    minikv::test_support::assert_contains(slots, "\"approvalCorrelationIdRequired\":true");
    minikv::test_support::assert_contains(slots, "\"approvalCorrelationIdPresent\":false");
    minikv::test_support::assert_contains(slots, "\"redactedValueDigestRequired\":true");
    minikv::test_support::assert_contains(slots, "\"redactedValueDigestSupplied\":false");
    minikv::test_support::assert_contains(slots, "\"typedValueEnvelopeRequired\":true");
    minikv::test_support::assert_contains(slots, "\"typedValueEnvelopeSupplied\":false");
    ...
    const std::string completed_slots =
        minikv::shard_route_preview_operator_value_supply_approval_template_slots::
            format_value_supply_approval_template_slots_json(25);
