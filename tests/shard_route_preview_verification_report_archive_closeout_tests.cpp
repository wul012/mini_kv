...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-boundary-field-audit\"");
    assert_contains(closeout, "\"closeoutStageSequence\":16");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v376\"");
    assert_contains(closeout, "\"publishedStageCount\":16");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v375\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v375.json\"");
