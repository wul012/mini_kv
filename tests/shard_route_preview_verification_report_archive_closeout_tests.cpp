...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-command-contract\"");
    assert_contains(closeout, "\"closeoutStageSequence\":1");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v361\"");
    assert_contains(closeout, "\"publishedStageCount\":1");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v360\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v360.json\"");
