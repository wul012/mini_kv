...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-catalog-alignment\"");
    assert_contains(closeout, "\"closeoutStageSequence\":2");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v362\"");
    assert_contains(closeout, "\"publishedStageCount\":2");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v361\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v361.json\"");
