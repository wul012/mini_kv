...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-no-router-audit\"");
    assert_contains(closeout, "\"closeoutStageSequence\":17");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v377\"");
    assert_contains(closeout, "\"publishedStageCount\":17");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v376\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v376.json\"");
