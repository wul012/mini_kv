...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-cli-smoke-contract\"");
    assert_contains(closeout, "\"closeoutStageSequence\":5");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v365\"");
    assert_contains(closeout, "\"publishedStageCount\":5");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v364\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v364.json\"");
