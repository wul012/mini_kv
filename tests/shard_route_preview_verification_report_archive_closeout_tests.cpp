...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-java-echo-handoff\"");
    assert_contains(closeout, "\"closeoutStageSequence\":14");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v374\"");
    assert_contains(closeout, "\"publishedStageCount\":14");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v373\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v373.json\"");
