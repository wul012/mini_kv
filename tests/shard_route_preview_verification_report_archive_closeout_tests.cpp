...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-index-audit\"");
    assert_contains(closeout, "\"closeoutStageSequence\":9");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v369\"");
    assert_contains(closeout, "\"publishedStageCount\":9");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v368\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v368.json\"");
