...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-no-write-audit\"");
    assert_contains(closeout, "\"closeoutStageSequence\":18");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v378\"");
    assert_contains(closeout, "\"publishedStageCount\":18");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v377\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v377.json\"");
