...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-checkjson-contract\"");
    assert_contains(closeout, "\"closeoutStageSequence\":4");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v364\"");
    assert_contains(closeout, "\"publishedStageCount\":4");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v363\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v363.json\"");
