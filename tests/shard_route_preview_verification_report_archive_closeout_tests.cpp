...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-retention-map\"");
    assert_contains(closeout, "\"closeoutStageSequence\":10");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v370\"");
    assert_contains(closeout, "\"publishedStageCount\":10");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v369\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v369.json\"");
