...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-tcp-smoke-contract\"");
    assert_contains(closeout, "\"closeoutStageSequence\":6");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v366\"");
    assert_contains(closeout, "\"publishedStageCount\":6");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v365\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v365.json\"");
