...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-fixture-freeze\"");
    assert_contains(closeout, "\"closeoutStageSequence\":7");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v367\"");
    assert_contains(closeout, "\"publishedStageCount\":7");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v366\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v366.json\"");
