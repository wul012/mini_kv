...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-explain-contract\"");
    assert_contains(closeout, "\"closeoutStageSequence\":3");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v363\"");
    assert_contains(closeout, "\"publishedStageCount\":3");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v362\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v362.json\"");
