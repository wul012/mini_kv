...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-consumer-handoff\"");
    assert_contains(closeout, "\"closeoutStageSequence\":12");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v372\"");
    assert_contains(closeout, "\"publishedStageCount\":12");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v371\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v371.json\"");
