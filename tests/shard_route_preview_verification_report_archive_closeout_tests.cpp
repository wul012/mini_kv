...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-index\"");
    assert_contains(closeout, "\"closeoutStageSequence\":8");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v368\"");
    assert_contains(closeout, "\"publishedStageCount\":8");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v367\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v367.json\"");
