...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-retention-audit\"");
    assert_contains(closeout, "\"closeoutStageSequence\":11");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v371\"");
    assert_contains(closeout, "\"publishedStageCount\":11");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v370\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v370.json\"");
