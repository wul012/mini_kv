...
int main() {
    ...
    assert_contains(closeout, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-consumer-handoff-audit\"");
    assert_contains(closeout, "\"closeoutStageSequence\":13");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v373\"");
    assert_contains(closeout, "\"publishedStageCount\":13");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v372\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v372.json\"");
