...
int main() {
    ...
    const auto passed = validation::format_candidate_submission_precheck_validation_json(25, true, 10, 10, 10, 10, 10, 10);
    ...
    const auto failed = validation::format_candidate_submission_precheck_validation_json(24, true, 10, 10, 10, 10, 10, 10);
