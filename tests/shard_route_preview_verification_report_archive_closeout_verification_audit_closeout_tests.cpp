...
int main() {
    ...
    assert_contains(
        closeout,
        "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-verification-audit-closeout-retention-audit\"");
    assert_contains(closeout, "\"closeoutStageSequence\":11");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v431\"");
    assert_contains(closeout, "\"publishedStageCount\":11");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v430\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v430.json\"");
    ...
    assert(occurrence_count(shard, "\"shardRoutePreviewVerificationReportArchiveCloseoutVerificationAuditCloseout\":") ==
           1);
    assert_contains(shard, "\"closeoutReleaseVersion\":\"v431\"");
