...
int main() {
    ...
    assert_contains(
        closeout,
        "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-verification-audit-closeout-cli-smoke-contract\"");
    assert_contains(closeout, "\"closeoutStageSequence\":5");
    assert_contains(closeout, "\"closeoutReleaseVersion\":\"v425\"");
    assert_contains(closeout, "\"publishedStageCount\":5");
    assert_contains(closeout, "\"plannedStageCount\":20");
    assert_contains(closeout, "\"sourceFrozenReleaseVersion\":\"v424\"");
    assert_contains(closeout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v424.json\"");
    ...
    assert(occurrence_count(shard, "\"shardRoutePreviewVerificationReportArchiveCloseoutVerificationAuditCloseout\":") ==
           1);
    assert_contains(shard, "\"closeoutReleaseVersion\":\"v425\"");
