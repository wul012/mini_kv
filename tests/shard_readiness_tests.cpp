...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"draftTextPackageComparedPackageEvidenceIntakeAuditReleaseVersion\":\"v867\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v866\"");
    assert_contains(json, "\"publishedStageCount\":7");
    ...
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v866.json\"");
