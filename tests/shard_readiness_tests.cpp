...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v310\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v309\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v309.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-operator-handoff\"");
    assert_contains(json, "\"rolloutStageSequence\":12");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v310\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v310 as read-only shard route preview verification operator-handoff evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v309\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v309.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v309 as read-only shard route preview verification history-fallback-freeze evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-operator-handoff\"");
    assert_contains(json, "\"stageSequence\":110");
    assert_contains(json, "\"stageReleaseVersion\":\"v310\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v310\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":110");
