...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v367\"");
    ...
    assert_contains(json, "\"publishedStageCount\":70");
    ...
    assert_contains(json, "\"publishedStageCount\":71");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-fixture-freeze\"");
    assert_contains(json, "\"closeoutStageSequence\":7");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v367\"");
    assert_contains(json, "\"publishedStageCount\":7");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v366\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v366.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v367 as read-only shard route preview verification report archive closeout fixture-freeze evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v366\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v366.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v367 as read-only shard route preview verification report archive closeout fixture-freeze evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v366\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v366.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:7d30ce173c4909ff\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-fixture-freeze\"");
    assert_contains(json, "\"stageSequence\":167");
    assert_contains(json, "\"stageReleaseVersion\":\"v367\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v367\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":167");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-fixture-freeze\"");
