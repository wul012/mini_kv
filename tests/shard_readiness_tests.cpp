...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v307\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v306\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v306.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-rollout-catalog\"");
    assert_contains(json, "\"rolloutStageSequence\":9");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v307\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v307 as read-only shard route preview verification rollout-catalog evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v306\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v306.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v306 as read-only shard route preview verification sample-parity-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-rollout-catalog\"");
    assert_contains(json, "\"stageSequence\":107");
    assert_contains(json, "\"stageReleaseVersion\":\"v307\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v307\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":107");
