...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v226\"");
    ...
    assert_contains(json, "\"historicalFixturePaths\":[\"fixtures/release/shard-readiness-v144.json\","
                          ...
                          "\"fixtures/release/shard-readiness-v200.json\",\"fixtures/release/shard-readiness-v201.json\",\"fixtures/release/shard-readiness-v202.json\",\"fixtures/release/shard-readiness-v203.json\",\"fixtures/release/shard-readiness-v204.json\",\"fixtures/release/shard-readiness-v205.json\",\"fixtures/release/shard-readiness-v206.json\",\"fixtures/release/shard-readiness-v207.json\",\"fixtures/release/shard-readiness-v208.json\",\"fixtures/release/shard-readiness-v209.json\",\"fixtures/release/shard-readiness-v210.json\",\"fixtures/release/shard-readiness-v211.json\",\"fixtures/release/shard-readiness-v212.json\",\"fixtures/release/shard-readiness-v213.json\",\"fixtures/release/shard-readiness-v214.json\",\"fixtures/release/shard-readiness-v215.json\",\"fixtures/release/shard-readiness-v216.json\",\"fixtures/release/shard-readiness-v217.json\",\"fixtures/release/shard-readiness-v218.json\",\"fixtures/release/shard-readiness-v219.json\",\"fixtures/release/shard-readiness-v220.json\",\"fixtures/release/shard-readiness-v221.json\",\"fixtures/release/shard-readiness-v222.json\",\"fixtures/release/shard-readiness-v223.json\",\"fixtures/release/shard-readiness-v224.json\",\"fixtures/release/shard-readiness-v225.json\"]");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v225\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v225.json\"");
    assert_contains(
        json,
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v225\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v225.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:b720e589ca8d9bc7\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v505-readiness-handoff-archive-verification-route-release-catalog-audit\"");
    assert_contains(json, "\"stageSequence\":26");
    assert_contains(json, "\"stageReleaseVersion\":\"v226\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v226\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":26");
