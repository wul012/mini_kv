...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v280\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v279\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v279.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-command-catalog-alignment\"");
    assert_contains(json, "\"rolloutStageSequence\":2");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v280\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v280 as read-only shard route preview route-preview-command-catalog-alignment evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v279\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v279.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v279 as read-only shard route preview route-preview-command-contract evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-command-catalog-alignment\"");
    assert_contains(json, "\"stageSequence\":80");
    assert_contains(json, "\"stageReleaseVersion\":\"v280\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v280\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":80");
