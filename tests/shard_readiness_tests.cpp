...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v316\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v315\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v315.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-no-execution-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":18");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v316\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v316 as read-only shard route preview verification no-execution-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v315\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v315.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v315 as read-only shard route preview verification no-write-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-no-execution-audit\"");
    assert_contains(json, "\"stageSequence\":116");
    assert_contains(json, "\"stageReleaseVersion\":\"v316\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v316\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":116");
