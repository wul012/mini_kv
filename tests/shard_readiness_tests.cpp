...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v347\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-continuity-map\"");
    assert_contains(json, "\"archiveStageSequence\":7");
    assert_contains(json, "\"archiveReleaseVersion\":\"v347\"");
    assert_contains(json, "\"publishedStageCount\":7");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v346\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v346.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v347 as read-only shard route preview verification report archive continuity map evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v346\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v346.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v347 as read-only shard route preview verification report archive continuity map evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v346\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v346.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:5a2f46c60bb2a2e6\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-continuity-map\"");
    assert_contains(json, "\"stageSequence\":147");
    assert_contains(json, "\"stageReleaseVersion\":\"v347\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v347\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":147");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-continuity-map\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
