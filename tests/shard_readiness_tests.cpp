...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v373\"");
    ...
    assert_contains(json, "\"publishedStageCount\":130");
    ...
    assert_contains(json, "\"publishedStageCount\":131");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-consumer-handoff-audit\"");
    assert_contains(json, "\"closeoutStageSequence\":13");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v373\"");
    assert_contains(json, "\"publishedStageCount\":13");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v372\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v372.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v373 as read-only shard route preview verification report archive closeout consumer-handoff-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v372\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v372.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v373 as read-only shard route preview verification report archive closeout consumer-handoff-audit evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v372\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v372.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:69cd33783dfffba4\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-consumer-handoff-audit\"");
    assert_contains(json, "\"stageSequence\":173");
    assert_contains(json, "\"stageReleaseVersion\":\"v373\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v373\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":173");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-consumer-handoff-audit\"");
