...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v285\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v284\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v284.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-fixture-freeze\"");
    assert_contains(json, "\"rolloutStageSequence\":7");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v285\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v284\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v284.json\"");
    assert_contains(
        json,
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-fixture-freeze\"");
    assert_contains(json, "\"stageSequence\":85");
    assert_contains(json, "\"stageReleaseVersion\":\"v285\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v285\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":85");
