...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v336\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v335\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v335.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-no-write-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":17");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v336\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v336 as read-only shard route preview verification report no-write-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v335\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v335.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v335 as read-only shard route preview verification report no-router-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-no-write-audit\"");
    assert_contains(json, "\"stageSequence\":136");
    assert_contains(json, "\"stageReleaseVersion\":\"v336\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v336\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":136");
