...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v378\"");
    ...
    assert_contains(json, "\"publishedStageCount\":180");
    ...
    assert_contains(json, "\"publishedStageCount\":181");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-no-write-audit\"");
    assert_contains(json, "\"closeoutStageSequence\":18");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v378\"");
    assert_contains(json, "\"publishedStageCount\":18");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v377\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v377.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v378 as read-only shard route preview verification report archive closeout no-write-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v377\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v377.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v378 as read-only shard route preview verification report archive closeout no-write-audit evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v377\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v377.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:d0e5eaecd7466a6d\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-no-write-audit\"");
    assert_contains(json, "\"stageSequence\":178");
    assert_contains(json, "\"stageReleaseVersion\":\"v378\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v378\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":178");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-no-write-audit\"");
