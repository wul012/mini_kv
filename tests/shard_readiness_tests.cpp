...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v262 as Node v549 final verification ready evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v261\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v261.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v261 Node v549 final closeout package audit evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:1c833e424df779d8\"");
