...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v237\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v236\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v236.json\"");
    assert_contains(
        json,
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v236\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v236.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:ffee5a44b8688bd6\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v522-stability-archive-package\"");
    assert_contains(json, "\"stageSequence\":37");
    assert_contains(json, "\"stageReleaseVersion\":\"v237\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v237\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":37");
