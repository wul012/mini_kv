...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v306\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v305\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v305.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-sample-parity-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":8");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v306\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v306 as read-only shard route preview verification sample-parity-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v305\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v305.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v305 as read-only shard route preview verification fixture-freeze evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-sample-parity-audit\"");
    assert_contains(json, "\"stageSequence\":106");
    assert_contains(json, "\"stageReleaseVersion\":\"v306\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v306\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":106");
