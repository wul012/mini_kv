...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v238\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v523+ may consume v238 as Node v522 stability archive package audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v237\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v237.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v523+ may consume v237 Node v522 stability archive package evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v237\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v237.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:241dc6d5438fd5ee\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v522-stability-archive-package-audit\"");
    assert_contains(json, "\"stageSequence\":38");
    assert_contains(json, "\"stageReleaseVersion\":\"v238\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v238\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":38");
