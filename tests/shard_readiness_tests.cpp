...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v317\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v316\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v316.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-release-package\"");
    assert_contains(json, "\"rolloutStageSequence\":19");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v317\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v317 as read-only shard route preview verification release-package evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v316\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v316.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v316 as read-only shard route preview verification no-execution-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-release-package\"");
    assert_contains(json, "\"stageSequence\":117");
    assert_contains(json, "\"stageReleaseVersion\":\"v317\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v317\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":117");
