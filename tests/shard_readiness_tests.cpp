...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v325\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v324\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v324.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-tcp-smoke-contract\"");
    assert_contains(json, "\"rolloutStageSequence\":6");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v325\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v325 as read-only shard route preview verification report tcp-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v324\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v324.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v324 as read-only shard route preview verification report cli-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-tcp-smoke-contract\"");
    assert_contains(json, "\"stageSequence\":125");
    assert_contains(json, "\"stageReleaseVersion\":\"v325\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v325\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":125");
