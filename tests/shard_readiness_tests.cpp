...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v303\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v302\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v302.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-cli-smoke-contract\"");
    assert_contains(json, "\"rolloutStageSequence\":5");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v303\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v303 as read-only shard route preview verification cli-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v302\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v302.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v302 as read-only shard route preview verification checkjson-contract evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-cli-smoke-contract\"");
    assert_contains(json, "\"stageSequence\":103");
    assert_contains(json, "\"stageReleaseVersion\":\"v303\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v303\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":103");
