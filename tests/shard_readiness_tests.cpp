...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v235\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v523+ may consume v235 as Node v522 stability evidence report readiness only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v234\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v234.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v523+ may consume v234 Node v522 twenty-version run closeout alignment audit evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v234\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v234.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:97d3419bb7663fde\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v522-stability-evidence-report-readiness\"");
    assert_contains(json, "\"stageSequence\":35");
    assert_contains(json, "\"stageReleaseVersion\":\"v235\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v235\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":35");
