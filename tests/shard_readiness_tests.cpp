...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v345\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-retention-map\"");
    assert_contains(json, "\"archiveStageSequence\":5");
    assert_contains(json, "\"archiveReleaseVersion\":\"v345\"");
    assert_contains(json, "\"publishedStageCount\":5");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v344\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v344.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v345 as read-only shard route preview verification report archive retention map evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v344\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v344.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v345 as read-only shard route preview verification report archive retention map evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v344\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v344.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:a3ab2b889b3c75df\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-retention-map\"");
    assert_contains(json, "\"stageSequence\":145");
    assert_contains(json, "\"stageReleaseVersion\":\"v345\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v345\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":145");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-retention-map\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
