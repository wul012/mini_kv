...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v330\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v329\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v329.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-history-fallback-freeze\"");
    assert_contains(json, "\"rolloutStageSequence\":11");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v330\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v330 as read-only shard route preview verification report history-fallback-freeze evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v329\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v329.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v329 as read-only shard route preview verification report rollout-catalog-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-history-fallback-freeze\"");
    assert_contains(json, "\"stageSequence\":130");
    assert_contains(json, "\"stageReleaseVersion\":\"v330\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v330\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":130");
