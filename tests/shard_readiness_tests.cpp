...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v296\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v295\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v295.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-no-execution-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":18");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v296\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v296 as read-only shard route preview route-preview-no-execution-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v295\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v295.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v295 as read-only shard route preview route-preview-no-write-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-no-execution-audit\"");
    assert_contains(json, "\"stageSequence\":96");
    assert_contains(json, "\"stageReleaseVersion\":\"v296\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v296\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":96");
