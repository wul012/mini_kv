...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v326\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v325\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v325.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-fixture-freeze\"");
    assert_contains(json, "\"rolloutStageSequence\":7");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v326\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v326 as read-only shard route preview verification report fixture-freeze evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v325\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v325.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v325 as read-only shard route preview verification report tcp-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-fixture-freeze\"");
    assert_contains(json, "\"stageSequence\":126");
    assert_contains(json, "\"stageReleaseVersion\":\"v326\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v326\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":126");
