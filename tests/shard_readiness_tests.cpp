...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"maintenanceStage\":\"route-preview-archive-maintenance-retention-audit\"");
    assert_contains(json, "\"maintenanceStageSequence\":15");
    assert_contains(json, "\"maintenanceReleaseVersion\":\"v475\"");
    assert_contains(json, "\"sharedStageCatalogFormatterApplied\":true");
