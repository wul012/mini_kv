...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"maintenanceStage\":\"route-preview-archive-maintenance-cli-smoke-contract\"");
    assert_contains(json, "\"maintenanceStageSequence\":9");
    assert_contains(json, "\"maintenanceReleaseVersion\":\"v469\"");
    assert_contains(json, "\"sharedStageCatalogFormatterApplied\":true");
