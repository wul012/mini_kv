...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v276\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v276 as maintenance-only shard readiness lifecycle section split evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v275\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v275.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v275 as maintenance-only TCP RESP server lifecycle harness extraction evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v275\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v275.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:7e6cea027911c562\"");
    assert_contains(json, "\"continuityStage\":\"maintenance-refactor-shard-readiness-lifecycle-section-split\"");
    assert_contains(json, "\"stageSequence\":76");
    assert_contains(json, "\"stageReleaseVersion\":\"v276\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v276\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":76");
