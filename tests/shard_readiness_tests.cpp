...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v338\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v337\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v337.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-release-package\"");
    assert_contains(json, "\"rolloutStageSequence\":19");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v338\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v338 as read-only shard route preview verification report release-package evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v337\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v337.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v337 as read-only shard route preview verification report no-execution-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-release-package\"");
    assert_contains(json, "\"stageSequence\":138");
    assert_contains(json, "\"stageReleaseVersion\":\"v338\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v338\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":138");
