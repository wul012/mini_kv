...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v220\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v499+ may consume v220 as route catalog cleanup continuity batch package audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFixturePaths\":[\"fixtures/release/shard-readiness-v144.json\","
                          ...
                          "\"fixtures/release/shard-readiness-v200.json\",\"fixtures/release/shard-readiness-v201.json\",\"fixtures/release/shard-readiness-v202.json\",\"fixtures/release/shard-readiness-v203.json\",\"fixtures/release/shard-readiness-v204.json\",\"fixtures/release/shard-readiness-v205.json\",\"fixtures/release/shard-readiness-v206.json\",\"fixtures/release/shard-readiness-v207.json\",\"fixtures/release/shard-readiness-v208.json\",\"fixtures/release/shard-readiness-v209.json\",\"fixtures/release/shard-readiness-v210.json\",\"fixtures/release/shard-readiness-v211.json\",\"fixtures/release/shard-readiness-v212.json\",\"fixtures/release/shard-readiness-v213.json\",\"fixtures/release/shard-readiness-v214.json\",\"fixtures/release/shard-readiness-v215.json\",\"fixtures/release/shard-readiness-v216.json\",\"fixtures/release/shard-readiness-v217.json\",\"fixtures/release/shard-readiness-v218.json\",\"fixtures/release/shard-readiness-v219.json\"]");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v219\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v219.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v499+ may consume v219 post closeout continuity v211-v218 batch package\"");
    ...
    assert_contains(json, "\"sourceNodePlan\":\"docs/plans3/"
                          "v498-post-java-mini-kv-route-catalog-cleanup-consumer-readiness-batch-closeout-archive-roadmap.md\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v219\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v219.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:78b10360a474df83\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-v211-v219-batch-package-audit\"");
    assert_contains(json, "\"stageSequence\":20");
    assert_contains(json, "\"stageReleaseVersion\":\"v220\"");
    assert_contains(json, "\"nodeBatchCloseoutVersion\":\"Node v498\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v220\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":20");
