...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v207\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v491+ may consume v207 as route catalog cleanup post-closeout continuity evidence only\"");
    ...
    assert_contains(json, "\"historicalFixturePaths\":[\"fixtures/release/shard-readiness-v144.json\","
                          ...
                          "\"fixtures/release/shard-readiness-v200.json\",\"fixtures/release/shard-readiness-v201.json\",\"fixtures/release/shard-readiness-v202.json\",\"fixtures/release/shard-readiness-v203.json\",\"fixtures/release/shard-readiness-v204.json\",\"fixtures/release/shard-readiness-v205.json\",\"fixtures/release/shard-readiness-v206.json\"]");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v206\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v206.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v491+ may consume v206 post closeout verification checklist audit\"");
    ...
    assert_contains(json, "\"sourceNodePlan\":\"docs/plans3/"
                          "v480-post-java-mini-kv-route-catalog-cleanup-evidence-batch-closeout-roadmap.md\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v206\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v206.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:1e5f3dc941b1a90e\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-archive-verification-route-checkpoint\"");
    assert_contains(json, "\"stageSequence\":7");
    assert_contains(json, "\"stageReleaseVersion\":\"v207\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v207\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":7");
