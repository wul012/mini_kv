...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v240\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v523+ may consume v240 as Node v522 CI and catalog health audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v239\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v239.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v523+ may consume v239 Node v522 CI and catalog health snapshot evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v239\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v239.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:e27115beafa3626e\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v522-ci-catalog-health-audit\"");
    assert_contains(json, "\"stageSequence\":40");
    assert_contains(json, "\"stageReleaseVersion\":\"v240\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v240\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":40");
