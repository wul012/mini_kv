...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v329\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v328\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v328.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-rollout-catalog-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":10");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v329\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v329 as read-only shard route preview verification report rollout-catalog-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v328\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v328.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v328 as read-only shard route preview verification report rollout-catalog evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-rollout-catalog-audit\"");
    assert_contains(json, "\"stageSequence\":129");
    assert_contains(json, "\"stageReleaseVersion\":\"v329\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v329\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":129");
