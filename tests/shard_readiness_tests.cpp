...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v260\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v260 as Node v549 final closeout package evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v259\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v259.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v259 Node v550 route exposure readiness audit evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v259\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v259.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:4ecbafd95ed78ab6\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v549-final-closeout-package\"");
    assert_contains(json, "\"stageSequence\":60");
    assert_contains(json, "\"stageReleaseVersion\":\"v260\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v260\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":60");
