...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v318\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v317\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v317.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-release-package-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":20");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v318\"");
    assert_contains(json, "\"publishedStageCount\":20");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v318 as read-only shard route preview verification release-package-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v317\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v317.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v317 as read-only shard route preview verification release-package evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-release-package-audit\"");
    assert_contains(json, "\"stageSequence\":118");
    assert_contains(json, "\"stageReleaseVersion\":\"v318\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v318\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":118");
