...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v523+ may consume v243 as Node v522 downstream consumption handoff evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v242\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v242.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v523+ may consume v242 Node v522 stability closeout audit evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:70672aaa77bbacfa\"");
