...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"maintenanceStage\":\"route-preview-archive-maintenance-fixture-freeze\"");
    assert_contains(json, "\"maintenanceStageSequence\":11");
    assert_contains(json, "\"maintenanceReleaseVersion\":\"v471\"");
    assert_contains(json, "\"sharedStageCatalogFormatterApplied\":true");
