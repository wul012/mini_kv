...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v291\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v290\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v290.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-node-consumer-handoff\"");
    assert_contains(json, "\"rolloutStageSequence\":13");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v291\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v291 as read-only shard route preview route-preview-node-consumer-handoff evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v290\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v290.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v290 as read-only shard route preview route-preview-operator-handoff evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-node-consumer-handoff\"");
    assert_contains(json, "\"stageSequence\":91");
    assert_contains(json, "\"stageReleaseVersion\":\"v291\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v291\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":91");
