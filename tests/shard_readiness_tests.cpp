...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v352\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-java-echo-audit\"");
    assert_contains(json, "\"archiveStageSequence\":12");
    assert_contains(json, "\"archiveReleaseVersion\":\"v352\"");
    assert_contains(json, "\"publishedStageCount\":12");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v351\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v351.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v352 as read-only shard route preview verification report archive java echo audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v351\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v351.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v352 as read-only shard route preview verification report archive java echo audit evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v351\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v351.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:85099e82c1bad69c\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-java-echo-audit\"");
    assert_contains(json, "\"stageSequence\":152");
    assert_contains(json, "\"stageReleaseVersion\":\"v352\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v352\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":152");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-java-echo-audit\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
