...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v364\"");
    ...
    assert_contains(json, "\"publishedStageCount\":40");
    ...
    assert_contains(json, "\"publishedStageCount\":41");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-checkjson-contract\"");
    assert_contains(json, "\"closeoutStageSequence\":4");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v364\"");
    assert_contains(json, "\"publishedStageCount\":4");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v363\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v363.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v364 as read-only shard route preview verification report archive closeout checkjson-contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v363\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v363.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v364 as read-only shard route preview verification report archive closeout checkjson-contract evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v363\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v363.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:e38a70be9e5ca290\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-checkjson-contract\"");
    assert_contains(json, "\"stageSequence\":164");
    assert_contains(json, "\"stageReleaseVersion\":\"v364\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v364\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":164");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-checkjson-contract\"");
