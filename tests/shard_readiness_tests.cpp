...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v284\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v283\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v283.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-tcp-smoke-contract\"");
    assert_contains(json, "\"rolloutStageSequence\":6");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v284\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v284 as read-only shard route preview route-preview-tcp-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v283\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v283.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v283 as read-only shard route preview route-preview-cli-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-tcp-smoke-contract\"");
    assert_contains(json, "\"stageSequence\":84");
    assert_contains(json, "\"stageReleaseVersion\":\"v284\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v284\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":84");
