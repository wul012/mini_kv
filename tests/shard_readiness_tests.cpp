...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v265\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v265 as maintenance-only CMake linked test helper evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v264\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v264.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v264 as maintenance-only shard readiness historical fixture loop evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v264\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v264.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:84d8aaf28b495b68\"");
    assert_contains(json, "\"continuityStage\":\"maintenance-refactor-cmake-linked-test-helper\"");
    assert_contains(json, "\"stageSequence\":65");
    assert_contains(json, "\"stageReleaseVersion\":\"v265\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v265\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":65");
