...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v319\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v319 as read-only shard route preview verification closeout-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v318\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v318.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v318 as read-only shard route preview verification release-package-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-closeout-audit\"");
    assert_contains(json, "\"stageSequence\":119");
    assert_contains(json, "\"stageReleaseVersion\":\"v319\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v319\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":119");
