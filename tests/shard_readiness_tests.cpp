...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v365\"");
    ...
    assert_contains(json, "\"publishedStageCount\":50");
    ...
    assert_contains(json, "\"publishedStageCount\":51");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-cli-smoke-contract\"");
    assert_contains(json, "\"closeoutStageSequence\":5");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v365\"");
    assert_contains(json, "\"publishedStageCount\":5");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v364\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v364.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v365 as read-only shard route preview verification report archive closeout cli-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v364\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v364.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v365 as read-only shard route preview verification report archive closeout cli-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v364\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v364.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:fcb0fb568757a6ce\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-cli-smoke-contract\"");
    assert_contains(json, "\"stageSequence\":165");
    assert_contains(json, "\"stageReleaseVersion\":\"v365\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v365\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":165");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-cli-smoke-contract\"");
