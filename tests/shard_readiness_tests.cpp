...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v283\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v282\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v282.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-cli-smoke-contract\"");
    assert_contains(json, "\"rolloutStageSequence\":5");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v283\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v283 as read-only shard route preview route-preview-cli-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v282\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v282.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v282 as read-only shard route preview route-preview-checkjson-contract evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-cli-smoke-contract\"");
    assert_contains(json, "\"stageSequence\":83");
    assert_contains(json, "\"stageReleaseVersion\":\"v283\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v283\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":83");
