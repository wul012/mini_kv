...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v298\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v298 as read-only shard route preview route-preview-release-package-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v297\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v297.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v297 as read-only shard route preview route-preview-release-package evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-release-package-audit\"");
    assert_contains(json, "\"stageSequence\":98");
    assert_contains(json, "\"stageReleaseVersion\":\"v298\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v298\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":98");
