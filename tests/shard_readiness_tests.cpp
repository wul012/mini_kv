...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v366\"");
    ...
    assert_contains(json, "\"publishedStageCount\":60");
    ...
    assert_contains(json, "\"publishedStageCount\":61");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-tcp-smoke-contract\"");
    assert_contains(json, "\"closeoutStageSequence\":6");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v366\"");
    assert_contains(json, "\"publishedStageCount\":6");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v365\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v365.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v366 as read-only shard route preview verification report archive closeout tcp-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v365\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v365.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v366 as read-only shard route preview verification report archive closeout tcp-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v365\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v365.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:31a147edd9e5183c\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-tcp-smoke-contract\"");
    assert_contains(json, "\"stageSequence\":166");
    assert_contains(json, "\"stageReleaseVersion\":\"v366\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v366\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":166");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-tcp-smoke-contract\"");
