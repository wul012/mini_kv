...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v236\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v235\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v235.json\"");
    assert_contains(
        json,
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v235\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v235.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:801952cee74210ef\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v522-stability-evidence-report-readiness-audit\"");
    assert_contains(json, "\"stageSequence\":36");
    assert_contains(json, "\"stageReleaseVersion\":\"v236\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v236\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":36");
