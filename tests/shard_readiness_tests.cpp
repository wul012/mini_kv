...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v322\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v321\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v321.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-explain-contract\"");
    assert_contains(json, "\"rolloutStageSequence\":3");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v322\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v322 as read-only shard route preview verification report explain-contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v321\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v321.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v321 as read-only shard route preview verification report command-catalog-alignment evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-explain-contract\"");
    assert_contains(json, "\"stageSequence\":122");
    assert_contains(json, "\"stageReleaseVersion\":\"v322\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v322\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":122");
