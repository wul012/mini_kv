...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v328\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v327\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v327.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-rollout-catalog\"");
    assert_contains(json, "\"rolloutStageSequence\":9");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v328\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v328 as read-only shard route preview verification report rollout-catalog evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v327\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v327.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v327 as read-only shard route preview verification report sample-parity-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-rollout-catalog\"");
    assert_contains(json, "\"stageSequence\":128");
    assert_contains(json, "\"stageReleaseVersion\":\"v328\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v328\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":128");
