...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"publishedStageCount\":110");
    ...
    assert_contains(json, "\"publishedStageCount\":111");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-retention-audit\"");
    assert_contains(json, "\"closeoutStageSequence\":11");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v371\"");
    assert_contains(json, "\"publishedStageCount\":11");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v370\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v370.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v371 as read-only shard route preview verification report archive closeout retention-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v370\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v370.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v371 as read-only shard route preview verification report archive closeout retention-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-retention-audit\"");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-retention-audit\"");
