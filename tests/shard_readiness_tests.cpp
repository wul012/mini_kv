...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v346\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-retention-audit\"");
    assert_contains(json, "\"archiveStageSequence\":6");
    assert_contains(json, "\"archiveReleaseVersion\":\"v346\"");
    assert_contains(json, "\"publishedStageCount\":6");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v345\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v345.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v346 as read-only shard route preview verification report archive retention audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v345\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v345.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v346 as read-only shard route preview verification report archive retention audit evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v345\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v345.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:68111a874e1be61a\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-retention-audit\"");
    assert_contains(json, "\"stageSequence\":146");
    assert_contains(json, "\"stageReleaseVersion\":\"v346\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v346\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":146");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-retention-audit\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
