...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v344\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-index-audit\"");
    assert_contains(json, "\"archiveStageSequence\":4");
    assert_contains(json, "\"archiveReleaseVersion\":\"v344\"");
    assert_contains(json, "\"publishedStageCount\":4");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v343\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v343.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v344 as read-only shard route preview verification report archive index audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v343\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v343.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v344 as read-only shard route preview verification report archive index audit evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v343\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v343.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:2ff62b23da30ba9d\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-index-audit\"");
    assert_contains(json, "\"stageSequence\":144");
    assert_contains(json, "\"stageReleaseVersion\":\"v344\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v344\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":144");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-index-audit\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
