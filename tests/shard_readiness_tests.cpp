...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v351\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-java-echo-handoff\"");
    assert_contains(json, "\"archiveStageSequence\":11");
    assert_contains(json, "\"archiveReleaseVersion\":\"v351\"");
    assert_contains(json, "\"publishedStageCount\":11");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v350\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v350.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v351 as read-only shard route preview verification report archive java echo handoff evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v350\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v350.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v351 as read-only shard route preview verification report archive java echo handoff evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v350\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v350.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:3c51622ccdb38a8f\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-java-echo-handoff\"");
    assert_contains(json, "\"stageSequence\":151");
    assert_contains(json, "\"stageReleaseVersion\":\"v351\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v351\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":151");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-java-echo-handoff\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
