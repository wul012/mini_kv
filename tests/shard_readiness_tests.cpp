...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v308\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v307\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v307.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-rollout-catalog-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":10");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v308\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v308 as read-only shard route preview verification rollout-catalog-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v307\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v307.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v307 as read-only shard route preview verification rollout-catalog evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-rollout-catalog-audit\"");
    assert_contains(json, "\"stageSequence\":108");
    assert_contains(json, "\"stageReleaseVersion\":\"v308\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v308\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":108");
