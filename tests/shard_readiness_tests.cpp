...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v309\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v308\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v308.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-history-fallback-freeze\"");
    assert_contains(json, "\"rolloutStageSequence\":11");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v309\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v309 as read-only shard route preview verification history-fallback-freeze evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v308\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v308.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v308 as read-only shard route preview verification rollout-catalog-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-history-fallback-freeze\"");
    assert_contains(json, "\"stageSequence\":109");
    assert_contains(json, "\"stageReleaseVersion\":\"v309\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v309\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":109");
