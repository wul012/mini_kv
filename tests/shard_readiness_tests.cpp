...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"maintenanceStage\":\"route-preview-archive-maintenance-tcp-smoke-contract\"");
    assert_contains(json, "\"maintenanceStageSequence\":10");
    assert_contains(json, "\"maintenanceReleaseVersion\":\"v470\"");
    assert_contains(json, "\"sharedStageCatalogFormatterApplied\":true");
