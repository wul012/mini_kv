...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v337\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v336\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v336.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-no-execution-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":18");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v337\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v337 as read-only shard route preview verification report no-execution-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v336\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v336.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v336 as read-only shard route preview verification report no-write-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-no-execution-audit\"");
    assert_contains(json, "\"stageSequence\":137");
    assert_contains(json, "\"stageReleaseVersion\":\"v337\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v337\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":137");
