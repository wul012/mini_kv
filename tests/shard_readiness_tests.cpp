...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"maintenanceStage\":\"route-preview-archive-maintenance-no-execution-audit\"");
    assert_contains(json, "\"maintenanceStageSequence\":24");
    assert_contains(json, "\"maintenanceReleaseVersion\":\"v484\"");
    assert_contains(json, "\"sharedStageCatalogFormatterApplied\":true");
