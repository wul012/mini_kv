...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v290\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v289\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v289.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-operator-handoff\"");
    assert_contains(json, "\"rolloutStageSequence\":12");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v290\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v290 as read-only shard route preview route-preview-operator-handoff evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v289\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v289.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v289 as read-only shard route preview route-preview-history-fallback-freeze evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-operator-handoff\"");
    assert_contains(json, "\"stageSequence\":90");
    assert_contains(json, "\"stageReleaseVersion\":\"v290\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v290\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":90");
