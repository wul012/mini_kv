...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v273\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v273 as maintenance-only CMake standalone source-dir test helper evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v272\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v272.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v272 as maintenance-only boundary field facade simplification evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v272\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v272.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:4f819aca4d500c49\"");
    assert_contains(json, "\"continuityStage\":\"maintenance-refactor-cmake-standalone-source-dir-test-helper\"");
    assert_contains(json, "\"stageSequence\":73");
    assert_contains(json, "\"stageReleaseVersion\":\"v273\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v273\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":73");
