...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v294\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v293\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v293.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-no-router-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":16");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v294\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v294 as read-only shard route preview route-preview-no-router-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v293\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v293.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v293 as read-only shard route preview route-preview-boundary-field-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-no-router-audit\"");
    assert_contains(json, "\"stageSequence\":94");
    assert_contains(json, "\"stageReleaseVersion\":\"v294\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v294\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":94");
