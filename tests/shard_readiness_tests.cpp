...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v348\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-continuity-audit\"");
    assert_contains(json, "\"archiveStageSequence\":8");
    assert_contains(json, "\"archiveReleaseVersion\":\"v348\"");
    assert_contains(json, "\"publishedStageCount\":8");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v347\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v347.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v348 as read-only shard route preview verification report archive continuity audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v347\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v347.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v348 as read-only shard route preview verification report archive continuity audit evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v347\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v347.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:06a7a5ba45eba419\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-continuity-audit\"");
    assert_contains(json, "\"stageSequence\":148");
    assert_contains(json, "\"stageReleaseVersion\":\"v348\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v348\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":148");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-continuity-audit\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
