...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v249\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v249 as Node v549 archive verification alignment audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v248\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v248.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v248 Node v549 archive verification alignment evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v248\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v248.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:b001b36a42e8e809\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v549-archive-verification-alignment-audit\"");
    assert_contains(json, "\"stageSequence\":49");
    assert_contains(json, "\"stageReleaseVersion\":\"v249\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v249\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":49");
