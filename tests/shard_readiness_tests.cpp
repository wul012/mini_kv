...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v206\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v491+ may consume v206 as route catalog cleanup post-closeout continuity evidence only\"");
    ...
    assert_contains(json, "\"historicalFixturePaths\":[\"fixtures/release/shard-readiness-v144.json\","
                          ...
                          "\"fixtures/release/shard-readiness-v200.json\",\"fixtures/release/shard-readiness-v201.json\",\"fixtures/release/shard-readiness-v202.json\",\"fixtures/release/shard-readiness-v203.json\",\"fixtures/release/shard-readiness-v204.json\",\"fixtures/release/shard-readiness-v205.json\"]");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v205\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v205.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v491+ may consume v205 post closeout verification checklist handoff\"");
    ...
    assert_contains(json, "\"sourceNodePlan\":\"docs/plans3/"
                          "v480-post-java-mini-kv-route-catalog-cleanup-evidence-batch-closeout-roadmap.md\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v205\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v205.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:c00dd62f28564fed\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-verification-checklist-audit\"");
    assert_contains(json, "\"stageSequence\":6");
    assert_contains(json, "\"stageReleaseVersion\":\"v206\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v206\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":6");
