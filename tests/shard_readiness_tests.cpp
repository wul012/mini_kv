...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v173\"");
    ...
    assert_contains(json, "\"status\":\"node-route-split-window-dry-run-adapter-read-only\"");
    ...
    assert_contains(json, "\"archivedNodeVersions\":[\"Node v370\",\"Node v371\",\"Node v372\",\"Node v373\","
                          ...
                          "\"Node v445\",\"Node v446\",\"Node v447\"]");
    assert_contains(json, "\"changesArchivedNodeEvidence\":false");
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v172\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v172.json\"");
    assert_contains(
        json,
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v172\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v172.json\"");
    assert_contains(json, "\"windowStartNodeVersion\":\"Node v433\"");
    assert_contains(json, "\"windowEndNodeVersion\":\"Node v447\"");
    assert_contains(json, "\"splitRouteGroupCount\":15");
    ...
    assert_contains(json, "\"expectedWindowVersionCount\":15");
    assert_contains(json, "\"observedWindowVersionCount\":15");
    assert_contains(json, "\"windowRangeStart\":\"Node v433\"");
    assert_contains(json, "\"windowRangeEnd\":\"Node v447\"");
    ...
    assert_contains(json, "\"sourceFrozenWindowDigest\":\"fnv1a64:85f0acb5a011256f\"");
