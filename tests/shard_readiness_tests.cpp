...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v332\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v331\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v331.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-node-consumer-handoff\"");
    assert_contains(json, "\"rolloutStageSequence\":13");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v332\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v332 as read-only shard route preview verification report node-consumer-handoff evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v331\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v331.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v331 as read-only shard route preview verification report operator-handoff evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-node-consumer-handoff\"");
    assert_contains(json, "\"stageSequence\":132");
    assert_contains(json, "\"stageReleaseVersion\":\"v332\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v332\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":132");
