...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v289\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v288\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v288.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-history-fallback-freeze\"");
    assert_contains(json, "\"rolloutStageSequence\":11");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v289\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v289 as read-only shard route preview route-preview-history-fallback-freeze evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v288\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v288.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v288 as read-only shard route preview route-preview-rollout-catalog-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-history-fallback-freeze\"");
    assert_contains(json, "\"stageSequence\":89");
    assert_contains(json, "\"stageReleaseVersion\":\"v289\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v289\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":89");
