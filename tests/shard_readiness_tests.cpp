...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v376\"");
    ...
    assert_contains(json, "\"publishedStageCount\":160");
    ...
    assert_contains(json, "\"publishedStageCount\":161");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-boundary-field-audit\"");
    assert_contains(json, "\"closeoutStageSequence\":16");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v376\"");
    assert_contains(json, "\"publishedStageCount\":16");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v375\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v375.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v376 as read-only shard route preview verification report archive closeout boundary-field-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v375\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v375.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v376 as read-only shard route preview verification report archive closeout boundary-field-audit evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v375\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v375.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:7e37f53d1d19c6a8\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-boundary-field-audit\"");
    assert_contains(json, "\"stageSequence\":176");
    assert_contains(json, "\"stageReleaseVersion\":\"v376\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v376\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":176");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-boundary-field-audit\"");
