...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v304\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v303\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v303.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-tcp-smoke-contract\"");
    assert_contains(json, "\"rolloutStageSequence\":6");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v304\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v304 as read-only shard route preview verification tcp-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v303\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v303.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v303 as read-only shard route preview verification cli-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-tcp-smoke-contract\"");
    assert_contains(json, "\"stageSequence\":104");
    assert_contains(json, "\"stageReleaseVersion\":\"v304\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v304\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":104");
