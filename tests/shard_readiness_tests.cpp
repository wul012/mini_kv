...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v327\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v326\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v326.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-sample-parity-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":8");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v327\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v327 as read-only shard route preview verification report sample-parity-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v326\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v326.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v326 as read-only shard route preview verification report fixture-freeze evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-sample-parity-audit\"");
    assert_contains(json, "\"stageSequence\":127");
    assert_contains(json, "\"stageReleaseVersion\":\"v327\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v327\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":127");
