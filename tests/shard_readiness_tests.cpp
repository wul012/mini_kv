...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v320\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v319\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v319.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-command-contract\"");
    assert_contains(json, "\"rolloutStageSequence\":1");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v320\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v320 as read-only shard route preview verification report command-contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v319\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v319.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v319 as read-only shard route preview verification closeout-audit evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v319\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v319.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:6c69270142ff05f0\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-command-contract\"");
    assert_contains(json, "\"stageSequence\":120");
    assert_contains(json, "\"stageReleaseVersion\":\"v320\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v320\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":120");
