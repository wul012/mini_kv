...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v342\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-verification\"");
    assert_contains(json, "\"archiveStageSequence\":2");
    assert_contains(json, "\"archiveReleaseVersion\":\"v342\"");
    assert_contains(json, "\"publishedStageCount\":2");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v341\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v341.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v342 as read-only shard route preview verification report archive verification evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v341\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v341.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v342 as read-only shard route preview verification report archive verification evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v341\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v341.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:934caa72499a8f77\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-verification\"");
    assert_contains(json, "\"stageSequence\":142");
    assert_contains(json, "\"stageReleaseVersion\":\"v342\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v342\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":142");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-verification\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
