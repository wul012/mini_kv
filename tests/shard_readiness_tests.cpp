...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v355\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-tcp-smoke-contract\"");
    assert_contains(json, "\"archiveStageSequence\":15");
    assert_contains(json, "\"archiveReleaseVersion\":\"v355\"");
    assert_contains(json, "\"publishedStageCount\":15");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v354\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v354.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v355 as read-only shard route preview verification report archive tcp smoke contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v354\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v354.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v355 as read-only shard route preview verification report archive tcp smoke contract evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v354\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v354.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:f525662d1524cae5\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-tcp-smoke-contract\"");
    assert_contains(json, "\"stageSequence\":155");
    assert_contains(json, "\"stageReleaseVersion\":\"v355\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v355\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":155");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-tcp-smoke-contract\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
