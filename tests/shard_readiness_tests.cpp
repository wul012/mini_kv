...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v354\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-cli-smoke-contract\"");
    assert_contains(json, "\"archiveStageSequence\":14");
    assert_contains(json, "\"archiveReleaseVersion\":\"v354\"");
    assert_contains(json, "\"publishedStageCount\":14");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v353\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v353.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v354 as read-only shard route preview verification report archive cli smoke contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v353\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v353.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v354 as read-only shard route preview verification report archive cli smoke contract evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v353\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v353.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:44ee802faccd7e83\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-cli-smoke-contract\"");
    assert_contains(json, "\"stageSequence\":154");
    assert_contains(json, "\"stageReleaseVersion\":\"v354\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v354\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":154");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-cli-smoke-contract\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
