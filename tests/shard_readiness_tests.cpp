...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v297\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v296\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v296.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-release-package\"");
    assert_contains(json, "\"rolloutStageSequence\":19");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v297\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v297 as read-only shard route preview route-preview-release-package evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v296\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v296.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v296 as read-only shard route preview route-preview-no-execution-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-release-package\"");
    assert_contains(json, "\"stageSequence\":97");
    assert_contains(json, "\"stageReleaseVersion\":\"v297\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v297\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":97");
