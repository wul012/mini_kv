...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"publishedStageCount\":100");
    ...
    assert_contains(json, "\"publishedStageCount\":101");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-retention-map\"");
    assert_contains(json, "\"closeoutStageSequence\":10");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v370\"");
    assert_contains(json, "\"publishedStageCount\":10");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v369\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v369.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v370 as read-only shard route preview verification report archive closeout retention-map evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v369\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v369.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v370 as read-only shard route preview verification report archive closeout retention-map evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-retention-map\"");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-retention-map\"");
