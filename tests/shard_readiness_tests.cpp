...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v212\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v491+ may consume v212 as route catalog cleanup post-closeout continuity evidence only\"");
    ...
    assert_contains(json, "\"historicalFixturePaths\":[\"fixtures/release/shard-readiness-v144.json\","
                          ...
                          "\"fixtures/release/shard-readiness-v200.json\",\"fixtures/release/shard-readiness-v201.json\",\"fixtures/release/shard-readiness-v202.json\",\"fixtures/release/shard-readiness-v203.json\",\"fixtures/release/shard-readiness-v204.json\",\"fixtures/release/shard-readiness-v205.json\",\"fixtures/release/shard-readiness-v206.json\",\"fixtures/release/shard-readiness-v207.json\",\"fixtures/release/shard-readiness-v208.json\",\"fixtures/release/shard-readiness-v209.json\",\"fixtures/release/shard-readiness-v210.json\",\"fixtures/release/shard-readiness-v211.json\"]");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v211\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v211.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v491+ may consume v211 post closeout continuity release catalog retention\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v211\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v211.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:e116b578a611d13d\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-release-catalog-retention-audit\"");
    assert_contains(json, "\"stageSequence\":12");
    assert_contains(json, "\"stageReleaseVersion\":\"v212\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v212\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":12");
