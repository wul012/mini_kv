...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v246\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v523+ may consume v246 as Node v522 final closeout package audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v245\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v245.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v523+ may consume v245 Node v522 final closeout package evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v245\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v245.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:a4303386b8081c3e\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v522-final-closeout-package-audit\"");
    assert_contains(json, "\"stageSequence\":46");
    assert_contains(json, "\"stageReleaseVersion\":\"v246\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v246\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":46");
