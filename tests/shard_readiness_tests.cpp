...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v239\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v523+ may consume v239 as Node v522 CI and catalog health snapshot evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v238\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v238.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v523+ may consume v238 Node v522 stability archive package audit evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v238\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v238.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:cb420f72e2db405d\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v522-ci-catalog-health-snapshot\"");
    assert_contains(json, "\"stageSequence\":39");
    assert_contains(json, "\"stageReleaseVersion\":\"v239\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v239\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":39");
