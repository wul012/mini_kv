...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v388\"");
    ...
    assert_contains(json, "\"verificationStage\":\"route-preview-verification-report-archive-closeout-verification-source-closeout-index\"");
    assert_contains(json, "\"verificationStageSequence\":8");
    assert_contains(json, "\"verificationReleaseVersion\":\"v388\"");
    assert_contains(json, "\"publishedStageCount\":8");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v387\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v387.json\"");
    ...
    assert_contains(json, "\"archiveCloseoutVerificationChainComplete\":false");
    assert_contains(json, "\"filesystemReadPerformed\":false");
    assert_contains(json, "\"runtimeArchiveWalkAllowed\":false");
    assert_contains(json, "\"activeRouterInstalled\":false");
    assert_contains(json, "\"writeRoutingAllowed\":false");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v388 as read-only shard route preview verification report archive closeout verification source-closeout-index evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v387\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v387.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v388 as read-only shard route preview verification report archive closeout verification source-closeout-index evidence only\"");
...
int main() {
    ...
    assert_contains(result.response, "\"verificationStage\":\"route-preview-verification-report-archive-closeout-verification-source-closeout-index\"");
    assert_contains(result.response, "\"verificationReleaseVersion\":\"v388\"");
    assert_contains(result.response, "\"sourceFrozenReleaseVersion\":\"v387\"");
