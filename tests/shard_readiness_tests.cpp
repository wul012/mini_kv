...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v245\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v523+ may consume v245 as Node v522 final closeout package evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v244\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v244.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v523+ may consume v244 Node v522 downstream consumption handoff audit evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v244\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v244.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:1a55e1d39f2827ac\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v522-final-closeout-package\"");
    assert_contains(json, "\"stageSequence\":45");
    assert_contains(json, "\"stageReleaseVersion\":\"v245\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v245\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":45");
