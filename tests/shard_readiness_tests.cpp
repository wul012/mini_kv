...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v261\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v261 as Node v549 final closeout package audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v260\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v260.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v260 Node v549 final closeout package evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v260\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v260.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:f30c2273908b1a76\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v549-final-closeout-package-audit\"");
    assert_contains(json, "\"stageSequence\":61");
    assert_contains(json, "\"stageReleaseVersion\":\"v261\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v261\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":61");
