...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v295\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v294\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v294.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-no-write-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":17");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v295\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v295 as read-only shard route preview route-preview-no-write-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v294\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v294.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v294 as read-only shard route preview route-preview-no-router-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-no-write-audit\"");
    assert_contains(json, "\"stageSequence\":95");
    assert_contains(json, "\"stageReleaseVersion\":\"v295\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v295\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":95");
