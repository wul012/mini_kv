...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v272\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v272 as maintenance-only boundary field facade simplification evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v271\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v271.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v271 as maintenance-only boundary catalog maintenance formatter split evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v271\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v271.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:e4ad76d27f327696\"");
    assert_contains(json, "\"continuityStage\":\"maintenance-refactor-boundary-field-facade-simplification\"");
    assert_contains(json, "\"stageSequence\":72");
    assert_contains(json, "\"stageReleaseVersion\":\"v272\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v272\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":72");
