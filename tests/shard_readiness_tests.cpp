...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v268\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v268 as maintenance-only boundary field name table split evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v267\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v267.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v267 as maintenance-only CMake testing module split evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v267\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v267.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:c4c8467762fe031f\"");
    assert_contains(json, "\"continuityStage\":\"maintenance-refactor-boundary-field-name-table-split\"");
    assert_contains(json, "\"stageSequence\":68");
    assert_contains(json, "\"stageReleaseVersion\":\"v268\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v268\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":68");
