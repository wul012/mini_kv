...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v331\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v330\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v330.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-operator-handoff\"");
    assert_contains(json, "\"rolloutStageSequence\":12");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v331\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v331 as read-only shard route preview verification report operator-handoff evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v330\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v330.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v330 as read-only shard route preview verification report history-fallback-freeze evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-operator-handoff\"");
    assert_contains(json, "\"stageSequence\":131");
    assert_contains(json, "\"stageReleaseVersion\":\"v331\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v331\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":131");
