...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v210\"");
    ...
    assert_contains(json, "\"historicalFixturePaths\":[\"fixtures/release/shard-readiness-v144.json\","
                          ...
                          "\"fixtures/release/shard-readiness-v200.json\",\"fixtures/release/shard-readiness-v201.json\",\"fixtures/release/shard-readiness-v202.json\",\"fixtures/release/shard-readiness-v203.json\",\"fixtures/release/shard-readiness-v204.json\",\"fixtures/release/shard-readiness-v205.json\",\"fixtures/release/shard-readiness-v206.json\",\"fixtures/release/shard-readiness-v207.json\",\"fixtures/release/shard-readiness-v208.json\",\"fixtures/release/shard-readiness-v209.json\"]");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v209\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v209.json\"");
    assert_contains(
        json,
    ...
    assert_contains(json, "\"sourceNodePlan\":\"docs/plans3/"
                          "v480-post-java-mini-kv-route-catalog-cleanup-evidence-batch-closeout-roadmap.md\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v209\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v209.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:6c283479e8bb1988\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-release-catalog-audit\"");
    assert_contains(json, "\"stageSequence\":10");
    assert_contains(json, "\"stageReleaseVersion\":\"v210\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v210\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":10");
