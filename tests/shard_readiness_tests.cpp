...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"shardRoutePreviewOperatorValueSupplySignedApprovalCaptureArtifactDraftTextPackageReviewCloseoutAudit\":{\"contract\":"
                          "\"shard-route-preview-operator-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit.v1\"");
    assert_contains(json, "\"command\":\"SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTTEXTPACKAGEREVIEWCLOSEOUTAUDITJSON\"");
    ...
    assert_contains(json, "\"executionAllowed\":false");
    assert_contains(json, "\"shardRoutePreviewOperatorValueSupplySignedApprovalCaptureArtifactDraftTextPackageComparedPackageEvidenceIntakeAudit\":{\"contract\":"
                          "\"shard-route-preview-operator-value-supply-signed-approval-capture-artifact-draft-text-package-compared-package-evidence-intake-audit.v1\"");
    ...
    assert_contains(json, "\"shardPreviewSignedApprovalArtifactDraftTextPackageProfileSection\":{\"contract\":"
    ...
    assert_contains(json, "\"command\":\"SHARDROUTESANDBOXENDPOINTCREDENTIALRESOLVERUPSTREAMECHONONPARTICIPATIONJSON\"");
    assert_contains(json,
    ...
    assert_contains(json, "\"shardPreviewDisabledFakeHarnessContractUpstreamEchoVerificationSplitNonParticipation\":{\"contract\":"
    ...
    assert_contains(json,
                    "\"shardPreviewProductionShardExecutionOwnerReceiptRequestPacket\":{\"contract\":"
    ...
    assert_contains(json, "\"verificationStage\":\"route-preview-verification-report-archive-closeout-verification-release-package\"");
    ...
    assert_contains(json, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-release-package\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v420 as read-only shard route preview verification report archive closeout verification audit release-package evidence only\"");
    ...
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v420 as read-only shard route preview verification report archive closeout verification audit release-package evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-release-package\"");
...
int main() {
    ...
    assert_contains(result.response,
        "SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTTEXTPACKAGECOMPAREDPACKAGEEVIDENCEINTAKEAUDITJSON(category=read,mutates_store=no,touches_wal=no,stable=yes)");
    assert_contains(result.response,
    ...
    assert_contains(result.response,
                    ...
                    "\"mutates_store\":false,\"touches_wal\":false");
    assert_contains(result.response,
                    "\"name\":\"SHARDROUTECANDIDATEINTAKEPACKETJSON\",\"category\":\"read\","
                    "\"mutates_store\":false,\"touches_wal\":false");
    assert_contains(result.response,
    ...
    assert_contains(result.response, "\"verificationStage\":\"route-preview-verification-report-archive-closeout-verification-release-package\"");
    ...
    assert_contains(result.response, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-release-package\"");
