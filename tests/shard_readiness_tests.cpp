...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v372\"");
    ...
    assert_contains(json, "\"publishedStageCount\":120");
    ...
    assert_contains(json, "\"publishedStageCount\":121");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-consumer-handoff\"");
    assert_contains(json, "\"closeoutStageSequence\":12");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v372\"");
    assert_contains(json, "\"publishedStageCount\":12");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v371\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v371.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v372 as read-only shard route preview verification report archive closeout consumer-handoff evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v371\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v371.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v372 as read-only shard route preview verification report archive closeout consumer-handoff evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v371\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v371.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:827d3e6a37f521e4\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-consumer-handoff\"");
    assert_contains(json, "\"stageSequence\":172");
    assert_contains(json, "\"stageReleaseVersion\":\"v372\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v372\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":172");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-consumer-handoff\"");
