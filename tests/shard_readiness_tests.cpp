...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v256\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v256 as Node v549 archive-files consumption handoff evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v255\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v255.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v255 Node v549 live-smoke boundary reconfirmation audit evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v255\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v255.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:c0381228f6fd3e32\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v549-archive-files-consumption-handoff\"");
    assert_contains(json, "\"stageSequence\":56");
    assert_contains(json, "\"stageReleaseVersion\":\"v256\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v256\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":56");
