...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v350\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-consumer-handoff-audit\"");
    assert_contains(json, "\"archiveStageSequence\":10");
    assert_contains(json, "\"archiveReleaseVersion\":\"v350\"");
    assert_contains(json, "\"publishedStageCount\":10");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v349\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v349.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v350 as read-only shard route preview verification report archive consumer handoff audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v349\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v349.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v350 as read-only shard route preview verification report archive consumer handoff audit evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v349\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v349.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:c513172d8269d288\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-consumer-handoff-audit\"");
    assert_contains(json, "\"stageSequence\":150");
    assert_contains(json, "\"stageReleaseVersion\":\"v350\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v350\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":150");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-consumer-handoff-audit\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
