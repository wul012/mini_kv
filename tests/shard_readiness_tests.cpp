...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v241\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v523+ may consume v241 as Node v522 stability closeout snapshot evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v240\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v240.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v523+ may consume v240 Node v522 CI and catalog health audit evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v240\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v240.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:b9a88b7ea2392cc6\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v522-stability-closeout-snapshot\"");
    assert_contains(json, "\"stageSequence\":41");
    assert_contains(json, "\"stageReleaseVersion\":\"v241\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v241\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":41");
