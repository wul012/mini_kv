...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"maintenanceStage\":\"route-preview-archive-maintenance-focused-test-helper\"");
    assert_contains(json, "\"maintenanceStageSequence\":5");
    assert_contains(json, "\"maintenanceReleaseVersion\":\"v465\"");
    assert_contains(json, "\"sharedStageCatalogFormatterApplied\":true");
