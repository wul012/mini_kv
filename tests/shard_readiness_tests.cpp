...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v177\"");
    ...
    assert_contains(json, "\"status\":\"node-route-split-window-foundational-audit-read-only\"");
    ...
    assert_contains(json,
                    "\"nodeConsumer\":\"Node v458+ may consume v177 as foundational audit route split compatibility evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v176\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v176.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v458 foundational audit route split may consume v176 manual sandbox connection fake transport route split compatibility evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v176\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v176.json\"");
    assert_contains(json, "\"windowStartNodeVersion\":\"Node v433\"");
    assert_contains(json, "\"windowEndNodeVersion\":\"Node v458\"");
    assert_contains(json, "\"splitRouteGroupCount\":26");
    ...
    assert_contains(json, "\"expectedWindowVersionCount\":26");
    assert_contains(json, "\"observedWindowVersionCount\":26");
    assert_contains(json, "\"windowRangeStart\":\"Node v433\"");
    assert_contains(json, "\"windowRangeEnd\":\"Node v458\"");
    ...
    assert_contains(json, "\"sourceFrozenWindowDigest\":\"fnv1a64:528073c4315ef89b\"");
