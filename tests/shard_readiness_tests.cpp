...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v244\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v523+ may consume v244 as Node v522 downstream consumption handoff audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v243\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v243.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v523+ may consume v243 Node v522 downstream consumption handoff evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v243\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v243.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:bd6eca1936c424c8\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v522-downstream-consumption-handoff-audit\"");
    assert_contains(json, "\"stageSequence\":44");
    assert_contains(json, "\"stageReleaseVersion\":\"v244\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v244\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":44");
