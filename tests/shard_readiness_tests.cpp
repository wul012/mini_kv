...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v321\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v320\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v320.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-command-catalog-alignment\"");
    assert_contains(json, "\"rolloutStageSequence\":2");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v321\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v321 as read-only shard route preview verification report command-catalog-alignment evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v320\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v320.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v320 as read-only shard route preview verification report command-contract evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-command-catalog-alignment\"");
    assert_contains(json, "\"stageSequence\":121");
    assert_contains(json, "\"stageReleaseVersion\":\"v321\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v321\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":121");
