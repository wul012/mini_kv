...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v377\"");
    ...
    assert_contains(json, "\"publishedStageCount\":170");
    ...
    assert_contains(json, "\"publishedStageCount\":171");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-no-router-audit\"");
    assert_contains(json, "\"closeoutStageSequence\":17");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v377\"");
    assert_contains(json, "\"publishedStageCount\":17");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v376\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v376.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v377 as read-only shard route preview verification report archive closeout no-router-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v376\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v376.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v377 as read-only shard route preview verification report archive closeout no-router-audit evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v376\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v376.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:ac8ca08205ce8f0b\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-no-router-audit\"");
    assert_contains(json, "\"stageSequence\":177");
    assert_contains(json, "\"stageReleaseVersion\":\"v377\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v377\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":177");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-no-router-audit\"");
