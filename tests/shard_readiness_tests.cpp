...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v259\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v259 as Node v550 route exposure readiness audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v258\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v258.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v258 Node v550 route exposure readiness evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v258\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v258.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:47524b3712b54719\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v549-node-v550-route-exposure-readiness-audit\"");
    assert_contains(json, "\"stageSequence\":59");
    assert_contains(json, "\"stageReleaseVersion\":\"v259\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v259\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":59");
