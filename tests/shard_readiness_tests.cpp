...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v242\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v523+ may consume v242 as Node v522 stability closeout audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v241\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v241.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v523+ may consume v241 Node v522 stability closeout snapshot evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v241\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v241.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:40293ba67109b6e0\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v522-stability-closeout-audit\"");
    assert_contains(json, "\"stageSequence\":42");
    assert_contains(json, "\"stageReleaseVersion\":\"v242\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v242\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":42");
