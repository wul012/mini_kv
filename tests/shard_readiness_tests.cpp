...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v374\"");
    ...
    assert_contains(json, "\"publishedStageCount\":140");
    ...
    assert_contains(json, "\"publishedStageCount\":141");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-java-echo-handoff\"");
    assert_contains(json, "\"closeoutStageSequence\":14");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v374\"");
    assert_contains(json, "\"publishedStageCount\":14");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v373\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v373.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v374 as read-only shard route preview verification report archive closeout java-echo-handoff evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v373\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v373.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v374 as read-only shard route preview verification report archive closeout java-echo-handoff evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v373\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v373.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:c5ad15aff90c27c9\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-java-echo-handoff\"");
    assert_contains(json, "\"stageSequence\":174");
    assert_contains(json, "\"stageReleaseVersion\":\"v374\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v374\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":174");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-java-echo-handoff\"");
