...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"draftTextPackageComparedPackageEvidenceIntakeAuditReleaseVersion\":\"v877\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v876\"");
    assert_contains(json, "\"publishedStageCount\":17");
    ...
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v876.json\"");
