...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v315\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v314\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v314.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-no-write-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":17");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v315\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v315 as read-only shard route preview verification no-write-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v314\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v314.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v314 as read-only shard route preview verification no-router-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-no-write-audit\"");
    assert_contains(json, "\"stageSequence\":115");
    assert_contains(json, "\"stageReleaseVersion\":\"v315\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v315\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":115");
