...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v305\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v304\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v304.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-fixture-freeze\"");
    assert_contains(json, "\"rolloutStageSequence\":7");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v305\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v305 as read-only shard route preview verification fixture-freeze evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v304\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v304.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v304 as read-only shard route preview verification tcp-smoke-contract evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-fixture-freeze\"");
    assert_contains(json, "\"stageSequence\":105");
    assert_contains(json, "\"stageReleaseVersion\":\"v305\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v305\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":105");
