...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v292\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v291\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v291.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-java-echo-handoff\"");
    assert_contains(json, "\"rolloutStageSequence\":14");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v292\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v292 as read-only shard route preview route-preview-java-echo-handoff evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v291\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v291.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v291 as read-only shard route preview route-preview-node-consumer-handoff evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-java-echo-handoff\"");
    assert_contains(json, "\"stageSequence\":92");
    assert_contains(json, "\"stageReleaseVersion\":\"v292\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v292\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":92");
