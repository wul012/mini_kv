...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v302\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v301\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v301.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-checkjson-contract\"");
    assert_contains(json, "\"rolloutStageSequence\":4");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v302\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v302 as read-only shard route preview verification checkjson-contract evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v301\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v301.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v301 as read-only shard route preview verification explain-contract evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-checkjson-contract\"");
    assert_contains(json, "\"stageSequence\":102");
    assert_contains(json, "\"stageReleaseVersion\":\"v302\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v302\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":102");
