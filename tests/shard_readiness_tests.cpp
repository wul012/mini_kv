...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v359\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-release-package\"");
    assert_contains(json, "\"archiveStageSequence\":19");
    assert_contains(json, "\"archiveReleaseVersion\":\"v359\"");
    assert_contains(json, "\"publishedStageCount\":19");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v358\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v358.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v359 as read-only shard route preview verification report archive release package evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v358\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v358.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v359 as read-only shard route preview verification report archive release package evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v358\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v358.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:c740e83477a521b8\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-release-package\"");
    assert_contains(json, "\"stageSequence\":159");
    assert_contains(json, "\"stageReleaseVersion\":\"v359\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v359\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":159");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-release-package\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
