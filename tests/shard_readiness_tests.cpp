...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v271\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v271 as maintenance-only boundary catalog maintenance formatter split evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v270\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v270.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v270 as maintenance-only boundary catalog index formatter split evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v270\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v270.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:de9b42aac6fd10cf\"");
    assert_contains(json, "\"continuityStage\":\"maintenance-refactor-boundary-catalog-maintenance-split\"");
    assert_contains(json, "\"stageSequence\":71");
    assert_contains(json, "\"stageReleaseVersion\":\"v271\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v271\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":71");
