...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v254\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v254 as Node v549 live-smoke boundary reconfirmation evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v253\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v253.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v253 Node v549 latest sibling clean quality reminder audit evidence\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v253\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v253.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:efc86787cea8b3b6\"");
    assert_contains(json, "\"continuityStage\":\"post-closeout-continuity-node-v549-live-smoke-boundary-reconfirmation\"");
    assert_contains(json, "\"stageSequence\":54");
    assert_contains(json, "\"stageReleaseVersion\":\"v254\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v254\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":54");
