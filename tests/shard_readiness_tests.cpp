...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v313\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v312\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v312.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-boundary-field-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":15");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v313\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v313 as read-only shard route preview verification boundary-field-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v312\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v312.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v312 as read-only shard route preview verification java-echo-handoff evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-boundary-field-audit\"");
    assert_contains(json, "\"stageSequence\":113");
    assert_contains(json, "\"stageReleaseVersion\":\"v313\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v313\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":113");
