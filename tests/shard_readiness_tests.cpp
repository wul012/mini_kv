...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-fixture-freeze\"");
    assert_contains(json, "\"auditStageSequence\":7");
    assert_contains(json, "\"auditReleaseVersion\":\"v407\"");
    assert_contains(json, "\"publishedStageCount\":7");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v406\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v406.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v407 as read-only shard route preview verification report archive closeout verification audit fixture-freeze evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v406\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v406.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v407 as read-only shard route preview verification report archive closeout verification audit fixture-freeze evidence only\"");
...
int main() {
    ...
    assert_contains(result.response, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-fixture-freeze\"");
    assert_contains(result.response, "\"auditReleaseVersion\":\"v407\"");
    assert_contains(result.response, "\"sourceFrozenReleaseVersion\":\"v406\"");
