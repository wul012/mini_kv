...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v375\"");
    ...
    assert_contains(json, "\"publishedStageCount\":150");
    ...
    assert_contains(json, "\"publishedStageCount\":151");
    ...
    assert_contains(json, "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-java-echo-audit\"");
    assert_contains(json, "\"closeoutStageSequence\":15");
    assert_contains(json, "\"closeoutReleaseVersion\":\"v375\"");
    assert_contains(json, "\"publishedStageCount\":15");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v374\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v374.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v375 as read-only shard route preview verification report archive closeout java-echo-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v374\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v374.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v375 as read-only shard route preview verification report archive closeout java-echo-audit evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v374\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v374.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:0da600fb455f2af2\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-closeout-java-echo-audit\"");
    assert_contains(json, "\"stageSequence\":175");
    assert_contains(json, "\"stageReleaseVersion\":\"v375\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v375\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":175");
...
int main() {
    ...
    assert_contains(result.response,
                    "\"closeoutStage\":\"route-preview-verification-report-archive-closeout-java-echo-audit\"");
