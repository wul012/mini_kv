...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"releaseVersion\":\"v176\"");
    ...
    assert_contains(json, "\"status\":\"node-route-split-window-manual-sandbox-fake-transport-read-only\"");
    ...
    assert_contains(json,
                    "\"nodeConsumer\":\"Node v457+ may consume v176 as managed audit manual sandbox connection fake transport route split compatibility evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v175\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v175.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v457 manual sandbox connection fake transport route split may consume v175 managed audit adapter implementation route split compatibility evidence\"");
    ...
    assert_contains(json, "\"sourceNodePlan\":\"docs/plans3/"
                          "v457-post-managed-audit-manual-sandbox-connection-fake-transport-route-group-split-roadmap.md\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v175\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v175.json\"");
    assert_contains(json, "\"windowStartNodeVersion\":\"Node v433\"");
    assert_contains(json, "\"windowEndNodeVersion\":\"Node v457\"");
    assert_contains(json, "\"splitRouteGroupCount\":25");
    ...
    assert_contains(json, "\"expectedWindowVersionCount\":25");
    assert_contains(json, "\"observedWindowVersionCount\":25");
    assert_contains(json, "\"windowRangeStart\":\"Node v433\"");
    assert_contains(json, "\"windowRangeEnd\":\"Node v457\"");
    ...
    assert_contains(json, "\"sourceFrozenWindowDigest\":\"fnv1a64:61e561e1c8ba7d50\"");
