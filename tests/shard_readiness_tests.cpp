...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v349\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-consumer-handoff\"");
    assert_contains(json, "\"archiveStageSequence\":9");
    assert_contains(json, "\"archiveReleaseVersion\":\"v349\"");
    assert_contains(json, "\"publishedStageCount\":9");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v348\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v348.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v349 as read-only shard route preview verification report archive consumer handoff evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v348\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v348.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v349 as read-only shard route preview verification report archive consumer handoff evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v348\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v348.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:2c9eac6c48d4776d\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-consumer-handoff\"");
    assert_contains(json, "\"stageSequence\":149");
    assert_contains(json, "\"stageReleaseVersion\":\"v349\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v349\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":149");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-consumer-handoff\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
