...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v387\"");
    ...
    assert_contains(json, "\"verificationStage\":\"route-preview-verification-report-archive-closeout-verification-fixture-freeze\"");
    assert_contains(json, "\"verificationStageSequence\":7");
    assert_contains(json, "\"verificationReleaseVersion\":\"v387\"");
    assert_contains(json, "\"publishedStageCount\":7");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v386\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v386.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v387 as read-only shard route preview verification report archive closeout verification fixture-freeze evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v386\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v386.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v387 as read-only shard route preview verification report archive closeout verification fixture-freeze evidence only\"");
...
int main() {
    ...
    assert_contains(result.response, "\"verificationStage\":\"route-preview-verification-report-archive-closeout-verification-fixture-freeze\"");
    assert_contains(result.response, "\"verificationReleaseVersion\":\"v387\"");
    assert_contains(result.response, "\"sourceFrozenReleaseVersion\":\"v386\"");
