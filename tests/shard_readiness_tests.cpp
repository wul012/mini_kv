...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v293\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v292\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v292.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-boundary-field-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":15");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v293\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v293 as read-only shard route preview route-preview-boundary-field-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v292\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v292.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v292 as read-only shard route preview route-preview-java-echo-handoff evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-boundary-field-audit\"");
    assert_contains(json, "\"stageSequence\":93");
    assert_contains(json, "\"stageReleaseVersion\":\"v293\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v293\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":93");
