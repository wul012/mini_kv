...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v353\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-fixture-freeze\"");
    assert_contains(json, "\"archiveStageSequence\":13");
    assert_contains(json, "\"archiveReleaseVersion\":\"v353\"");
    assert_contains(json, "\"publishedStageCount\":13");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v352\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v352.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v353 as read-only shard route preview verification report archive fixture freeze evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v352\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v352.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v353 as read-only shard route preview verification report archive fixture freeze evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v352\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v352.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:67bc128aadc1681f\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-fixture-freeze\"");
    assert_contains(json, "\"stageSequence\":153");
    assert_contains(json, "\"stageReleaseVersion\":\"v353\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v353\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":153");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-fixture-freeze\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
