...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v299\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v298\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v298.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-command-contract\"");
    assert_contains(json, "\"rolloutStageSequence\":1");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v299\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v299 as read-only shard route preview verification command evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v298\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v298.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v298 as read-only shard route preview route-preview-release-package-audit evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v298\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v298.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:a58cf80e8ddfc6e3\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-command-contract\"");
    assert_contains(json, "\"stageSequence\":99");
    assert_contains(json, "\"stageReleaseVersion\":\"v299\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v299\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":99");
