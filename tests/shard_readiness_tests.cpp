...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v314\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v313\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v313.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-no-router-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":16");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v314\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v314 as read-only shard route preview verification no-router-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v313\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v313.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v313 as read-only shard route preview verification boundary-field-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-no-router-audit\"");
    assert_contains(json, "\"stageSequence\":114");
    assert_contains(json, "\"stageReleaseVersion\":\"v314\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v314\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":114");
