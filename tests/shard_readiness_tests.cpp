...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v343\"");
    ...
    assert_contains(json, "\"archiveStage\":\"route-preview-verification-report-archive-index\"");
    assert_contains(json, "\"archiveStageSequence\":3");
    assert_contains(json, "\"archiveReleaseVersion\":\"v343\"");
    assert_contains(json, "\"publishedStageCount\":3");
    assert_contains(json, "\"plannedStageCount\":20");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v342\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v342.json\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v343 as read-only shard route preview verification report archive index evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v342\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v342.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v343 as read-only shard route preview verification report archive index evidence only\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v342\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v342.json\"");
    assert_contains(json, "\"sourceFrozenDigest\":\"fnv1a64:be6931b2ab6fd239\"");
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-archive-index\"");
    assert_contains(json, "\"stageSequence\":143");
    assert_contains(json, "\"stageReleaseVersion\":\"v343\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v343\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":143");
...
int main() {
    ...
    assert_contains(result.response, "\"archiveStage\":\"route-preview-verification-report-archive-index\"");
    assert_contains(result.response, "\"executionAllowed\":false");
}
