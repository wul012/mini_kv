...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"maintenanceStage\":\"route-preview-archive-maintenance-retention-map\"");
    assert_contains(json, "\"maintenanceStageSequence\":14");
    assert_contains(json, "\"maintenanceReleaseVersion\":\"v474\"");
    assert_contains(json, "\"sharedStageCatalogFormatterApplied\":true");
