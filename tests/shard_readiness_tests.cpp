...
void assert_shard_readiness_contract(const std::string& json) {
    ...
    assert_contains(json, "\"version\":\"" + std::string{minikv::version} + "\",\"releaseVersion\":\"v335\"");
    ...
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v334\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v334.json\"");
    assert_contains(json, "\"rolloutStage\":\"route-preview-verification-report-no-router-audit\"");
    assert_contains(json, "\"rolloutStageSequence\":16");
    assert_contains(json, "\"rolloutReleaseVersion\":\"v335\"");
    ...
    assert_contains(
        json,
        "\"nodeConsumer\":\"Node v550+ may consume v335 as read-only shard route preview verification report no-router-audit evidence only\"");
    ...
    assert_contains(json, "\"historicalFallback\":{\"previousConsumedReleaseVersion\":\"v334\"");
    assert_contains(json, "\"previousConsumedFixturePath\":\"fixtures/release/shard-readiness-v334.json\"");
    assert_contains(
        json,
        "\"previousConsumptionNodeVersion\":\"Node v550+ may consume v334 as read-only shard route preview verification report boundary-field-audit evidence only\"");
    ...
    assert_contains(json, "\"continuityStage\":\"feature-read-only-shard-route-preview-verification-report-no-router-audit\"");
    assert_contains(json, "\"stageSequence\":135");
    assert_contains(json, "\"stageReleaseVersion\":\"v335\"");
    ...
    assert_contains(json, "\"trackedPostCloseoutRangeEnd\":\"v335\"");
    assert_contains(json, "\"trackedPostCloseoutReleaseCount\":135");
