...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageComparisonCloseoutAuditStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-comparison-closeout-audit-source-snippet-digest-lane\"");
    ...
    assert_contains(json, "\"completedComparisonCheckCount\":13");
    ...
    assert(digest.find("v848-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-comparison-closeout-audit-source-snippet-digest-lane") != std::string::npos);
