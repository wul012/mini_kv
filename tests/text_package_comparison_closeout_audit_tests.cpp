...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageComparisonCloseoutAuditStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-comparison-closeout-audit-request-correlation-lane\"");
    ...
    assert_contains(json, "\"completedComparisonCheckCount\":5");
    ...
    assert(digest.find("v840-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-comparison-closeout-audit-request-correlation-lane") != std::string::npos);
