...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageComparisonCloseoutAuditStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-comparison-closeout-audit-identity-lane\"");
    ...
    assert_contains(json, "\"completedComparisonCheckCount\":4");
    ...
    assert(digest.find("v839-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-comparison-closeout-audit-identity-lane") != std::string::npos);
