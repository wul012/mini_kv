...
int main() {
    ...
    assert_contains(echo_marker, "\"source_version\":\"0.100.0\"");
    ...
    assert_contains(echo_marker, "\"current_artifact_path_hint\":\"c/100/\"");
    ...
    assert_contains(no_start, "\"source_version\":\"0.100.0\"");
    ...
    assert_contains(no_start, "\"current_artifact_path_hint\":\"c/100/\"");
