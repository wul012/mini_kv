...
int main() {
    ...
    assert_contains(echo_marker, "\"source_version\":\"0.97.0\"");
    ...
    assert_contains(echo_marker, "\"current_artifact_path_hint\":\"c/97/\"");
    ...
    assert_contains(no_start, "\"source_version\":\"0.97.0\"");
    ...
    assert_contains(no_start, "\"current_artifact_path_hint\":\"c/97/\"");
