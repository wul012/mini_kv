...
int main() {
    ...
    assert_contains(manifest, "\"project_version\":\"0.96.0\"");
    assert_contains(manifest, "\"release_version\":\"v96\"");
    ...
    assert_contains(manifest,
                    "\"consumer_hint\":\"Node v229 manual sandbox connection packet verification\"");

    assert_contains(manifest, "\"command\":\"cmake -S . -B cmake-build-v96");
    assert_contains(manifest, "\"command\":\"cmake --build cmake-build-v96 --parallel 2\"");
    assert_contains(manifest, "\"command\":\"ctest --test-dir cmake-build-v96 --output-on-failure\"");
    ...
    assert_contains(manifest, "\"SMOKEJSON version matches 0.96.0\"");
    assert_contains(manifest, "\"SMOKEJSON read_only=true and execution_allowed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v96 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5\"");
    assert_contains(manifest, "\"SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:c9da016a60b4a58e and production_binary_claimed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:e8df420be507be3e and managed_audit_write_executed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes retention_provenance_replay_marker.marker_digest=fnv1a64:0e8a532e42d289d5 and replay_executed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.receipt_digest=fnv1a64:ad1d4a1774dc38c2 and adapter_write_allowed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes adapter_shell_non_storage_guard_receipt.consumed_release_version=v88\"");
    assert_contains(manifest, "\"SMOKEJSON exposes adapter_shell_non_storage_guard_receipt.receipt_digest=fnv1a64:6ebf3cc89a6a326c\"");
    ...
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_external_adapter_non_participation_receipt.receipt_digest=fnv1a64:8c8339872e6dae25\"");
    ...
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest=fnv1a64:e3693d38283c37e2\"");
    ...
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_sandbox_connection_receipt_echo_marker.marker_digest=fnv1a64:b9fc556875ea625b\"");
    ...
    assert_contains(manifest, "\"cmake_project_version\":\"0.96.0\"");
    ...
    assert_contains(manifest, "\"session_id_echo\":\"mini-kv-live-read-v96\"");
    ...
    assert_contains(manifest, "\"source_version\":\"0.96.0\"");
    assert_contains(manifest, "\"artifact_path_hint\":\"c/96/\"");
    assert_contains(manifest, "\"runtime_binary_hint\":\"cmake-build-v96/minikv_server and cmake-build-v96/minikv_client from the current CMake build\"");
    ...
    assert_contains(manifest, "\"provenance_digest\":\"fnv1a64:c9da016a60b4a58e\"");
    ...
    assert_contains(manifest, "\"expected_binary_provenance_digest\":\"fnv1a64:c9da016a60b4a58e\"");
    assert_contains(manifest, "\"check_digest\":\"fnv1a64:e8df420be507be3e\"");
    ...
    assert_contains(manifest, "\"current_artifact_path_hint\":\"c/96/\"");
    assert_contains(manifest, "\"marker_digest\":\"fnv1a64:0e8a532e42d289d5\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:ad1d4a1774dc38c2\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:23741de2828676be\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:e7bee76d3e9e4a56\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:6ebf3cc89a6a326c\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:8c8339872e6dae25\"");
    ...
    assert_contains(manifest, "\"runtime_role\":\"runtime evidence provider only\"");
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:e3693d38283c37e2\"");
    ...
    assert_contains(manifest, "\"marker_digest\":\"fnv1a64:b9fc556875ea625b\"");
    ...
    assert_contains(manifest, "\"Node v229 may verify the mini-kv sandbox connection receipt echo marker before manual sandbox connection packet verification\"");
    ...
    assert_contains(cmake_lists, "project(mini_kv VERSION 0.96.0");
    ...
    assert_contains(result.response, "\"version\":\"0.96.0\"");
    ...
    assert_contains(result.response, "\"source_version\":\"0.96.0\"");
    assert_contains(result.response, "\"artifact_path_hint\":\"c/96/\"");
    assert_contains(result.response, "\"provenance_digest\":\"fnv1a64:c9da016a60b4a58e\"");
    ...
    assert_contains(result.response, "\"session_id_echo\":\"mini-kv-live-read-v96\"");
    ...
    assert_contains(result.response, "\"check_digest\":\"fnv1a64:e8df420be507be3e\"");
    ...
    assert_contains(result.response, "\"marker_digest\":\"fnv1a64:0e8a532e42d289d5\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:ad1d4a1774dc38c2\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:e7bee76d3e9e4a56\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:6ebf3cc89a6a326c\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:8c8339872e6dae25\"");
    ...
    assert_contains(result.response, "\"current_artifact_path_hint\":\"c/96/\"");
    assert_contains(result.response, "\"adapter_target\":\"sandbox managed audit adapter dry-run\"");
    assert_contains(result.response, "\"runtime_role\":\"runtime evidence provider only\"");
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:e3693d38283c37e2\"");
    ...
    assert_contains(result.response, "\"marker_digest\":\"fnv1a64:b9fc556875ea625b\"");
