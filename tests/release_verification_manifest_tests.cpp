...
int main() {
    ...
    assert_contains(manifest, "\"project_version\":\"0.63.0\"");
    assert_contains(manifest, "\"release_version\":\"v63\"");
    ...
    assert_contains(manifest, "\"consumer_hint\":\"Node v162 cross-project release verification intake gate\"");

    assert_contains(manifest, "\"command\":\"cmake -S . -B cmake-build-v63");
    assert_contains(manifest, "\"command\":\"cmake --build cmake-build-v63 --parallel 2\"");
    assert_contains(manifest, "\"command\":\"ctest --test-dir cmake-build-v63 --output-on-failure\"");
    ...
    assert_contains(manifest, "\"cmake_project_version\":\"0.63.0\"");
    ...
    assert_contains(cmake_lists, "project(mini_kv VERSION 0.63.0");
    ...
    assert_contains(result.response, "\"version\":\"0.63.0\"");
