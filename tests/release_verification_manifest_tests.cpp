...
int main() {
    ...
    assert_contains(manifest, "\"project_version\":\"0.98.0\"");
    assert_contains(manifest, "\"release_version\":\"v98\"");
    ...
    assert_contains(manifest,
                    "\"consumer_hint\":\"Node v233 manual sandbox connection rehearsal packet review\"");

    assert_contains(manifest, "\"command\":\"cmake -S . -B cmake-build-v98");
    assert_contains(manifest, "\"command\":\"cmake --build cmake-build-v98 --parallel 2\"");
    assert_contains(manifest, "\"command\":\"ctest --test-dir cmake-build-v98 --output-on-failure\"");
    ...
    assert_contains(manifest, "\"SMOKEJSON version matches 0.98.0\"");
    assert_contains(manifest, "\"SMOKEJSON read_only=true and execution_allowed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v98 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5\"");
    assert_contains(manifest, "\"SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:4be577ac4f8347c6 and production_binary_claimed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:3397146bc78ee26f and managed_audit_write_executed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes retention_provenance_replay_marker.marker_digest=fnv1a64:f8c7f073fdddb289 and replay_executed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.receipt_digest=fnv1a64:f006b4f4299a99ce and adapter_write_allowed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes adapter_shell_non_storage_guard_receipt.consumed_release_version=v88\"");
    assert_contains(manifest, "\"SMOKEJSON exposes adapter_shell_non_storage_guard_receipt.receipt_digest=fnv1a64:7bce24ede1836a30\"");
    ...
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_external_adapter_non_participation_receipt.receipt_digest=fnv1a64:36b65e9c69f03b49\"");
    ...
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest=fnv1a64:9e89d248ca215706\"");
    ...
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_sandbox_connection_receipt_echo_marker.marker_digest=fnv1a64:c88b0bf6b974ac6b\"");
    ...
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_sandbox_connection_no_start_guard_receipt.receipt_digest=fnv1a64:431780d3772a52a5\"");
    ...
    assert_contains(manifest, "\"cmake_project_version\":\"0.98.0\"");
    ...
    assert_contains(manifest, "\"session_id_echo\":\"mini-kv-live-read-v98\"");
    ...
    assert_contains(manifest, "\"source_version\":\"0.98.0\"");
    assert_contains(manifest, "\"artifact_path_hint\":\"c/98/\"");
    assert_contains(manifest, "\"runtime_binary_hint\":\"cmake-build-v98/minikv_server and cmake-build-v98/minikv_client from the current CMake build\"");
    ...
    assert_contains(manifest, "\"provenance_digest\":\"fnv1a64:4be577ac4f8347c6\"");
    ...
    assert_contains(manifest, "\"expected_binary_provenance_digest\":\"fnv1a64:4be577ac4f8347c6\"");
    assert_contains(manifest, "\"check_digest\":\"fnv1a64:3397146bc78ee26f\"");
    ...
    assert_contains(manifest, "\"current_artifact_path_hint\":\"c/98/\"");
    assert_contains(manifest, "\"marker_digest\":\"fnv1a64:f8c7f073fdddb289\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:f006b4f4299a99ce\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:e6ffb387b375879e\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:86f3d1ae4aaf7c62\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:7bce24ede1836a30\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:36b65e9c69f03b49\"");
    ...
    assert_contains(manifest, "\"runtime_role\":\"runtime evidence provider only\"");
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:9e89d248ca215706\"");
    ...
    assert_contains(manifest, "\"marker_digest\":\"fnv1a64:c88b0bf6b974ac6b\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:431780d3772a52a5\"");
    ...
    assert_contains(cmake_lists, "project(mini_kv VERSION 0.98.0");
    ...
    assert_contains(result.response, "\"source_version\":\"0.98.0\"");
    assert_contains(result.response, "\"artifact_path_hint\":\"c/98/\"");
    assert_contains(result.response, "\"provenance_digest\":\"fnv1a64:4be577ac4f8347c6\"");
    ...
    assert_contains(result.response, "\"session_id_echo\":\"mini-kv-live-read-v98\"");
    ...
    assert_contains(result.response, "\"check_digest\":\"fnv1a64:3397146bc78ee26f\"");
    ...
    assert_contains(result.response, "\"marker_digest\":\"fnv1a64:f8c7f073fdddb289\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:f006b4f4299a99ce\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:86f3d1ae4aaf7c62\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:7bce24ede1836a30\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:36b65e9c69f03b49\"");
    ...
    assert_contains(result.response, "\"current_artifact_path_hint\":\"c/98/\"");
    assert_contains(result.response, "\"adapter_target\":\"sandbox managed audit adapter dry-run\"");
    assert_contains(result.response, "\"runtime_role\":\"runtime evidence provider only\"");
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:9e89d248ca215706\"");
    ...
    assert_contains(result.response, "\"marker_digest\":\"fnv1a64:c88b0bf6b974ac6b\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:431780d3772a52a5\"");
