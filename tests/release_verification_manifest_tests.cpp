...
int main() {
    ...
    assert_contains(result.response, "\"node_consumption\":\"Node v267 may verify the mini-kv v117 credential resolver fake-shell archive non-participation receipt");
