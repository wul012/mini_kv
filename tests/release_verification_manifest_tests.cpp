...
int main() {
    ...
    assert_contains(manifest, "\"project_version\":\"0.90.0\"");
    assert_contains(manifest, "\"release_version\":\"v90\"");
    ...
    assert_contains(manifest,
                    "\"consumer_hint\":\"Node v223 managed audit external adapter connection readiness review\"");

    assert_contains(manifest, "\"command\":\"cmake -S . -B cmake-build-v90");
    assert_contains(manifest, "\"command\":\"cmake --build cmake-build-v90 --parallel 2\"");
    assert_contains(manifest, "\"command\":\"ctest --test-dir cmake-build-v90 --output-on-failure\"");
    ...
    assert_contains(manifest, "\"SMOKEJSON version matches 0.90.0\"");
    assert_contains(manifest, "\"SMOKEJSON returns runtime_smoke evidence\"");
    assert_contains(manifest, "\"SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v90\"");
    assert_contains(manifest, "\"SMOKEJSON exposes live_read_session.read_command_list_digest=fnv1a64:5bef33f2fbe65cc5\"");
    assert_contains(manifest, "\"SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:05de09a5ea28b666\"");
    assert_contains(manifest, "\"SMOKEJSON exposes binary_provenance.production_binary_claimed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:9e97e1284756f0e3\"");
    assert_contains(manifest, "\"SMOKEJSON exposes retention_provenance_check.managed_audit_write_executed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes retention_provenance_replay_marker.consumed_release_version=v84\"");
    assert_contains(manifest, "\"SMOKEJSON exposes retention_provenance_replay_marker.marker_digest=fnv1a64:5b19ed3789b3f799\"");
    assert_contains(manifest, "\"SMOKEJSON exposes retention_provenance_replay_marker.replay_executed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.consumed_release_version=v85\"");
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.receipt_digest=fnv1a64:7d0e1dbbfabd869e\"");
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.adapter_write_allowed=false\"");
    assert_contains(manifest, "\"SMOKEJSON exposes adapter_shell_non_storage_guard_receipt.consumed_release_version=v88\"");
    assert_contains(manifest, "\"SMOKEJSON exposes adapter_shell_non_storage_guard_receipt.receipt_digest=fnv1a64:385f612f8ea585d0\"");
    ...
    assert_contains(manifest, "\"SMOKEJSON exposes managed_audit_external_adapter_non_participation_receipt.receipt_digest=fnv1a64:0dfb07cd2f8de289\"");
    ...
    assert_contains(manifest, "\"cmake_project_version\":\"0.90.0\"");
    ...
    assert_contains(manifest, "\"session_id_echo\":\"mini-kv-live-read-v90\"");
    ...
    assert_contains(manifest, "\"source_version\":\"0.90.0\"");
    assert_contains(manifest, "\"artifact_path_hint\":\"c/90/\"");
    assert_contains(manifest, "\"runtime_binary_hint\":\"cmake-build-v90/minikv_server and cmake-build-v90/minikv_client from the current CMake build\"");
    ...
    assert_contains(manifest, "\"provenance_digest\":\"fnv1a64:05de09a5ea28b666\"");
    ...
    assert_contains(manifest, "\"expected_binary_provenance_digest\":\"fnv1a64:05de09a5ea28b666\"");
    assert_contains(manifest, "\"check_digest\":\"fnv1a64:9e97e1284756f0e3\"");
    ...
    assert_contains(manifest, "\"current_artifact_path_hint\":\"c/90/\"");
    assert_contains(manifest, "\"marker_digest\":\"fnv1a64:5b19ed3789b3f799\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:7d0e1dbbfabd869e\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:b528c09e1d2e919e\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:1f14361070b229f2\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:385f612f8ea585d0\"");
    ...
    assert_contains(manifest, "\"receipt_digest\":\"fnv1a64:0dfb07cd2f8de289\"");
    ...
    assert_contains(cmake_lists, "project(mini_kv VERSION 0.90.0");
