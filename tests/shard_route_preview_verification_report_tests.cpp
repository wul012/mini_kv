...
int main() {
    ...
    assert_contains(report, "\"reportStage\":\"route-preview-verification-report-java-echo-handoff\"");
    assert_contains(report, "\"reportStageSequence\":14");
    assert_contains(report, "\"reportReleaseVersion\":\"v333\"");
    assert_contains(report, "\"sourceFrozenReleaseVersion\":\"v332\"");
    assert_contains(report, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v332.json\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v332\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v332.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-report-java-echo-handoff\"");
    assert_contains(rollout, "\"rolloutStageSequence\":14");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v333\"");
    assert_contains(rollout, "\"publishedStageCount\":14");
