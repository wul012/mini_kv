...
int main() {
    ...
    assert_contains(report, "\"reportStage\":\"route-preview-verification-report-sample-parity-audit\"");
    assert_contains(report, "\"reportStageSequence\":8");
    assert_contains(report, "\"reportReleaseVersion\":\"v327\"");
    assert_contains(report, "\"sourceFrozenReleaseVersion\":\"v326\"");
    assert_contains(report, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v326.json\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v326\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v326.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-report-sample-parity-audit\"");
    assert_contains(rollout, "\"rolloutStageSequence\":8");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v327\"");
    assert_contains(rollout, "\"publishedStageCount\":8");
