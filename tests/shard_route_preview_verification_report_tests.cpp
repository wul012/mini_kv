...
int main() {
    ...
    assert_contains(report, "\"reportStage\":\"route-preview-verification-report-checkjson-contract\"");
    assert_contains(report, "\"reportStageSequence\":4");
    assert_contains(report, "\"reportReleaseVersion\":\"v323\"");
    assert_contains(report, "\"sourceFrozenReleaseVersion\":\"v322\"");
    assert_contains(report, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v322.json\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v322\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v322.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-report-checkjson-contract\"");
    assert_contains(rollout, "\"rolloutStageSequence\":4");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v323\"");
    assert_contains(rollout, "\"publishedStageCount\":4");
