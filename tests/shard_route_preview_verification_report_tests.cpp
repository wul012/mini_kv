...
int main() {
    ...
    assert_contains(report, "\"reportStage\":\"route-preview-verification-report-command-contract\"");
    assert_contains(report, "\"reportStageSequence\":1");
    assert_contains(report, "\"reportReleaseVersion\":\"v320\"");
    assert_contains(report, "\"sourceFrozenReleaseVersion\":\"v319\"");
    assert_contains(report, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v319.json\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v319\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v319.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-report-command-contract\"");
    assert_contains(rollout, "\"rolloutStageSequence\":1");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v320\"");
    assert_contains(rollout, "\"publishedStageCount\":1");
