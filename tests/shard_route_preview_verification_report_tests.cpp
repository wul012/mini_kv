...
int main() {
    ...
    assert_contains(report, "\"reportStage\":\"route-preview-verification-report-node-consumer-handoff\"");
    assert_contains(report, "\"reportStageSequence\":13");
    assert_contains(report, "\"reportReleaseVersion\":\"v332\"");
    assert_contains(report, "\"sourceFrozenReleaseVersion\":\"v331\"");
    assert_contains(report, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v331.json\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v331\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v331.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-report-node-consumer-handoff\"");
    assert_contains(rollout, "\"rolloutStageSequence\":13");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v332\"");
