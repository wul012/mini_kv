...
int main() {
    ...
    assert_contains(report, "\"reportStage\":\"route-preview-verification-report-explain-contract\"");
    assert_contains(report, "\"reportStageSequence\":3");
    assert_contains(report, "\"reportReleaseVersion\":\"v322\"");
    assert_contains(report, "\"sourceFrozenReleaseVersion\":\"v321\"");
    assert_contains(report, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v321.json\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v321\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v321.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-report-explain-contract\"");
    assert_contains(rollout, "\"rolloutStageSequence\":3");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v322\"");
    assert_contains(rollout, "\"publishedStageCount\":3");
