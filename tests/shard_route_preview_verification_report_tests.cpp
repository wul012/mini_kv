...
int main() {
    ...
    assert_contains(report, "\"reportStage\":\"route-preview-verification-report-fixture-freeze\"");
    assert_contains(report, "\"reportStageSequence\":7");
    assert_contains(report, "\"reportReleaseVersion\":\"v326\"");
    assert_contains(report, "\"sourceFrozenReleaseVersion\":\"v325\"");
    assert_contains(report, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v325.json\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v325\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v325.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-report-fixture-freeze\"");
    assert_contains(rollout, "\"rolloutStageSequence\":7");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v326\"");
    assert_contains(rollout, "\"publishedStageCount\":7");
