...
int main() {
    ...
    assert_contains(report, "\"reportStage\":\"route-preview-verification-report-command-catalog-alignment\"");
    assert_contains(report, "\"reportStageSequence\":2");
    assert_contains(report, "\"reportReleaseVersion\":\"v321\"");
    assert_contains(report, "\"sourceFrozenReleaseVersion\":\"v320\"");
    assert_contains(report, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v320.json\"");
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v320\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v320.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-verification-report-command-catalog-alignment\"");
    assert_contains(rollout, "\"rolloutStageSequence\":2");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v321\"");
    assert_contains(rollout, "\"publishedStageCount\":2");
