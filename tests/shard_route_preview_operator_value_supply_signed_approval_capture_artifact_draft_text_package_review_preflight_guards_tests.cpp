...
int main() {
    ...
    const auto first =
        controls::format_signed_approval_capture_artifact_draft_text_package_review_preflight_guards_json(1);
    ...
    const auto all =
        controls::format_signed_approval_capture_artifact_draft_text_package_review_preflight_guards_json(99);
