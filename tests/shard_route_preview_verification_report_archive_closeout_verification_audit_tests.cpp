...
int main() {
    ...
    assert_contains(audit, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-checkjson-contract\"");
    assert_contains(audit, "\"auditStageSequence\":4");
    assert_contains(audit, "\"auditReleaseVersion\":\"v404\"");
    assert_contains(audit, "\"publishedStageCount\":4");
    assert_contains(audit, "\"plannedStageCount\":20");
    assert_contains(audit, "\"sourceFrozenReleaseVersion\":\"v403\"");
    assert_contains(audit, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v403.json\"");
    ...
    assert_contains(shard, "\"auditReleaseVersion\":\"v404\"");
