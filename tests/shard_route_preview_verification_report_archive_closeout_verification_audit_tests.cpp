...
int main() {
    ...
    assert_contains(audit, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-consumer-handoff-audit\"");
    assert_contains(audit, "\"auditStageSequence\":13");
    assert_contains(audit, "\"auditReleaseVersion\":\"v413\"");
    assert_contains(audit, "\"publishedStageCount\":13");
    assert_contains(audit, "\"plannedStageCount\":20");
    assert_contains(audit, "\"sourceFrozenReleaseVersion\":\"v412\"");
    assert_contains(audit, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v412.json\"");
    ...
    assert_contains(shard, "\"auditReleaseVersion\":\"v413\"");
