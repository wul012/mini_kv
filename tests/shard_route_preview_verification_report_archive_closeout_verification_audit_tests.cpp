...
int main() {
    ...
    assert_contains(audit, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-command-contract-and-section-dedup\"");
    assert_contains(audit, "\"auditStageSequence\":1");
    assert_contains(audit, "\"auditReleaseVersion\":\"v401\"");
    assert_contains(audit, "\"publishedStageCount\":1");
    assert_contains(audit, "\"plannedStageCount\":20");
    assert_contains(audit, "\"sourceFrozenReleaseVersion\":\"v400\"");
    assert_contains(audit, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v400.json\"");
    ...
    assert_contains(audit, "\"archiveCloseoutVerificationAuditChainComplete\":false");
    ...
    assert_contains(shard, "\"auditReleaseVersion\":\"v401\"");
