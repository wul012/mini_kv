...
int main() {
    ...
    assert_contains(audit, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-explain-contract\"");
    assert_contains(audit, "\"auditStageSequence\":3");
    assert_contains(audit, "\"auditReleaseVersion\":\"v403\"");
    assert_contains(audit, "\"publishedStageCount\":3");
    assert_contains(audit, "\"plannedStageCount\":20");
    assert_contains(audit, "\"sourceFrozenReleaseVersion\":\"v402\"");
    assert_contains(audit, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v402.json\"");
    ...
    assert_contains(shard, "\"auditReleaseVersion\":\"v403\"");
