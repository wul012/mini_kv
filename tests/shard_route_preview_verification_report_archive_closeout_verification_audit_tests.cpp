...
int main() {
    ...
    assert_contains(audit, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-cli-smoke-contract\"");
    assert_contains(audit, "\"auditStageSequence\":5");
    assert_contains(audit, "\"auditReleaseVersion\":\"v405\"");
    assert_contains(audit, "\"publishedStageCount\":5");
    assert_contains(audit, "\"plannedStageCount\":20");
    assert_contains(audit, "\"sourceFrozenReleaseVersion\":\"v404\"");
    assert_contains(audit, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v404.json\"");
    ...
    assert_contains(shard, "\"auditReleaseVersion\":\"v405\"");
