...
int main() {
    ...
    assert_contains(audit, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-catalog-alignment\"");
    assert_contains(audit, "\"auditStageSequence\":2");
    assert_contains(audit, "\"auditReleaseVersion\":\"v402\"");
    assert_contains(audit, "\"publishedStageCount\":2");
    assert_contains(audit, "\"plannedStageCount\":20");
    assert_contains(audit, "\"sourceFrozenReleaseVersion\":\"v401\"");
    assert_contains(audit, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v401.json\"");
    ...
    assert_contains(shard, "\"auditReleaseVersion\":\"v402\"");
