...
int main() {
    ...
    assert_contains(audit, "\"auditStage\":\"route-preview-verification-report-archive-closeout-verification-audit-boundary-field-audit\"");
    assert_contains(audit, "\"auditStageSequence\":16");
    assert_contains(audit, "\"auditReleaseVersion\":\"v416\"");
    assert_contains(audit, "\"publishedStageCount\":16");
    assert_contains(audit, "\"plannedStageCount\":20");
    assert_contains(audit, "\"sourceFrozenReleaseVersion\":\"v415\"");
    assert_contains(audit, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v415.json\"");
    ...
    assert_contains(shard, "\"auditReleaseVersion\":\"v416\"");
