...
int main() {
    ...
    assert(completion.complete(value_supply_profile_section_prefix, value_supply_profile_section_prefix.size()) ==
           std::optional<std::string>{"SHARDROUTEVALUESUPPLYPROFILESECTION"});
    const std::string value_supply_profile_section_exact_prefix = "SHARDROUTEVALUESUPPLYPROFILESECTIONJ";
    assert(completion.complete(value_supply_profile_section_exact_prefix,
                               value_supply_profile_section_exact_prefix.size()) ==
           std::optional<std::string>{"SHARDROUTEVALUESUPPLYPROFILESECTIONJSON "});
    const std::string value_supply_profile_section_integrity_prefix = "SHARDROUTEVALUESUPPLYPROFILESECTIONI";
    assert(completion.complete(value_supply_profile_section_integrity_prefix,
                               value_supply_profile_section_integrity_prefix.size()) ==
           std::optional<std::string>{"SHARDROUTEVALUESUPPLYPROFILESECTIONINTEGRITYJSON "});
    const std::string production_live_capture_prefix = "SHARDROUTEPROD";
    assert(completion.complete(production_live_capture_prefix, production_live_capture_prefix.size()) ==
           std::optional<std::string>{"SHARDROUTEPRODUCTIONLIVECAPTURE"});
    const std::string production_live_capture_archive_prefix = "SHARDROUTEPRODUCTIONLIVECAPTUREA";
    assert(completion.complete(production_live_capture_archive_prefix,
                               production_live_capture_archive_prefix.size()) ==
           std::optional<std::string>{"SHARDROUTEPRODUCTIONLIVECAPTUREARCHIVE"});
    const std::string production_live_capture_archive_verification_prefix =
        "SHARDROUTEPRODUCTIONLIVECAPTUREARCHIVEV";
    assert(completion.complete(production_live_capture_archive_verification_prefix,
                               production_live_capture_archive_verification_prefix.size()) ==
           std::optional<std::string>{
               "SHARDROUTEPRODUCTIONLIVECAPTUREARCHIVEVERIFYNONPARTICIPATIONJSON "});
    const std::string production_live_capture_release_review_prefix =
        "SHARDROUTEPRODUCTIONLIVECAPTURER";
    assert(completion.complete(production_live_capture_release_review_prefix,
                               production_live_capture_release_review_prefix.size()) ==
           std::optional<std::string>{
               "SHARDROUTEPRODUCTIONLIVECAPTURERELEASEEVIDENCEREVIEWNONPARTICIPATIONJSON "});
    const std::string catalog_entry_group_split_prefix = "SHARDROUTECATALOG";
    assert(completion.complete(catalog_entry_group_split_prefix, catalog_entry_group_split_prefix.size()) ==
    ...
    assert(completion.complete(type_barrel_split_follow_up_prefix, type_barrel_split_follow_up_prefix.size()) ==
           std::optional<std::string>{"SHARDROUTETYPEBARRELSPLITFOLLOWUP"});
    const std::string type_barrel_split_follow_up_fixture_prefix = "SHARDROUTETYPEBARRELSPLITFOLLOWUPF";
    ...
    const std::string sandbox_endpoint_credential_resolver_prefix = "SHARDROUTESANDBOXENDPOINTCREDENTIAL";
    assert(completion.complete(sandbox_endpoint_credential_resolver_prefix,
    ...
    assert(completion.complete(disabled_fake_harness_contract_upstream_echo_verification_split_prefix,
           ...
           std::optional<std::string>{
               "SHARDROUTEDISABLEDFAKEHARNESSCONTRACTUPSTREAMECHOVERIFICATIONSPLITNONPARTICIPATIONJSON "});
    const std::string blocked_execution_rehearsal_split_prefix = "SHARDROUTEBLOCKEDEXECUTION";
    ...
    assert(completion.complete(precheck_upstream_receipt_verification_split_prefix,
           ...
           std::optional<std::string>{
               "SHARDROUTEPRECHECKUPSTREAMRECEIPTVERIFICATIONSPLITNONPARTICIPATIONJSON "});
    const std::string runtime_approval_gate_archive_prefix = "SHARDROUTERUNTIMEEXECUTION";
    assert(completion.complete(runtime_approval_gate_archive_prefix,
    ...
    const std::string mini_kv_owner_receipt_bundle_prefix = "SHARDPRODUCTIONSHARDEXECUTIONMINIKV";
    assert(completion.complete(mini_kv_owner_receipt_bundle_prefix,
                               mini_kv_owner_receipt_bundle_prefix.size()) ==
           std::optional<std::string>{"SHARDPRODUCTIONSHARDEXECUTIONMINIKVOWNERRECEIPTBUNDLEJSON "});
    const std::string external_artifact_dry_run_closeout_prefix = "SHARDPRODUCTIONSHARDEXECUTIONE";
    assert(completion.complete(external_artifact_dry_run_closeout_prefix,
                               external_artifact_dry_run_closeout_prefix.size()) ==
           std::optional<std::string>{
               "SHARDPRODUCTIONSHARDEXECUTIONEXTERNALARTIFACTDRYRUNCLOSEOUTJSON "});
    ...
    assert(completion.complete(type_barrel_split_follow_up_non_participation_prefix,
                               type_barrel_split_follow_up_non_participation_prefix.size()) ==
