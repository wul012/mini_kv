...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-profile-count\"");
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditReleaseVersion\":\"v816\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v815\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v815.json\"");
    ...
    assert_contains(json, "\"completedAuditCheckCount\":6");
    ...
    assert(digest.find("v816-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-profile-count") != std::string::npos);
