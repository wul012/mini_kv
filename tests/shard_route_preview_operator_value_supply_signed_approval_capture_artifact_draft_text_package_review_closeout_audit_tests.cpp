...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-parse-rejection\"");
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditReleaseVersion\":\"v821\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v820\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v820.json\"");
    ...
    assert_contains(json, "\"completedAuditCheckCount\":11");
    ...
    assert(digest.find("v821-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-parse-rejection") != std::string::npos);
