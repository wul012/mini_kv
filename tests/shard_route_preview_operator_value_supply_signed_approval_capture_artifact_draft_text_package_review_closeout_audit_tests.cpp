...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-acceptance-rejection\"");
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditReleaseVersion\":\"v822\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v821\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v821.json\"");
    ...
    assert_contains(json, "\"completedAuditCheckCount\":12");
    ...
    assert(digest.find("v822-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-acceptance-rejection") != std::string::npos);
