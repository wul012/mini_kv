...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-release-range\"");
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditReleaseVersion\":\"v812\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v811\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v811.json\"");
    ...
    assert_contains(json, "\"completedAuditCheckCount\":2");
    ...
    assert(digest.find("v812-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-release-range") != std::string::npos);
