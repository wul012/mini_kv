...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-source-freeze\"");
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditReleaseVersion\":\"v811\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v810\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v810.json\"");
    ...
    assert_contains(json, "\"completedAuditCheckCount\":1");
    ...
    assert(digest.find("v811-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-source-freeze") != std::string::npos);
