...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-draft-text-absence\"");
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditReleaseVersion\":\"v820\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v819\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v819.json\"");
    ...
    assert_contains(json, "\"completedAuditCheckCount\":10");
    ...
    assert(digest.find("v820-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-draft-text-absence") != std::string::npos);
