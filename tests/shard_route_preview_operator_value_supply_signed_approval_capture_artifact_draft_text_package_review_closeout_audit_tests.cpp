...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-runtime-payload-rejection\"");
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditReleaseVersion\":\"v826\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v825\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v825.json\"");
    ...
    assert_contains(json, "\"completedAuditCheckCount\":16");
    ...
    assert(digest.find("v826-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-runtime-payload-rejection") != std::string::npos);
