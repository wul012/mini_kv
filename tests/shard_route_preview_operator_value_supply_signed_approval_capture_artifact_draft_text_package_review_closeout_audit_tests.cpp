...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-stage-sequence\"");
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditReleaseVersion\":\"v813\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v812\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v812.json\"");
    ...
    assert_contains(json, "\"completedAuditCheckCount\":3");
    ...
    assert(digest.find("v813-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-stage-sequence") != std::string::npos);
