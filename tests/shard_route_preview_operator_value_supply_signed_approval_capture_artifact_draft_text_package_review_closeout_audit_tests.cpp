...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-approval-grant-rejection\"");
    assert_contains(json, "\"draftTextPackageReviewCloseoutAuditReleaseVersion\":\"v823\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v822\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v822.json\"");
    ...
    assert_contains(json, "\"completedAuditCheckCount\":13");
    ...
    assert(digest.find("v823-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-closeout-audit-approval-grant-rejection") != std::string::npos);
