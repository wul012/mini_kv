...
int main() {
    ...
    const auto ok = validation::format_candidate_document_request_package_validation_json(15, 15, 38, 1, 1, 3, true, 1);
    ...
    const auto complete =
        validation::format_candidate_document_request_package_validation_json(15, 15, 38, 15, 15, 38, true, 15);
    ...
    const auto blocked =
        validation::format_candidate_document_request_package_validation_json(15, 15, 38, 2, 1, 4, true, 2);
