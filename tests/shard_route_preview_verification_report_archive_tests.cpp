...
int main() {
    ...
    assert_contains(archive, "\"archiveStage\":\"route-preview-verification-report-archive-cli-smoke-contract\"");
    assert_contains(archive, "\"archiveStageSequence\":14");
    assert_contains(archive, "\"archiveReleaseVersion\":\"v354\"");
    assert_contains(archive, "\"publishedStageCount\":14");
    assert_contains(archive, "\"plannedStageCount\":20");
    assert_contains(archive, "\"sourceFrozenReleaseVersion\":\"v353\"");
    assert_contains(archive, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v353.json\"");
