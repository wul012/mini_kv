...
int main() {
    ...
    assert_contains(archive, "\"archiveStage\":\"route-preview-verification-report-archive-fixture-freeze\"");
    assert_contains(archive, "\"archiveStageSequence\":13");
    assert_contains(archive, "\"archiveReleaseVersion\":\"v353\"");
    assert_contains(archive, "\"publishedStageCount\":13");
    assert_contains(archive, "\"plannedStageCount\":20");
    assert_contains(archive, "\"sourceFrozenReleaseVersion\":\"v352\"");
    assert_contains(archive, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v352.json\"");
