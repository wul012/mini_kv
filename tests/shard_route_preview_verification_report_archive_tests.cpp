...
int main() {
    ...
    assert_contains(archive, "\"archiveStage\":\"route-preview-verification-report-archive-index-audit\"");
    assert_contains(archive, "\"archiveStageSequence\":4");
    assert_contains(archive, "\"archiveReleaseVersion\":\"v344\"");
    assert_contains(archive, "\"publishedStageCount\":4");
    assert_contains(archive, "\"plannedStageCount\":20");
    assert_contains(archive, "\"sourceFrozenReleaseVersion\":\"v343\"");
    assert_contains(archive, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v343.json\"");
