...
int main() {
    ...
    assert_contains(archive, "\"archiveStage\":\"route-preview-verification-report-archive-no-write-audit\"");
    assert_contains(archive, "\"archiveStageSequence\":17");
    assert_contains(archive, "\"archiveReleaseVersion\":\"v357\"");
    assert_contains(archive, "\"publishedStageCount\":17");
    assert_contains(archive, "\"plannedStageCount\":20");
    assert_contains(archive, "\"sourceFrozenReleaseVersion\":\"v356\"");
    assert_contains(archive, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v356.json\"");
