...
int main() {
    ...
    assert_contains(archive, "\"archiveStage\":\"route-preview-verification-report-archive-continuity-map\"");
    assert_contains(archive, "\"archiveStageSequence\":7");
    assert_contains(archive, "\"archiveReleaseVersion\":\"v347\"");
    assert_contains(archive, "\"publishedStageCount\":7");
    assert_contains(archive, "\"plannedStageCount\":20");
    assert_contains(archive, "\"sourceFrozenReleaseVersion\":\"v346\"");
    assert_contains(archive, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v346.json\"");
