...
int main() {
    ...
    assert_contains(archive, "\"archiveStage\":\"route-preview-verification-report-archive-index\"");
    assert_contains(archive, "\"archiveStageSequence\":3");
    assert_contains(archive, "\"archiveReleaseVersion\":\"v343\"");
    assert_contains(archive, "\"publishedStageCount\":3");
    assert_contains(archive, "\"plannedStageCount\":20");
    assert_contains(archive, "\"sourceFrozenReleaseVersion\":\"v342\"");
    assert_contains(archive, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v342.json\"");
