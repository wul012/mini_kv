...
int main() {
    ...
    const auto passed = validation::format_catalog_entry_group_split_non_participation_validation_json(
        35, true, false, false, false, false, 30, 30, 30, 30);
    ...
    const auto failed_source =
        validation::format_catalog_entry_group_split_non_participation_validation_json(
            34, true, false, false, false, false, 30, 30, 30, 30);
    ...
    const auto failed_closure =
        validation::format_catalog_entry_group_split_non_participation_validation_json(
            35, true, false, true, false, false, 30, 30, 30, 30);
    ...
    const auto failed_count =
        validation::format_catalog_entry_group_split_non_participation_validation_json(
            35, true, false, false, false, false, 30, 29, 30, 30);
