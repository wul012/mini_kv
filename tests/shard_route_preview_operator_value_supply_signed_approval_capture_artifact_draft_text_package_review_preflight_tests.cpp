...
int main() {
    ...
    assert_contains(json, "\"draftTextPackageReviewPreflightStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-preflight-package-schema-version-criterion\"");
    assert_contains(json, "\"draftTextPackageReviewPreflightReleaseVersion\":\"v788\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v787\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v787.json\"");
    ...
    assert_contains(json, "\"preparedReviewCriterionCount\":3");
    ...
    assert_contains(json, "\"criterionCode\":\"package_schema_version_criterion\"");
    assert_contains(json, "\"controlCode\":\"package_schema_version_criterion_control\"");
    assert_contains(json, "\"profileCode\":\"draft_text_package_review_preflight_package_schema_version_criterion_profile\"");
    ...
    assert(digest.find("v788-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-preflight-package-schema-version-criterion") != std::string::npos);
