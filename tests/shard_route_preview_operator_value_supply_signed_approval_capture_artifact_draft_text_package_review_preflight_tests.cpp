...
int main() {
    ...
    assert_contains(json,
                    "\"draftTextPackageReviewPreflightStage\":\"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-preflight-package-manifest-criterion\"");
    assert_contains(json, "\"draftTextPackageReviewPreflightReleaseVersion\":\"v786\"");
    assert_contains(json, "\"sourceFrozenReleaseVersion\":\"v785\"");
    assert_contains(json, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v785.json\"");
    ...
    assert_contains(json, "\"preparedReviewCriterionCount\":1");
    ...
    assert_contains(json, "\"reviewCriteria\":[{\"sequence\":1,\"criterionCode\":\"package_manifest_criterion\"");
    assert_contains(json, "\"rejectionControls\":[{\"sequence\":1,\"controlCode\":\"package_manifest_criterion_control\"");
    assert_contains(json,
                    "\"reviewProfiles\":[{\"sequence\":1,\"profileCode\":\"draft_text_package_review_preflight_package_manifest_criterion_profile\"");
    ...
    assert(digest.find("v786-route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-review-preflight-package-manifest-criterion") !=
           std::string::npos);
