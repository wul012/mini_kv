...
int main() {
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v297\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v297.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-release-package-audit\"");
    assert_contains(rollout, "\"rolloutStageSequence\":20");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v298\"");
