...
int main() {
    ...
    assert_contains(rollout, "\"sourceFrozenReleaseVersion\":\"v287\"");
    assert_contains(rollout, "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v287.json\"");
    assert_contains(rollout, "\"rolloutStage\":\"route-preview-rollout-catalog-audit\"");
    assert_contains(rollout, "\"rolloutStageSequence\":10");
    assert_contains(rollout, "\"rolloutReleaseVersion\":\"v288\"");
