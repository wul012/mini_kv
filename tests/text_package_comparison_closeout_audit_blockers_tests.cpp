...
int main() {
    ...
    const auto records =
        blockers::signed_approval_capture_artifact_draft_text_package_comparison_closeout_audit_blockers();
    ...
    assert(blockers::
               planned_signed_approval_capture_artifact_draft_text_package_comparison_closeout_audit_blocker_count() ==
           25);
