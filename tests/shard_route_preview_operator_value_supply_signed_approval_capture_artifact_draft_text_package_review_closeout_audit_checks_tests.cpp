...
int main() {
    ...
    assert(checks::planned_signed_approval_capture_artifact_draft_text_package_review_closeout_audit_check_count() ==
           25);

    const auto first =
        checks::format_signed_approval_capture_artifact_draft_text_package_review_closeout_audit_checks_json(1);
    ...
    const auto all =
        checks::format_signed_approval_capture_artifact_draft_text_package_review_closeout_audit_checks_json(99);
