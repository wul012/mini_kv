...
int main() {
    ...
    minikv::test_support::assert_contains(maintenance,
                                          "\"maintenanceStage\":\"route-preview-archive-maintenance-tcp-smoke-contract\"");
    minikv::test_support::assert_contains(maintenance, "\"maintenanceStageSequence\":10");
    minikv::test_support::assert_contains(maintenance, "\"maintenanceReleaseVersion\":\"v470\"");
    minikv::test_support::assert_contains(maintenance, "\"publishedStageCount\":10");
    minikv::test_support::assert_contains(maintenance, "\"plannedStageCount\":25");
    minikv::test_support::assert_contains(maintenance, "\"sourceFrozenReleaseVersion\":\"v469\"");
    minikv::test_support::assert_contains(maintenance,
                                          "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v469.json\"");
    ...
    minikv::test_support::assert_contains(shard, "\"releaseVersion\":\"v470\"");
    minikv::test_support::assert_contains(shard, "\"status\":\"route-preview-archive-maintenance-tcp-smoke-contract-read-only\"");
    minikv::test_support::assert_contains(shard, "\"maintenanceReleaseVersion\":\"v470\"");
