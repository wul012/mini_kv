...
int main() {
    ...
    minikv::test_support::assert_contains(maintenance,
                                          "\"maintenanceStage\":\"route-preview-archive-maintenance-java-echo-boundary-handoff\"");
    minikv::test_support::assert_contains(maintenance, "\"maintenanceStageSequence\":21");
    minikv::test_support::assert_contains(maintenance, "\"maintenanceReleaseVersion\":\"v481\"");
    minikv::test_support::assert_contains(maintenance, "\"publishedStageCount\":21");
    minikv::test_support::assert_contains(maintenance, "\"plannedStageCount\":25");
    minikv::test_support::assert_contains(maintenance, "\"sourceFrozenReleaseVersion\":\"v480\"");
    minikv::test_support::assert_contains(maintenance,
                                          "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v480.json\"");
    ...
    minikv::test_support::assert_contains(shard, "\"releaseVersion\":\"v481\"");
    minikv::test_support::assert_contains(shard, "\"status\":\"route-preview-archive-maintenance-java-echo-boundary-handoff-read-only\"");
    minikv::test_support::assert_contains(shard, "\"maintenanceReleaseVersion\":\"v481\"");
