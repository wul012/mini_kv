...
int main() {
    ...
    minikv::test_support::assert_contains(maintenance,
                                          "\"maintenanceStage\":\"route-preview-archive-maintenance-retention-map\"");
    minikv::test_support::assert_contains(maintenance, "\"maintenanceStageSequence\":14");
    minikv::test_support::assert_contains(maintenance, "\"maintenanceReleaseVersion\":\"v474\"");
    minikv::test_support::assert_contains(maintenance, "\"publishedStageCount\":14");
    minikv::test_support::assert_contains(maintenance, "\"plannedStageCount\":25");
    minikv::test_support::assert_contains(maintenance, "\"sourceFrozenReleaseVersion\":\"v473\"");
    minikv::test_support::assert_contains(maintenance,
                                          "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v473.json\"");
    ...
    minikv::test_support::assert_contains(shard, "\"releaseVersion\":\"v474\"");
    minikv::test_support::assert_contains(shard, "\"status\":\"route-preview-archive-maintenance-retention-map-read-only\"");
    minikv::test_support::assert_contains(shard, "\"maintenanceReleaseVersion\":\"v474\"");
