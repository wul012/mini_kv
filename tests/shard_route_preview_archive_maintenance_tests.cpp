...
int main() {
    ...
    minikv::test_support::assert_contains(maintenance,
                                          "\"maintenanceStage\":\"route-preview-archive-maintenance-source-fixture-index-audit\"");
    minikv::test_support::assert_contains(maintenance, "\"maintenanceStageSequence\":13");
    minikv::test_support::assert_contains(maintenance, "\"maintenanceReleaseVersion\":\"v473\"");
    minikv::test_support::assert_contains(maintenance, "\"publishedStageCount\":13");
    minikv::test_support::assert_contains(maintenance, "\"plannedStageCount\":25");
    minikv::test_support::assert_contains(maintenance, "\"sourceFrozenReleaseVersion\":\"v472\"");
    minikv::test_support::assert_contains(maintenance,
                                          "\"sourceFrozenFixturePath\":\"fixtures/release/shard-readiness-v472.json\"");
    ...
    minikv::test_support::assert_contains(shard, "\"releaseVersion\":\"v473\"");
    minikv::test_support::assert_contains(shard, "\"status\":\"route-preview-archive-maintenance-source-fixture-index-audit-read-only\"");
    minikv::test_support::assert_contains(shard, "\"maintenanceReleaseVersion\":\"v473\"");
