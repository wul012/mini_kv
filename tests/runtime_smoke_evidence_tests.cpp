...
int main() {
    ...
    assert_contains(smoke, "\"runtime_smoke_evidence_version\":\"mini-kv-runtime-smoke-evidence.v7\"");
    assert_contains(smoke, "\"project\":\"mini-kv\"");
    assert_contains(smoke, "\"project_version\":\"0.82.0\"");
    assert_contains(smoke, "\"release_version\":\"v82\"");
    ...
    assert_contains(smoke, "\"consumer_hint\":\"Node v205 three-project real-read runtime smoke execution packet\"");
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.82.0\"");
    ...
    assert_contains(smoke, "SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v82 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5");

    assert_contains(smoke, "\"server\":\"minikv_server 6420 127.0.0.1\"");
    assert_contains(smoke, "\"client\":\"minikv_client 127.0.0.1 6420 5000 --connect-retries 10 --retry-delay-ms 100\"");
    assert_contains(smoke, "\"commands\":[\"SMOKEJSON\",\"INFOJSON\",\"STORAGEJSON\",\"HEALTH\",\"GET restore:real-read-token\",\"QUIT\"]");

    assert_contains(smoke, "\"target_version\":\"Node v205\"");
    assert_contains(smoke, "\"mode\":\"three-project real-read runtime smoke execution packet\"");
    ...
    assert_contains(smoke, "\"node_must_verify\":\"live_read_session.session_id_echo equals mini-kv-live-read-v82");
    ...
    assert_contains(smoke, "\"session_id_echo\":\"mini-kv-live-read-v82\"");
    ...
    assert_contains(smoke, "\"Node v205 must verify live_read_session, taxonomy_digest, operator_window.identity_neutral_proof, ci_evidence, and artifact_retention before the real-read execution packet\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.82.0\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.82.0\"");
    ...
    assert_contains(result.response, "\"notes\":[\"runtime_smoke_evidence\",\"live_read_session_hint\",\"read_only_aggregate\",\"not_order_authoritative\","
