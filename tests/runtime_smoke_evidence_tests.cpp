...
int main() {
    ...
    assert_contains(smoke, "\"project_version\":\"0.88.0\"");
    assert_contains(smoke, "\"release_version\":\"v88\"");
    ...
    assert_contains(smoke, "\"consumer_hint\":\"Node v219 managed audit adapter implementation precheck packet\"");
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.88.0\"");
    ...
    assert_contains(smoke, "SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v88 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5");
    assert_contains(smoke, "SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:f9d8030cdd14ad18 and production_binary_claimed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:1e5d51ff30deb3e4 and managed_audit_write_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_replay_marker.marker_digest=fnv1a64:864ac1bef831e551 and replay_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.receipt_digest=fnv1a64:4135035dd3fe95d2 and adapter_write_allowed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest=fnv1a64:8640a9d8be7767ee and managed_audit_store=false");
    ...
    assert_contains(smoke, "\"target_version\":\"Node v219\"");
    assert_contains(smoke, "\"mode\":\"managed audit adapter implementation precheck packet\"");
    ...
    assert_contains(smoke, "\"node_must_verify\":\"binary_provenance.provenance_digest equals fnv1a64:f9d8030cdd14ad18");
    assert_contains(smoke, "binary_provenance.artifact_path_hint equals c/88/");
    ...
    assert_contains(smoke, "retention_provenance_check.expected_binary_provenance_digest equals fnv1a64:f9d8030cdd14ad18");
    assert_contains(smoke, "retention_provenance_check.check_digest equals fnv1a64:1e5d51ff30deb3e4");
    ...
    assert_contains(smoke, "retention_provenance_replay_marker.current_artifact_path_hint equals c/88/");
    assert_contains(smoke, "retention_provenance_replay_marker.marker_digest equals fnv1a64:864ac1bef831e551");
    ...
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.current_artifact_path_hint equals c/88/");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.receipt_digest equals fnv1a64:4135035dd3fe95d2");
    ...
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest equals fnv1a64:8640a9d8be7767ee");
    ...
    assert_contains(smoke, "live_read_session.session_id_echo equals mini-kv-live-read-v88");
    ...
    assert_contains(smoke, "\"session_id_echo\":\"mini-kv-live-read-v88\"");
    ...
    assert_contains(smoke, "\"source_version\":\"0.88.0\"");
    assert_contains(smoke, "\"artifact_path_hint\":\"c/88/\"");
    assert_contains(smoke, "\"runtime_binary_hint\":\"cmake-build-v88/minikv_server and cmake-build-v88/minikv_client from the current CMake build\"");
    ...
    assert_contains(smoke, "\"provenance_digest\":\"fnv1a64:f9d8030cdd14ad18\"");
    ...
    assert_contains(smoke, "\"expected_binary_provenance_digest\":\"fnv1a64:f9d8030cdd14ad18\"");
    assert_contains(smoke, "\"check_digest\":\"fnv1a64:1e5d51ff30deb3e4\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:864ac1bef831e551\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:4135035dd3fe95d2\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:8640a9d8be7767ee\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:4aa6d12fb067e2a6\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.88.0\"");
    ...
    assert_contains(result.response, "\"version\":\"0.88.0\"");
    ...
    assert_contains(result.response, "\"session_id_echo\":\"mini-kv-live-read-v88\"");
    ...
    assert_contains(result.response, "\"source_version\":\"0.88.0\"");
    assert_contains(result.response, "\"artifact_path_hint\":\"c/88/\"");
    assert_contains(result.response, "\"provenance_digest\":\"fnv1a64:f9d8030cdd14ad18\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:8640a9d8be7767ee\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:4aa6d12fb067e2a6\"");
    ...
    assert_contains(result.response, "\"expected_binary_provenance_digest\":\"fnv1a64:f9d8030cdd14ad18\"");
    assert_contains(result.response, "\"check_digest\":\"fnv1a64:1e5d51ff30deb3e4\"");
    ...
    assert_contains(result.response, "\"marker_digest\":\"fnv1a64:864ac1bef831e551\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:4135035dd3fe95d2\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.88.0\"");
