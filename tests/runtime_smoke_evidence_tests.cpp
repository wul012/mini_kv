...
int main() {
    ...
    assert_contains(smoke, "\"project_version\":\"0.97.0\"");
    assert_contains(smoke, "\"release_version\":\"v97\"");
    ...
    assert_contains(smoke, "\"consumer_hint\":\"Node v231 manual sandbox connection preflight verification\"");
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.97.0\"");
    ...
    assert_contains(smoke, "SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v97 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5");
    assert_contains(smoke, "SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:bc97d5dba7bf5130 and production_binary_claimed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:dfb8f391498358f3 and managed_audit_write_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_replay_marker.marker_digest=fnv1a64:70a34f981a518759 and replay_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.receipt_digest=fnv1a64:efcbd2ffb50e96aa and adapter_write_allowed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest=fnv1a64:7074656bc886ed76 and managed_audit_store=false");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_external_adapter_non_participation_receipt.receipt_digest=fnv1a64:953dd8fb3e1640f5");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest=fnv1a64:d71b79804d9cfd94");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_connection_receipt_echo_marker.marker_digest=fnv1a64:fbad91e89da49997");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_connection_no_start_guard_receipt.receipt_digest=fnv1a64:9ff902c1a090c0b7");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_no_start_guard_receipt.current_artifact_path_hint equals c/97/");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_no_start_guard_receipt.receipt_digest equals fnv1a64:9ff902c1a090c0b7");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_receipt_echo_marker.marker_digest equals fnv1a64:fbad91e89da49997");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.current_artifact_path_hint equals c/97/");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest equals fnv1a64:d71b79804d9cfd94");
    ...
    assert_contains(smoke, "managed_audit_external_adapter_non_participation_receipt.receipt_digest equals fnv1a64:953dd8fb3e1640f5");
    assert_contains(smoke, "adapter_shell_non_storage_guard_receipt.receipt_digest equals fnv1a64:4686040cffebdf32");
    assert_contains(smoke, "command_dispatch_quality_receipt.receipt_digest equals fnv1a64:637e56ca0a9c6536");
    assert_contains(smoke, "binary_provenance.provenance_digest equals fnv1a64:bc97d5dba7bf5130");
    ...
    assert_contains(smoke, "retention_provenance_check.check_digest equals fnv1a64:dfb8f391498358f3");
    assert_contains(smoke, "retention_provenance_replay_marker.current_artifact_path_hint equals c/97/");
    assert_contains(smoke, "retention_provenance_replay_marker.marker_digest equals fnv1a64:70a34f981a518759");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.current_artifact_path_hint equals c/97/");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.receipt_digest equals fnv1a64:efcbd2ffb50e96aa");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.current_artifact_path_hint equals c/97/");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest equals fnv1a64:7074656bc886ed76");
    assert_contains(smoke, "live_read_session.session_id_echo equals mini-kv-live-read-v97");
    ...
    assert_contains(smoke, "\"session_id_echo\":\"mini-kv-live-read-v97\"");
    ...
    assert_contains(smoke, "\"source_version\":\"0.97.0\"");
    assert_contains(smoke, "\"artifact_path_hint\":\"c/97/\"");
    assert_contains(smoke, "\"runtime_binary_hint\":\"cmake-build-v97/minikv_server and cmake-build-v97/minikv_client from the current CMake build\"");
    ...
    assert_contains(smoke, "\"provenance_digest\":\"fnv1a64:bc97d5dba7bf5130\"");
    ...
    assert_contains(smoke, "\"expected_binary_provenance_digest\":\"fnv1a64:bc97d5dba7bf5130\"");
    assert_contains(smoke, "\"check_digest\":\"fnv1a64:dfb8f391498358f3\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:70a34f981a518759\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:efcbd2ffb50e96aa\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:7074656bc886ed76\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:637e56ca0a9c6536\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:4686040cffebdf32\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:953dd8fb3e1640f5\"");
    ...
    assert_contains(smoke, "\"current_artifact_path_hint\":\"c/97/\"");
    assert_contains(smoke, "\"adapter_target\":\"sandbox managed audit adapter dry-run\"");
    assert_contains(smoke, "\"runtime_role\":\"runtime evidence provider only\"");
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:d71b79804d9cfd94\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:fbad91e89da49997\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:9ff902c1a090c0b7\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.97.0\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.97.0\"");
