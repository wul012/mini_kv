...
int main() {
    ...
    assert_contains(smoke, "\"project_version\":\"0.91.0\"");
    assert_contains(smoke, "\"release_version\":\"v91\"");
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.91.0\"");
    ...
    assert_contains(smoke, "SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v91 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5");
    assert_contains(smoke, "SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:fcb45d5de96a5cc4 and production_binary_claimed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:67d9e038b4f75ddd and managed_audit_write_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_replay_marker.marker_digest=fnv1a64:ee7d1884932cf285 and replay_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.receipt_digest=fnv1a64:db8816739e430716 and adapter_write_allowed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest=fnv1a64:e496a6646c73069e and managed_audit_store=false");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_external_adapter_non_participation_receipt.receipt_digest=fnv1a64:4b351e5a1f7b4f29");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest=fnv1a64:fd925623ea87eac4");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.current_artifact_path_hint equals c/91/");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest equals fnv1a64:fd925623ea87eac4");
    ...
    assert_contains(smoke, "managed_audit_external_adapter_non_participation_receipt.receipt_digest equals fnv1a64:4b351e5a1f7b4f29");
    assert_contains(smoke, "adapter_shell_non_storage_guard_receipt.receipt_digest equals fnv1a64:2a966abfb5f6707a");
    assert_contains(smoke, "command_dispatch_quality_receipt.receipt_digest equals fnv1a64:a5355285a46b8e02");
    assert_contains(smoke, "binary_provenance.provenance_digest equals fnv1a64:fcb45d5de96a5cc4");
    ...
    assert_contains(smoke, "retention_provenance_check.check_digest equals fnv1a64:67d9e038b4f75ddd");
    assert_contains(smoke, "retention_provenance_replay_marker.current_artifact_path_hint equals c/91/");
    assert_contains(smoke, "retention_provenance_replay_marker.marker_digest equals fnv1a64:ee7d1884932cf285");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.current_artifact_path_hint equals c/91/");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.receipt_digest equals fnv1a64:db8816739e430716");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.current_artifact_path_hint equals c/91/");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest equals fnv1a64:e496a6646c73069e");
    assert_contains(smoke, "live_read_session.session_id_echo equals mini-kv-live-read-v91");
    ...
    assert_contains(smoke, "\"session_id_echo\":\"mini-kv-live-read-v91\"");
    ...
    assert_contains(smoke, "\"source_version\":\"0.91.0\"");
    assert_contains(smoke, "\"artifact_path_hint\":\"c/91/\"");
    assert_contains(smoke, "\"runtime_binary_hint\":\"cmake-build-v91/minikv_server and cmake-build-v91/minikv_client from the current CMake build\"");
    ...
    assert_contains(smoke, "\"provenance_digest\":\"fnv1a64:fcb45d5de96a5cc4\"");
    ...
    assert_contains(smoke, "\"expected_binary_provenance_digest\":\"fnv1a64:fcb45d5de96a5cc4\"");
    assert_contains(smoke, "\"check_digest\":\"fnv1a64:67d9e038b4f75ddd\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:ee7d1884932cf285\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:db8816739e430716\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:e496a6646c73069e\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:a5355285a46b8e02\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:2a966abfb5f6707a\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:4b351e5a1f7b4f29\"");
    ...
    assert_contains(smoke, "\"current_artifact_path_hint\":\"c/91/\"");
    assert_contains(smoke, "\"adapter_target\":\"sandbox managed audit adapter dry-run\"");
    assert_contains(smoke, "\"runtime_role\":\"runtime evidence provider only\"");
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:fd925623ea87eac4\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.91.0\"");
    ...
    assert_contains(result.response, "\"version\":\"0.91.0\"");
    ...
    assert_contains(result.response, "\"session_id_echo\":\"mini-kv-live-read-v91\"");
    ...
    assert_contains(result.response, "\"source_version\":\"0.91.0\"");
    assert_contains(result.response, "\"artifact_path_hint\":\"c/91/\"");
    assert_contains(result.response, "\"provenance_digest\":\"fnv1a64:fcb45d5de96a5cc4\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:e496a6646c73069e\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:a5355285a46b8e02\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:2a966abfb5f6707a\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:4b351e5a1f7b4f29\"");
    ...
    assert_contains(result.response, "\"current_artifact_path_hint\":\"c/91/\"");
    assert_contains(result.response, "\"adapter_target\":\"sandbox managed audit adapter dry-run\"");
    assert_contains(result.response, "\"runtime_role\":\"runtime evidence provider only\"");
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:fd925623ea87eac4\"");
    ...
    assert_contains(result.response, "\"expected_binary_provenance_digest\":\"fnv1a64:fcb45d5de96a5cc4\"");
    assert_contains(result.response, "\"check_digest\":\"fnv1a64:67d9e038b4f75ddd\"");
    ...
    assert_contains(result.response, "\"marker_digest\":\"fnv1a64:ee7d1884932cf285\"");
    ...
    assert_contains(result.response, "\"receipt_digest\":\"fnv1a64:db8816739e430716\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.91.0\"");
