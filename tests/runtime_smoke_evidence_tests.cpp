...
int main() {
    ...
    assert_contains(smoke, "\"project_version\":\"0.99.0\"");
    assert_contains(smoke, "\"release_version\":\"v99\"");
    ...
    assert_contains(smoke, "\"consumer_hint\":\"Node v234 manual sandbox connection blocked execution rehearsal\"");
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.99.0\"");
    ...
    assert_contains(smoke, "SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v99 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5");
    assert_contains(smoke, "SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:68ec9a2a032906f4 and production_binary_claimed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:56b28a6190be9fe9 and managed_audit_write_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_replay_marker.marker_digest=fnv1a64:03afe1be1ce63765 and replay_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.receipt_digest=fnv1a64:3b406aed990b25d6 and adapter_write_allowed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest=fnv1a64:49eb9963647aecbe and managed_audit_store=false");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_external_adapter_non_participation_receipt.receipt_digest=fnv1a64:35fe7b1c42714d89");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest=fnv1a64:e718f4de6ca49014");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_connection_receipt_echo_marker.marker_digest=fnv1a64:0d5212cff01975af");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_connection_no_start_guard_receipt.receipt_digest=fnv1a64:1f09161efd809c33");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_no_start_guard_receipt.current_artifact_path_hint equals c/99/");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_no_start_guard_receipt.receipt_digest equals fnv1a64:1f09161efd809c33");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_receipt_echo_marker.marker_digest equals fnv1a64:0d5212cff01975af");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.current_artifact_path_hint equals c/99/");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest equals fnv1a64:e718f4de6ca49014");
    ...
    assert_contains(smoke, "managed_audit_external_adapter_non_participation_receipt.receipt_digest equals fnv1a64:35fe7b1c42714d89");
    assert_contains(smoke, "adapter_shell_non_storage_guard_receipt.receipt_digest equals fnv1a64:b46fadc02bfd129a");
    assert_contains(smoke, "command_dispatch_quality_receipt.receipt_digest equals fnv1a64:27c7a66594fe5792");
    assert_contains(smoke, "binary_provenance.provenance_digest equals fnv1a64:68ec9a2a032906f4");
    ...
    assert_contains(smoke, "retention_provenance_check.check_digest equals fnv1a64:56b28a6190be9fe9");
    assert_contains(smoke, "retention_provenance_replay_marker.current_artifact_path_hint equals c/99/");
    assert_contains(smoke, "retention_provenance_replay_marker.marker_digest equals fnv1a64:03afe1be1ce63765");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.current_artifact_path_hint equals c/99/");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.receipt_digest equals fnv1a64:3b406aed990b25d6");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.current_artifact_path_hint equals c/99/");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest equals fnv1a64:49eb9963647aecbe");
    assert_contains(smoke, "live_read_session.session_id_echo equals mini-kv-live-read-v99");
    ...
    assert_contains(smoke, "\"session_id_echo\":\"mini-kv-live-read-v99\"");
    ...
    assert_contains(smoke, "\"source_version\":\"0.99.0\"");
    assert_contains(smoke, "\"artifact_path_hint\":\"c/99/\"");
    assert_contains(smoke, "\"runtime_binary_hint\":\"cmake-build-v99/minikv_server and cmake-build-v99/minikv_client from the current CMake build\"");
    ...
    assert_contains(smoke, "\"provenance_digest\":\"fnv1a64:68ec9a2a032906f4\"");
    ...
    assert_contains(smoke, "\"expected_binary_provenance_digest\":\"fnv1a64:68ec9a2a032906f4\"");
    assert_contains(smoke, "\"check_digest\":\"fnv1a64:56b28a6190be9fe9\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:03afe1be1ce63765\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:3b406aed990b25d6\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:49eb9963647aecbe\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:27c7a66594fe5792\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:b46fadc02bfd129a\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:35fe7b1c42714d89\"");
    ...
    assert_contains(smoke, "\"current_artifact_path_hint\":\"c/99/\"");
    assert_contains(smoke, "\"adapter_target\":\"sandbox managed audit adapter dry-run\"");
    assert_contains(smoke, "\"runtime_role\":\"runtime evidence provider only\"");
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:e718f4de6ca49014\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:0d5212cff01975af\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:1f09161efd809c33\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.99.0\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.99.0\"");
