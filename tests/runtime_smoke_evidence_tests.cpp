...
int main() {
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.101.0\"");
    ...
    assert_contains(smoke, "SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v101 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5");
    assert_contains(smoke, "SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:6b0e9514847a3e7a and production_binary_claimed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:ef2742262316a25a and managed_audit_write_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_replay_marker.marker_digest=fnv1a64:3dcfdb4fc3986949 and replay_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.receipt_digest=fnv1a64:03cb419f2029035e and adapter_write_allowed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest=fnv1a64:e0e0fb3648c2286e and managed_audit_store=false");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_external_adapter_non_participation_receipt.receipt_digest=fnv1a64:a206a5701755d819");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest=fnv1a64:eea9770f26d0bade");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_connection_receipt_echo_marker.marker_digest=fnv1a64:259cb68de0117847");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_connection_no_start_guard_receipt.receipt_digest=fnv1a64:f5c9fa97c073ba43");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_no_start_guard_receipt.current_artifact_path_hint equals c/101/");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_no_start_guard_receipt.receipt_digest equals fnv1a64:f5c9fa97c073ba43");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_receipt_echo_marker.marker_digest equals fnv1a64:259cb68de0117847");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.current_artifact_path_hint equals c/101/");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest equals fnv1a64:eea9770f26d0bade");
    ...
    assert_contains(smoke, "managed_audit_external_adapter_non_participation_receipt.receipt_digest equals fnv1a64:a206a5701755d819");
    assert_contains(smoke, "adapter_shell_non_storage_guard_receipt.receipt_digest equals fnv1a64:5655496384119854");
    assert_contains(smoke, "command_dispatch_quality_receipt.receipt_digest equals fnv1a64:afdbb858cd603ace");
    assert_contains(smoke, "binary_provenance.provenance_digest equals fnv1a64:6b0e9514847a3e7a");
    ...
    assert_contains(smoke, "retention_provenance_check.check_digest equals fnv1a64:ef2742262316a25a");
    assert_contains(smoke, "retention_provenance_replay_marker.current_artifact_path_hint equals c/101/");
    assert_contains(smoke, "retention_provenance_replay_marker.marker_digest equals fnv1a64:3dcfdb4fc3986949");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.current_artifact_path_hint equals c/101/");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.receipt_digest equals fnv1a64:03cb419f2029035e");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.current_artifact_path_hint equals c/101/");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest equals fnv1a64:e0e0fb3648c2286e");
    assert_contains(smoke, "live_read_session.session_id_echo equals mini-kv-live-read-v101");
    ...
    assert_contains(smoke, "\"session_id_echo\":\"mini-kv-live-read-v101\"");
    ...
    assert_contains(smoke, "\"source_version\":\"0.101.0\"");
    assert_contains(smoke, "\"artifact_path_hint\":\"c/101/\"");
    assert_contains(smoke, "\"runtime_binary_hint\":\"cmake-build-v101/minikv_server and cmake-build-v101/minikv_client from the current CMake build\"");
    ...
    assert_contains(smoke, "\"provenance_digest\":\"fnv1a64:6b0e9514847a3e7a\"");
    ...
    assert_contains(smoke, "\"expected_binary_provenance_digest\":\"fnv1a64:6b0e9514847a3e7a\"");
    assert_contains(smoke, "\"check_digest\":\"fnv1a64:ef2742262316a25a\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:3dcfdb4fc3986949\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:03cb419f2029035e\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:e0e0fb3648c2286e\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:afdbb858cd603ace\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:5655496384119854\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:a206a5701755d819\"");
    ...
    assert_contains(smoke, "\"current_artifact_path_hint\":\"c/101/\"");
    assert_contains(smoke, "\"adapter_target\":\"sandbox managed audit adapter dry-run\"");
    assert_contains(smoke, "\"runtime_role\":\"runtime evidence provider only\"");
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:eea9770f26d0bade\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:259cb68de0117847\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:f5c9fa97c073ba43\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.101.0\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.101.0\"");
