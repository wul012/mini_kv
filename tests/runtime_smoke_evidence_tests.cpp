...
int main() {
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.100.0\"");
    ...
    assert_contains(smoke, "SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v100 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5");
    assert_contains(smoke, "SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:4b6d333035bfbba0 and production_binary_claimed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:5cd74c21104d0f66 and managed_audit_write_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_replay_marker.marker_digest=fnv1a64:298a3e48980ac14b and replay_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.receipt_digest=fnv1a64:5a82e59db74b0264 and adapter_write_allowed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest=fnv1a64:46a0b24772686044 and managed_audit_store=false");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_external_adapter_non_participation_receipt.receipt_digest=fnv1a64:ad3c0d907eab57b3");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest=fnv1a64:3a5d3e7f4a3092f6");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_connection_receipt_echo_marker.marker_digest=fnv1a64:a5ea80910cb99931");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_connection_no_start_guard_receipt.receipt_digest=fnv1a64:5530a3cc527cd8eb");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_no_start_guard_receipt.current_artifact_path_hint equals c/100/");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_no_start_guard_receipt.receipt_digest equals fnv1a64:5530a3cc527cd8eb");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_receipt_echo_marker.marker_digest equals fnv1a64:a5ea80910cb99931");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.current_artifact_path_hint equals c/100/");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest equals fnv1a64:3a5d3e7f4a3092f6");
    ...
    assert_contains(smoke, "managed_audit_external_adapter_non_participation_receipt.receipt_digest equals fnv1a64:ad3c0d907eab57b3");
    assert_contains(smoke, "adapter_shell_non_storage_guard_receipt.receipt_digest equals fnv1a64:d2d6ed618d06c1ec");
    assert_contains(smoke, "command_dispatch_quality_receipt.receipt_digest equals fnv1a64:e44f8fb484b931b0");
    assert_contains(smoke, "binary_provenance.provenance_digest equals fnv1a64:4b6d333035bfbba0");
    ...
    assert_contains(smoke, "retention_provenance_check.check_digest equals fnv1a64:5cd74c21104d0f66");
    assert_contains(smoke, "retention_provenance_replay_marker.current_artifact_path_hint equals c/100/");
    assert_contains(smoke, "retention_provenance_replay_marker.marker_digest equals fnv1a64:298a3e48980ac14b");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.current_artifact_path_hint equals c/100/");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.receipt_digest equals fnv1a64:5a82e59db74b0264");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.current_artifact_path_hint equals c/100/");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest equals fnv1a64:46a0b24772686044");
    assert_contains(smoke, "live_read_session.session_id_echo equals mini-kv-live-read-v100");
    ...
    assert_contains(smoke, "\"session_id_echo\":\"mini-kv-live-read-v100\"");
    ...
    assert_contains(smoke, "\"source_version\":\"0.100.0\"");
    assert_contains(smoke, "\"artifact_path_hint\":\"c/100/\"");
    assert_contains(smoke, "\"runtime_binary_hint\":\"cmake-build-v100/minikv_server and cmake-build-v100/minikv_client from the current CMake build\"");
    ...
    assert_contains(smoke, "\"provenance_digest\":\"fnv1a64:4b6d333035bfbba0\"");
    ...
    assert_contains(smoke, "\"expected_binary_provenance_digest\":\"fnv1a64:4b6d333035bfbba0\"");
    assert_contains(smoke, "\"check_digest\":\"fnv1a64:5cd74c21104d0f66\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:298a3e48980ac14b\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:5a82e59db74b0264\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:46a0b24772686044\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:e44f8fb484b931b0\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:d2d6ed618d06c1ec\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:ad3c0d907eab57b3\"");
    ...
    assert_contains(smoke, "\"current_artifact_path_hint\":\"c/100/\"");
    assert_contains(smoke, "\"adapter_target\":\"sandbox managed audit adapter dry-run\"");
    assert_contains(smoke, "\"runtime_role\":\"runtime evidence provider only\"");
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:3a5d3e7f4a3092f6\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:a5ea80910cb99931\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:5530a3cc527cd8eb\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.100.0\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.100.0\"");
