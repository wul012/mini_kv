...
int main() {
    ...
    assert_contains(smoke, "\"runtime_smoke_evidence_version\":\"mini-kv-runtime-smoke-evidence.v8\"");
    assert_contains(smoke, "\"project\":\"mini-kv\"");
    assert_contains(smoke, "\"project_version\":\"0.83.0\"");
    assert_contains(smoke, "\"release_version\":\"v83\"");
    ...
    assert_contains(smoke, "\"consumer_hint\":\"Node v208 managed audit persistence boundary candidate\"");
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.83.0\"");
    ...
    assert_contains(smoke, "SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v83 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5");
    assert_contains(smoke, "SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:c1c0896fc6b77fe2 and production_binary_claimed=false");

    assert_contains(smoke, "\"server\":\"minikv_server 6421 127.0.0.1\"");
    assert_contains(smoke, "\"client\":\"minikv_client 127.0.0.1 6421 5000 --connect-retries 10 --retry-delay-ms 100\"");
    assert_contains(smoke, "\"commands\":[\"SMOKEJSON\",\"INFOJSON\",\"STORAGEJSON\",\"HEALTH\",\"GET restore:real-read-token\",\"QUIT\"]");

    assert_contains(smoke, "\"target_version\":\"Node v208\"");
    assert_contains(smoke, "\"mode\":\"managed audit persistence boundary candidate\"");
    ...
    assert_contains(smoke, "\"node_must_verify\":\"binary_provenance.provenance_digest equals fnv1a64:c1c0896fc6b77fe2");
    assert_contains(smoke, "binary_provenance.artifact_path_hint equals c/83/");
    ...
    assert_contains(smoke, "live_read_session.session_id_echo equals mini-kv-live-read-v83");
    ...
    assert_contains(smoke, "\"session_id_echo\":\"mini-kv-live-read-v83\"");
    ...
    assert_contains(smoke, "\"source_version\":\"0.83.0\"");
    assert_contains(smoke, "\"artifact_path_hint\":\"c/83/\"");
    assert_contains(smoke, "\"runtime_binary_hint\":\"cmake-build-v83/minikv_server and cmake-build-v83/minikv_client from the current CMake build\"");
    ...
    assert_contains(smoke, "\"provenance_digest\":\"fnv1a64:c1c0896fc6b77fe2\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.83.0\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.83.0\"");
    ...
    assert_contains(result.response, "\"notes\":[\"runtime_smoke_evidence\",\"live_read_session_hint\",\"binary_provenance_hint\",\"read_only_aggregate\",\"not_order_authoritative\","
