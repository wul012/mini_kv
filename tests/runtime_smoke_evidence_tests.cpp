...
int main() {
    ...
    assert_contains(smoke, "\"runtime_smoke_evidence_version\":\"mini-kv-runtime-smoke-evidence.v1\"");
    assert_contains(smoke, "\"project\":\"mini-kv\"");
    assert_contains(smoke, "\"project_version\":\"0.76.0\"");
    assert_contains(smoke, "\"release_version\":\"v76\"");
    ...
    assert_contains(smoke, "\"consumer_hint\":\"Node v191 real HTTP/TCP read adapter rehearsal\"");
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.76.0\"");
    ...
    assert_contains(smoke, "\"target_version\":\"Node v191\"");
    ...
    assert_contains(result.response, "\"node_consumption\":\"Node v191 may read this command only when mini-kv is already running\"");
