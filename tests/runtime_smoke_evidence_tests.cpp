...
int main() {
    ...
    assert_contains(smoke, "\"runtime_smoke_evidence_version\":\"mini-kv-runtime-smoke-evidence.v14\"");
    assert_contains(smoke, "\"project\":\"mini-kv\"");
    assert_contains(smoke, "\"project_version\":\"0.98.0\"");
    assert_contains(smoke, "\"release_version\":\"v98\"");
    ...
    assert_contains(smoke, "\"consumer_hint\":\"Node v233 manual sandbox connection rehearsal packet review\"");
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.98.0\"");
    ...
    assert_contains(smoke, "SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v98 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5");
    assert_contains(smoke, "SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:4be577ac4f8347c6 and production_binary_claimed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:3397146bc78ee26f and managed_audit_write_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_replay_marker.marker_digest=fnv1a64:f8c7f073fdddb289 and replay_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.receipt_digest=fnv1a64:f006b4f4299a99ce and adapter_write_allowed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest=fnv1a64:e6ffb387b375879e and managed_audit_store=false");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_external_adapter_non_participation_receipt.receipt_digest=fnv1a64:36b65e9c69f03b49");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest=fnv1a64:9e89d248ca215706");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_connection_receipt_echo_marker.marker_digest=fnv1a64:c88b0bf6b974ac6b");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_connection_no_start_guard_receipt.receipt_digest=fnv1a64:431780d3772a52a5");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_no_start_guard_receipt.current_artifact_path_hint equals c/98/");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_no_start_guard_receipt.receipt_digest equals fnv1a64:431780d3772a52a5");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_receipt_echo_marker.marker_digest equals fnv1a64:c88b0bf6b974ac6b");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.current_artifact_path_hint equals c/98/");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest equals fnv1a64:9e89d248ca215706");
    ...
    assert_contains(smoke, "managed_audit_external_adapter_non_participation_receipt.receipt_digest equals fnv1a64:36b65e9c69f03b49");
    assert_contains(smoke, "adapter_shell_non_storage_guard_receipt.receipt_digest equals fnv1a64:7bce24ede1836a30");
    assert_contains(smoke, "command_dispatch_quality_receipt.receipt_digest equals fnv1a64:86f3d1ae4aaf7c62");
    assert_contains(smoke, "binary_provenance.provenance_digest equals fnv1a64:4be577ac4f8347c6");
    ...
    assert_contains(smoke, "retention_provenance_check.check_digest equals fnv1a64:3397146bc78ee26f");
    assert_contains(smoke, "retention_provenance_replay_marker.current_artifact_path_hint equals c/98/");
    assert_contains(smoke, "retention_provenance_replay_marker.marker_digest equals fnv1a64:f8c7f073fdddb289");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.current_artifact_path_hint equals c/98/");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.receipt_digest equals fnv1a64:f006b4f4299a99ce");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.current_artifact_path_hint equals c/98/");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest equals fnv1a64:e6ffb387b375879e");
    assert_contains(smoke, "live_read_session.session_id_echo equals mini-kv-live-read-v98");
    ...
    assert_contains(smoke, "\"session_id_echo\":\"mini-kv-live-read-v98\"");
    ...
    assert_contains(smoke, "\"source_version\":\"0.98.0\"");
    assert_contains(smoke, "\"artifact_path_hint\":\"c/98/\"");
    assert_contains(smoke, "\"runtime_binary_hint\":\"cmake-build-v98/minikv_server and cmake-build-v98/minikv_client from the current CMake build\"");
    ...
    assert_contains(smoke, "\"provenance_digest\":\"fnv1a64:4be577ac4f8347c6\"");
    ...
    assert_contains(smoke, "\"expected_binary_provenance_digest\":\"fnv1a64:4be577ac4f8347c6\"");
    assert_contains(smoke, "\"check_digest\":\"fnv1a64:3397146bc78ee26f\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:f8c7f073fdddb289\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:f006b4f4299a99ce\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:e6ffb387b375879e\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:86f3d1ae4aaf7c62\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:7bce24ede1836a30\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:36b65e9c69f03b49\"");
    ...
    assert_contains(smoke, "\"current_artifact_path_hint\":\"c/98/\"");
    assert_contains(smoke, "\"adapter_target\":\"sandbox managed audit adapter dry-run\"");
    assert_contains(smoke, "\"runtime_role\":\"runtime evidence provider only\"");
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:9e89d248ca215706\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:c88b0bf6b974ac6b\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:431780d3772a52a5\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.98.0\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.98.0\"");
