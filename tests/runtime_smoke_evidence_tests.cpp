...
int main() {
    ...
    assert_contains(smoke, "\"project_version\":\"0.96.0\"");
    assert_contains(smoke, "\"release_version\":\"v96\"");
    ...
    assert_contains(smoke, "\"consumer_hint\":\"Node v229 manual sandbox connection packet verification\"");
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.96.0\"");
    ...
    assert_contains(smoke, "SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v96 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5");
    assert_contains(smoke, "SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:c9da016a60b4a58e and production_binary_claimed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:e8df420be507be3e and managed_audit_write_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_replay_marker.marker_digest=fnv1a64:0e8a532e42d289d5 and replay_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_restore_boundary_receipt.receipt_digest=fnv1a64:ad1d4a1774dc38c2 and adapter_write_allowed=false");
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest=fnv1a64:23741de2828676be and managed_audit_store=false");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_external_adapter_non_participation_receipt.receipt_digest=fnv1a64:8c8339872e6dae25");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest=fnv1a64:e3693d38283c37e2");
    ...
    assert_contains(smoke, "SMOKEJSON exposes managed_audit_sandbox_connection_receipt_echo_marker.marker_digest=fnv1a64:b9fc556875ea625b");
    ...
    assert_contains(smoke, "\"target_version\":\"Node v229\"");
    assert_contains(smoke, "\"mode\":\"manual sandbox connection packet verification\"");
    ...
    assert_contains(smoke, "\"node_must_verify\":\"managed_audit_sandbox_connection_receipt_echo_marker.consumed_release_version equals v95");
    ...
    assert_contains(smoke, "managed_audit_sandbox_connection_receipt_echo_marker.marker_digest equals fnv1a64:b9fc556875ea625b");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.current_artifact_path_hint equals c/96/");
    ...
    assert_contains(smoke, "managed_audit_sandbox_adapter_non_participation_receipt.receipt_digest equals fnv1a64:e3693d38283c37e2");
    ...
    assert_contains(smoke, "managed_audit_external_adapter_non_participation_receipt.receipt_digest equals fnv1a64:8c8339872e6dae25");
    assert_contains(smoke, "adapter_shell_non_storage_guard_receipt.receipt_digest equals fnv1a64:6ebf3cc89a6a326c");
    assert_contains(smoke, "command_dispatch_quality_receipt.receipt_digest equals fnv1a64:e7bee76d3e9e4a56");
    assert_contains(smoke, "binary_provenance.provenance_digest equals fnv1a64:c9da016a60b4a58e");
    ...
    assert_contains(smoke, "retention_provenance_check.check_digest equals fnv1a64:e8df420be507be3e");
    assert_contains(smoke, "retention_provenance_replay_marker.current_artifact_path_hint equals c/96/");
    assert_contains(smoke, "retention_provenance_replay_marker.marker_digest equals fnv1a64:0e8a532e42d289d5");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.current_artifact_path_hint equals c/96/");
    assert_contains(smoke, "managed_audit_adapter_restore_boundary_receipt.receipt_digest equals fnv1a64:ad1d4a1774dc38c2");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.current_artifact_path_hint equals c/96/");
    assert_contains(smoke, "managed_audit_adapter_non_authoritative_storage_receipt.receipt_digest equals fnv1a64:23741de2828676be");
    assert_contains(smoke, "live_read_session.session_id_echo equals mini-kv-live-read-v96");
    ...
    assert_contains(smoke, "\"session_id_echo\":\"mini-kv-live-read-v96\"");
    ...
    assert_contains(smoke, "\"source_version\":\"0.96.0\"");
    assert_contains(smoke, "\"artifact_path_hint\":\"c/96/\"");
    assert_contains(smoke, "\"runtime_binary_hint\":\"cmake-build-v96/minikv_server and cmake-build-v96/minikv_client from the current CMake build\"");
    ...
    assert_contains(smoke, "\"provenance_digest\":\"fnv1a64:c9da016a60b4a58e\"");
    ...
    assert_contains(smoke, "\"expected_binary_provenance_digest\":\"fnv1a64:c9da016a60b4a58e\"");
    assert_contains(smoke, "\"check_digest\":\"fnv1a64:e8df420be507be3e\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:0e8a532e42d289d5\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:ad1d4a1774dc38c2\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:23741de2828676be\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:e7bee76d3e9e4a56\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:6ebf3cc89a6a326c\"");
    ...
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:8c8339872e6dae25\"");
    ...
    assert_contains(smoke, "\"current_artifact_path_hint\":\"c/96/\"");
    assert_contains(smoke, "\"adapter_target\":\"sandbox managed audit adapter dry-run\"");
    assert_contains(smoke, "\"runtime_role\":\"runtime evidence provider only\"");
    assert_contains(smoke, "\"receipt_digest\":\"fnv1a64:e3693d38283c37e2\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:b9fc556875ea625b\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.96.0\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.96.0\"");
