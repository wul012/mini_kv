...
int main() {
    ...
    assert_contains(smoke, "\"runtime_smoke_evidence_version\":\"mini-kv-runtime-smoke-evidence.v6\"");
    assert_contains(smoke, "\"project\":\"mini-kv\"");
    assert_contains(smoke, "\"project_version\":\"0.81.0\"");
    assert_contains(smoke, "\"release_version\":\"v81\"");
    ...
    assert_contains(smoke, "\"consumer_hint\":\"Node v203 cross-project CI artifact retention gate\"");
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.81.0\"");
    ...
    assert_contains(smoke, "\"server\":\"minikv_server 6419 127.0.0.1\"");
    assert_contains(smoke, "\"client\":\"minikv_client 127.0.0.1 6419 5000 --connect-retries 10 --retry-delay-ms 100\"");
    assert_contains(smoke, "\"commands\":[\"SMOKEJSON\",\"INFOJSON\",\"STORAGEJSON\",\"HEALTH\",\"GET restore:real-read-token\",\"QUIT\"]");

    assert_contains(smoke, "\"target_version\":\"Node v203\"");
    assert_contains(smoke, "\"mode\":\"cross-project CI artifact retention gate\"");
    ...
    assert_contains(smoke, "\"Node v203 must verify taxonomy_digest, operator_window.identity_neutral_proof, ci_evidence, and artifact_retention before the cross-project retention gate\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.81.0\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.81.0\"");
