...
int main() {
    ...
    assert_contains(smoke, "\"runtime_smoke_evidence_version\":\"mini-kv-runtime-smoke-evidence.v9\"");
    assert_contains(smoke, "\"project\":\"mini-kv\"");
    assert_contains(smoke, "\"project_version\":\"0.84.0\"");
    assert_contains(smoke, "\"release_version\":\"v84\"");
    ...
    assert_contains(smoke, "\"consumer_hint\":\"Node v211 managed audit identity approval provenance dry-run packet\"");
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.84.0\"");
    ...
    assert_contains(smoke, "SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v84 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5");
    assert_contains(smoke, "SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:c682f9c827129e40 and production_binary_claimed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:357cc7e9eec3f223 and managed_audit_write_executed=false");

    assert_contains(smoke, "\"server\":\"minikv_server 6422 127.0.0.1\"");
    assert_contains(smoke, "\"client\":\"minikv_client 127.0.0.1 6422 5000 --connect-retries 10 --retry-delay-ms 100\"");
    assert_contains(smoke, "\"commands\":[\"SMOKEJSON\",\"INFOJSON\",\"STORAGEJSON\",\"HEALTH\",\"GET restore:real-read-token\",\"QUIT\"]");

    assert_contains(smoke, "\"target_version\":\"Node v211\"");
    assert_contains(smoke, "\"mode\":\"managed audit identity approval provenance dry-run packet\"");
    ...
    assert_contains(smoke, "\"node_must_verify\":\"binary_provenance.provenance_digest equals fnv1a64:c682f9c827129e40");
    assert_contains(smoke, "binary_provenance.artifact_path_hint equals c/84/");
    ...
    assert_contains(smoke, "retention_provenance_check.expected_binary_provenance_digest equals fnv1a64:c682f9c827129e40");
    assert_contains(smoke, "retention_provenance_check.check_digest equals fnv1a64:357cc7e9eec3f223");
    assert_contains(smoke, "retention_provenance_check.managed_audit_write_executed is false");
    assert_contains(smoke, "live_read_session.session_id_echo equals mini-kv-live-read-v84");
    ...
    assert_contains(smoke, "\"session_id_echo\":\"mini-kv-live-read-v84\"");
    ...
    assert_contains(smoke, "\"source_version\":\"0.84.0\"");
    assert_contains(smoke, "\"artifact_path_hint\":\"c/84/\"");
    assert_contains(smoke, "\"runtime_binary_hint\":\"cmake-build-v84/minikv_server and cmake-build-v84/minikv_client from the current CMake build\"");
    ...
    assert_contains(smoke, "\"provenance_digest\":\"fnv1a64:c682f9c827129e40\"");
    ...
    assert_contains(smoke, "\"expected_binary_provenance_digest\":\"fnv1a64:c682f9c827129e40\"");
    assert_contains(smoke, "\"check_digest\":\"fnv1a64:357cc7e9eec3f223\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.84.0\"");
    ...
    assert_contains(result.response, "\"session_id_echo\":\"mini-kv-live-read-v84\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.84.0\"");
    ...
    assert_contains(result.response, "\"node_consumption\":\"Node v211 may verify runtime evidence retention, binary provenance digest alignment, live-read session echo, uptime bucket, read command digest, taxonomy digest, operator-window identity-neutral proof, CI evidence hints, and artifact retention evidence before managed audit identity approval provenance dry-run packet work; mini-kv must already be running and the read-only window must be open\"");
    assert_contains(result.response, "\"notes\":[\"runtime_smoke_evidence\",\"live_read_session_hint\",\"binary_provenance_hint\",\"retention_provenance_check\",\"read_only_aggregate\",\"not_order_authoritative\","
