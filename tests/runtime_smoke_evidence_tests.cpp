...
int main() {
    ...
    assert_contains(smoke, "\"project_version\":\"0.85.0\"");
    assert_contains(smoke, "\"release_version\":\"v85\"");
    ...
    assert_contains(smoke, "\"consumer_hint\":\"Node v213 managed audit packet restore drill plan\"");
    ...
    assert_contains(smoke, "\"SMOKEJSON version matches 0.85.0\"");
    ...
    assert_contains(smoke, "SMOKEJSON exposes live_read_session.session_id_echo=mini-kv-live-read-v85 and read_command_list_digest=fnv1a64:5bef33f2fbe65cc5");
    assert_contains(smoke, "SMOKEJSON exposes binary_provenance.provenance_digest=fnv1a64:384b81df32ac02e2 and production_binary_claimed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_check.check_digest=fnv1a64:d154e1434e5224da and managed_audit_write_executed=false");
    assert_contains(smoke, "SMOKEJSON exposes retention_provenance_replay_marker.marker_digest=fnv1a64:1ea4570c967cfdb1 and replay_executed=false");

    assert_contains(smoke, "\"server\":\"minikv_server 6423 127.0.0.1\"");
    assert_contains(smoke, "\"client\":\"minikv_client 127.0.0.1 6423 5000 --connect-retries 10 --retry-delay-ms 100\"");
    assert_contains(smoke, "\"commands\":[\"SMOKEJSON\",\"INFOJSON\",\"STORAGEJSON\",\"HEALTH\",\"GET restore:real-read-token\",\"QUIT\"]");

    assert_contains(smoke, "\"target_version\":\"Node v213\"");
    assert_contains(smoke, "\"mode\":\"managed audit packet restore drill plan\"");
    ...
    assert_contains(smoke, "\"node_must_verify\":\"binary_provenance.provenance_digest equals fnv1a64:384b81df32ac02e2");
    assert_contains(smoke, "binary_provenance.artifact_path_hint equals c/85/");
    ...
    assert_contains(smoke, "retention_provenance_check.expected_binary_provenance_digest equals fnv1a64:384b81df32ac02e2");
    assert_contains(smoke, "retention_provenance_check.check_digest equals fnv1a64:d154e1434e5224da");
    ...
    assert_contains(smoke, "retention_provenance_replay_marker.current_artifact_path_hint equals c/85/");
    assert_contains(smoke, "retention_provenance_replay_marker.marker_digest equals fnv1a64:1ea4570c967cfdb1");
    assert_contains(smoke, "retention_provenance_replay_marker.replay_executed is false");
    assert_contains(smoke, "live_read_session.session_id_echo equals mini-kv-live-read-v85");
    ...
    assert_contains(smoke, "\"session_id_echo\":\"mini-kv-live-read-v85\"");
    ...
    assert_contains(smoke, "\"source_version\":\"0.85.0\"");
    assert_contains(smoke, "\"artifact_path_hint\":\"c/85/\"");
    assert_contains(smoke, "\"runtime_binary_hint\":\"cmake-build-v85/minikv_server and cmake-build-v85/minikv_client from the current CMake build\"");
    ...
    assert_contains(smoke, "\"provenance_digest\":\"fnv1a64:384b81df32ac02e2\"");
    ...
    assert_contains(smoke, "\"expected_binary_provenance_digest\":\"fnv1a64:384b81df32ac02e2\"");
    assert_contains(smoke, "\"check_digest\":\"fnv1a64:d154e1434e5224da\"");
    ...
    assert_contains(smoke, "\"marker_digest\":\"fnv1a64:1ea4570c967cfdb1\"");
    ...
    assert_contains(smoke, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.85.0\"");
    ...
    assert_contains(result.response, "\"version\":\"0.85.0\"");
    ...
    assert_contains(result.response, "\"session_id_echo\":\"mini-kv-live-read-v85\"");
    ...
    assert_contains(result.response, "\"source_command\":\"SMOKEJSON\",\"source_version\":\"0.85.0\"");
