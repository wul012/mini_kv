...
int main() {
    ...
    assert(records.back().stage ==
           std::string{"route-preview-value-supply-signed-approval-capture-artifact-draft-text-package-compared-"
                       "package-evidence-intake-archive-closeout-final-guard-summary"});
