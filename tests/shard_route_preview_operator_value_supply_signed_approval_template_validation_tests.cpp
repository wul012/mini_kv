...
int main() {
    const std::string validation =
        minikv::shard_route_preview_operator_value_supply_signed_approval_template_validation::
            format_signed_approval_template_validation_json(25, 25, 25, 25);
    minikv::test_support::assert_contains(
        validation,
        "\"validationMode\":\"signed-approval-template-read-only-preflight-validation\"");
    minikv::test_support::assert_contains(validation, "\"fieldCount\":25");
    minikv::test_support::assert_contains(validation, "\"clauseCount\":25");
    minikv::test_support::assert_contains(validation, "\"reviewControlCount\":25");
    ...
    minikv::test_support::assert_contains(validation, "\"allFieldsHaveMissingBlockers\":true");
    minikv::test_support::assert_contains(validation, "\"allClausesHaveRejectionCodes\":true");
    minikv::test_support::assert_contains(validation, "\"allControlsBoundToSourceReviewPackage\":true");
    ...
    const std::string partial_validation =
        minikv::shard_route_preview_operator_value_supply_signed_approval_template_validation::
            format_signed_approval_template_validation_json(25, 25, 25, 1);
