...
int main() {
    namespace criteria =
        minikv::shard_route_preview_operator_value_supply_signed_approval_capture_artifact_draft_text_package_review_preflight_slots;
    ...
    const auto first = criteria::format_signed_approval_capture_artifact_draft_text_package_review_preflight_slots_json(1);
    ...
    const auto all = criteria::format_signed_approval_capture_artifact_draft_text_package_review_preflight_slots_json(99);
