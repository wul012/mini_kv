...
| K3 | v1615 advisory first; implementation next | not started | v1615 handles the post-K2 GitHub Actions Node 20 deprecation advisory before K3 logging starts |
| K4 | — | blocked on K3 and planner sequencing | |
| K5 | — | not started | |
| K6 | — | not started | |
