...
| Test architecture | zero-entry size baseline, command/shard manifests, shared fixtures, suite scanner | `test_architecture_contract` rejects assertion loss, missing calls, duplicate parts, any file above 1,000 nonblank lines and reintroduced baseline entries | command repaid in v1665; shard-readiness repaid and baseline cleared in v1666 |
