...
This index is the K5 retention ledger for the path-stable archive roots in this repository. It records the original v1620 baseline, the v1657 post-OSFS remeasurement, the v1658 track-review evidence closeout, the bounded v1659-v1662 elegance evidence, the selective v1663 OSFS teaching evidence, the v1664 README exhibit proof, the v1665-v1667 test/build-architecture proof, and the v1668-v1669 receipt-profile evidence.
...
| `f/` | 1597-1669 | 368 | 11,535,389 | 11.00 | 128 | ACTIVE ROOT; EXISTING VERSION DIRECTORIES FROZEN |

Latest measured version archive:

| Version archive | Files | Bytes | MiB | Budget MiB | State |
|---|---:|---:|---:|---:|---|
| `f/1669/` | 6 | 62,414 | 0.06 | 8 | within budget |

The table above is the direct output of `python scripts/archive_inventory.py` on 2026-07-20 after the six selective v1669 evidence files were written. The script emitted `warnings: none`; no historical path was moved or rewritten. Earlier inventories remain frozen in their own summaries. v1669 keeps four selected census/build-test/full-CTest/CLI screenshots, one explanation and one text summary; it does not retain build binaries, the raw 712-line CTest output or the 457,958-character SMOKEJSON object.
