# mini-kv v503 route preview archive maintenance verification

## Goal

v503 audits no active router. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v503 stage, the frozen source fixture, source v485 maintenance chain
