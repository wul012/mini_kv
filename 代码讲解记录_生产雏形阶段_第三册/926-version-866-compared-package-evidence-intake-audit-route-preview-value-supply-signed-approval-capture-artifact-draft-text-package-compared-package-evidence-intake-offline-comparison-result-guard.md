# mini-kv v866 compared package evidence intake audit

## Goal

v866 publishes compared package evidence intake audit stage 6 of 20: $stage. The version freezes v865 as `fixtures/release/shard-readiness-v865.json` before rolling current evidence to v866.
...
One-line value: v866 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.