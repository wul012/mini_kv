# mini-kv v601 route-preview-value-supply-envelope-no-automatic-sibling-import-audit
...
One sentence: v601 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.