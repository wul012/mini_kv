# mini-kv v496 route preview archive maintenance verification

## Goal

v496 records owned TCP smoke behavior. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v496 stage, the frozen source fixture, source v485 maintenance chain
