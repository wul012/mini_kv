# mini-kv v862 compared package evidence intake audit

## Goal

v862 publishes compared package evidence intake audit stage 2 of 20: $stage. The version freezes v861 as `fixtures/release/shard-readiness-v861.json` before rolling current evidence to v862.
...
One-line value: v862 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.