# mini-kv v727 value shape fragment
...
- Source fixture: fixtures/release/shard-readiness-v726.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-value-shape
...
One-line value: v727 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
