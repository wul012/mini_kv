# mini-kv v732 zero value import lock
...
- Source fixture: fixtures/release/shard-readiness-v731.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-zero-value-import
...
One-line value: v732 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
