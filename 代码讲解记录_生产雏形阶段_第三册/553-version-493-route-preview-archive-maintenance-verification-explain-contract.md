# mini-kv v493 route preview archive maintenance verification

## Goal

v493 pins EXPLAINJSON metadata-read semantics. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v493 stage, the frozen source fixture, source v485 maintenance chain
