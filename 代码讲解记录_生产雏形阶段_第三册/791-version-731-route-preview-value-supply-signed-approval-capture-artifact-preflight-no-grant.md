# mini-kv v731 no approval grant lock
...
- Source fixture: fixtures/release/shard-readiness-v730.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-no-grant
...
One-line value: v731 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
