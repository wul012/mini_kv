# mini-kv v486 route preview archive maintenance verification

## Goal

v486 starts the read-only maintenance verifier chain. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v486 stage, the frozen source fixture, source v485 maintenance chain
