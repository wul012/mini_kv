# mini-kv v608 route-preview-value-supply-envelope-no-execution-audit
...
One sentence: v608 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.