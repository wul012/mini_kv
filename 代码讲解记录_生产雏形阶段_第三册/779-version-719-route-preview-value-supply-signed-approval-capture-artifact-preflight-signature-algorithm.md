# mini-kv v719 signature algorithm fragment
...
- Source fixture: fixtures/release/shard-readiness-v718.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-signature-algorithm
...
One-line value: v719 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
