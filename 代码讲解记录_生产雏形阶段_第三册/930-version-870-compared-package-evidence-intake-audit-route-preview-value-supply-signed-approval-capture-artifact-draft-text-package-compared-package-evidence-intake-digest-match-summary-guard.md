# mini-kv v870 compared package evidence intake audit

## Goal

v870 publishes compared package evidence intake audit stage 10 of 20: $stage. The version freezes v869 as `fixtures/release/shard-readiness-v869.json` before rolling current evidence to v870.
...
One-line value: v870 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.