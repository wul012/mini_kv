# mini-kv v604 route-preview-value-supply-envelope-no-synthetic-evidence-audit
...
One sentence: v604 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.