# mini-kv v487 route preview archive maintenance verification

## Goal

v487 keeps stage chain continuity checks in a reusable helper. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v487 stage, the frozen source fixture, source v485 maintenance chain
