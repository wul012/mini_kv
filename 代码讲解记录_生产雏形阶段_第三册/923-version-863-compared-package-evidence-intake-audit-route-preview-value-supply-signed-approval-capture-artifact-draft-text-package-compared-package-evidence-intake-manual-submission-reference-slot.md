# mini-kv v863 compared package evidence intake audit

## Goal

v863 publishes compared package evidence intake audit stage 3 of 20: $stage. The version freezes v862 as `fixtures/release/shard-readiness-v862.json` before rolling current evidence to v863.
...
One-line value: v863 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.