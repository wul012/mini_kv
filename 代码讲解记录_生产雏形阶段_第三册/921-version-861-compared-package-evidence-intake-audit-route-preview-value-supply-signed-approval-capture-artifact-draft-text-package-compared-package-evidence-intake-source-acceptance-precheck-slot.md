# mini-kv v861 compared package evidence intake audit

## Goal

v861 publishes compared package evidence intake audit stage 1 of 20: $stage. The version freezes v860 as `fixtures/release/shard-readiness-v860.json` before rolling current evidence to v861.
...
One-line value: v861 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.