# mini-kv v609 route-preview-value-supply-envelope-release-readiness-audit
...
One sentence: v609 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.