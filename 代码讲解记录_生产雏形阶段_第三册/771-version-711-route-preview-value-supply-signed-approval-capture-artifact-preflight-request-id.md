# mini-kv v711 request id fragment
...
- Source fixture: fixtures/release/shard-readiness-v710.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-request-id
...
One-line value: v711 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
