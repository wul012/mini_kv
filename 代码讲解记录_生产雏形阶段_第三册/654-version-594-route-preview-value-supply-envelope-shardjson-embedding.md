# mini-kv v594 route-preview-value-supply-envelope-shardjson-embedding
...
One sentence: v594 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.