# mini-kv v498 route preview archive maintenance verification

## Goal

v498 audits single SHARDJSON verifier embedding. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v498 stage, the frozen source fixture, source v485 maintenance chain
