# mini-kv v488 route preview archive maintenance verification

## Goal

v488 pins the source maintenance ledger contract. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v488 stage, the frozen source fixture, source v485 maintenance chain
