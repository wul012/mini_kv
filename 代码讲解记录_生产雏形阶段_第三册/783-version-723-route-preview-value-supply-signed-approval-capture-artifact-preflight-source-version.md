# mini-kv v723 source evidence version fragment
...
- Source fixture: fixtures/release/shard-readiness-v722.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-source-version
...
One-line value: v723 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
