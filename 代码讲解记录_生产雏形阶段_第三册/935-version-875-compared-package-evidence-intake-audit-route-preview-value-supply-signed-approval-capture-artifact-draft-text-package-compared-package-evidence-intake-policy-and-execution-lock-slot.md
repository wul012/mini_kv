# mini-kv v875 compared package evidence intake audit

## Goal

v875 publishes compared package evidence intake audit stage 15 of 20: $stage. The version freezes v874 as `fixtures/release/shard-readiness-v874.json` before rolling current evidence to v875.
...
One-line value: v875 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.