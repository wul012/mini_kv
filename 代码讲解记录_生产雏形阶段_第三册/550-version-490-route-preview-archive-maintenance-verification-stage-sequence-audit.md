# mini-kv v490 route preview archive maintenance verification

## Goal

v490 audits verifier stage sequence continuity. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v490 stage, the frozen source fixture, source v485 maintenance chain
