# mini-kv v607 route-preview-value-supply-envelope-no-write-audit
...
One sentence: v607 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.