# mini-kv v586 route-preview-value-supply-envelope-policy-split
...
One sentence: v586 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.