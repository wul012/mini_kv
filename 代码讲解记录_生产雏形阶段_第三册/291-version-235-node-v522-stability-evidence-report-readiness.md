...
This version freezes v234 as fixtures/release/shard-readiness-v234.json and advances the rolling SHARDJSON fixture to v235. The source plan is Node v522, which closed the Java / mini-kv route catalog cleanup twenty-version run and left Java and mini-kv on a recommended-parallel path.
