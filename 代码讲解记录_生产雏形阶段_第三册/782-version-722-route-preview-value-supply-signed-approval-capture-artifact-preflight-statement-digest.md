# mini-kv v722 approval statement digest placeholder
...
- Source fixture: fixtures/release/shard-readiness-v721.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-statement-digest
...
One-line value: v722 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
