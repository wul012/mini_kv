# mini-kv v505 route preview archive maintenance verification

## Goal

v505 audits no restore, load, compact, route execution, or service start. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v505 stage, the frozen source fixture, source v485 maintenance chain
