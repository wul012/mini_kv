# mini-kv v566 route-preview-value-draft-command-catalog-contract

## Goal

v566 advances the read-only SHARDROUTEVALUEDRAFTJSON operator evidence value draft chain: pins command catalog metadata for the value draft command. It consumes the frozen v560 SHARDROUTEIMPORTPREFLIGHTJSON package as source evidence, not a live Node, Java, or mini-kv runtime.
...
v566 moves the operator evidence value draft one version forward while keeping real values, import, writes, routing, and execution outside mini-kv.
