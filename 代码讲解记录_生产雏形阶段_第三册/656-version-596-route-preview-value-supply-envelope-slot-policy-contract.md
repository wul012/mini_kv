# mini-kv v596 route-preview-value-supply-envelope-slot-policy-contract
...
One sentence: v596 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.