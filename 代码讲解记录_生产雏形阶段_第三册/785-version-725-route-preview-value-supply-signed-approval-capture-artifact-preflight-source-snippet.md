# mini-kv v725 source evidence snippet fragment
...
- Source fixture: fixtures/release/shard-readiness-v724.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-source-snippet
...
One-line value: v725 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
