# mini-kv v603 route-preview-value-supply-envelope-no-runtime-payload-audit
...
One sentence: v603 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.