# mini-kv v712 capture preflight digest binding
...
- Source fixture: fixtures/release/shard-readiness-v711.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-capture-digest
...
One-line value: v712 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
