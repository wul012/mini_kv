# mini-kv v506 route preview archive maintenance verification

## Goal

v506 records downstream consumer handoff semantics. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v506 stage, the frozen source fixture, source v485 maintenance chain
