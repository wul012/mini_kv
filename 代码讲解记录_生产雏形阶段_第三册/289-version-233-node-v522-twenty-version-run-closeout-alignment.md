...
This version freezes v232 as fixtures/release/shard-readiness-v232.json and advances the rolling SHARDJSON fixture to v233. The source plan is Node v522, which closed the Java / mini-kv route catalog cleanup twenty-version run and left Java and mini-kv on a recommended-parallel path.
