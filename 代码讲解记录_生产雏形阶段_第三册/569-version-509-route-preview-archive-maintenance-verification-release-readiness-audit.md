# mini-kv v509 route preview archive maintenance verification

## Goal

v509 audits release readiness. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v509 stage, the frozen source fixture, source v485 maintenance chain
