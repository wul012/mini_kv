# mini-kv v495 route preview archive maintenance verification

## Goal

v495 records CLI smoke behavior. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v495 stage, the frozen source fixture, source v485 maintenance chain
