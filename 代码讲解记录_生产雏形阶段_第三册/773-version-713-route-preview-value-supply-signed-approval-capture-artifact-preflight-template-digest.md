# mini-kv v713 template digest binding
...
- Source fixture: fixtures/release/shard-readiness-v712.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-template-digest
...
One-line value: v713 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
