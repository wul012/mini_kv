# mini-kv v726 redacted value digest fragment
...
- Source fixture: fixtures/release/shard-readiness-v725.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-redacted-value-digest
...
One-line value: v726 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
