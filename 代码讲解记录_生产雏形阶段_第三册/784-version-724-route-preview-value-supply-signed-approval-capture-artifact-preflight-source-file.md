# mini-kv v724 source evidence file fragment
...
- Source fixture: fixtures/release/shard-readiness-v723.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-source-file
...
One-line value: v724 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
