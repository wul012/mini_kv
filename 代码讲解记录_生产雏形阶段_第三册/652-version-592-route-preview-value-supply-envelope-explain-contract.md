# mini-kv v592 route-preview-value-supply-envelope-explain-contract
...
One sentence: v592 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.