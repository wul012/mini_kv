# mini-kv v730 no raw secret lock
...
- Source fixture: fixtures/release/shard-readiness-v729.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-no-raw-secret
...
One-line value: v730 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
