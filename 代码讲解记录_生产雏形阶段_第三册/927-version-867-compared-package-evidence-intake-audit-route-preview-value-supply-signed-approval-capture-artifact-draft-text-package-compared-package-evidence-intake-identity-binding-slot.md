# mini-kv v867 compared package evidence intake audit

## Goal

v867 publishes compared package evidence intake audit stage 7 of 20: $stage. The version freezes v866 as `fixtures/release/shard-readiness-v866.json` before rolling current evidence to v867.
...
One-line value: v867 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.