# mini-kv v599 route-preview-value-supply-envelope-missing-value-policy
...
One sentence: v599 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.