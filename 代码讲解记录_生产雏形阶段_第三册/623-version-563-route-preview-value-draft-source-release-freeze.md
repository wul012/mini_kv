# mini-kv v563 route-preview-value-draft-source-release-freeze

## Goal

v563 advances the read-only SHARDROUTEVALUEDRAFTJSON operator evidence value draft chain: freezes the prior value draft fixture before rolling current evidence. It consumes the frozen v560 SHARDROUTEIMPORTPREFLIGHTJSON package as source evidence, not a live Node, Java, or mini-kv runtime.
...
v563 moves the operator evidence value draft one version forward while keeping real values, import, writes, routing, and execution outside mini-kv.
