# mini-kv v598 route-preview-value-supply-envelope-redaction-policy
...
One sentence: v598 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.