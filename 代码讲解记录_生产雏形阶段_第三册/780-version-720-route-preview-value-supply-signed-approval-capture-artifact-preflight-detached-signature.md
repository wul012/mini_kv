# mini-kv v720 detached signature placeholder
...
- Source fixture: fixtures/release/shard-readiness-v719.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-detached-signature
...
One-line value: v720 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
