# mini-kv v504 route preview archive maintenance verification

## Goal

v504 audits no write routing and no WAL touch. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v504 stage, the frozen source fixture, source v485 maintenance chain
