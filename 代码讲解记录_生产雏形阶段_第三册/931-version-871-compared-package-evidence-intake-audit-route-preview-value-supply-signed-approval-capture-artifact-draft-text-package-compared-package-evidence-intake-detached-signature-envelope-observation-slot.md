# mini-kv v871 compared package evidence intake audit

## Goal

v871 publishes compared package evidence intake audit stage 11 of 20: $stage. The version freezes v870 as `fixtures/release/shard-readiness-v870.json` before rolling current evidence to v871.
...
One-line value: v871 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.