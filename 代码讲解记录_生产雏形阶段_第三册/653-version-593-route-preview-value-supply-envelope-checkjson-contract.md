# mini-kv v593 route-preview-value-supply-envelope-checkjson-contract
...
One sentence: v593 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.