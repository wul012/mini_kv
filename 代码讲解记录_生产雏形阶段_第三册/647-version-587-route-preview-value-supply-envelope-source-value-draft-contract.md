# mini-kv v587 route-preview-value-supply-envelope-source-value-draft-contract
...
One sentence: v587 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.