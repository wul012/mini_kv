# mini-kv v492 route preview archive maintenance verification

## Goal

v492 pins command catalog metadata. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v492 stage, the frozen source fixture, source v485 maintenance chain
