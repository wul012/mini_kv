# mini-kv v605 route-preview-value-supply-envelope-no-secret-storage-audit
...
One sentence: v605 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.