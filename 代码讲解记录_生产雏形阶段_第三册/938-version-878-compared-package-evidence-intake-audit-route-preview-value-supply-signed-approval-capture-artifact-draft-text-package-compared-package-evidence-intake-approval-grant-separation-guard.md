# mini-kv v878 compared package evidence intake audit

## Goal

v878 publishes compared package evidence intake audit stage 18 of 20: $stage. The version freezes v877 as `fixtures/release/shard-readiness-v877.json` before rolling current evidence to v878.
...
One-line value: v878 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.