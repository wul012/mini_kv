# mini-kv v510 route preview archive maintenance verification

## Goal

v510 packages final verifier evidence. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v510 stage, the frozen source fixture, source v485 maintenance chain
