# mini-kv v717 capture window id fragment
...
- Source fixture: fixtures/release/shard-readiness-v716.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-window-id
...
One-line value: v717 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
