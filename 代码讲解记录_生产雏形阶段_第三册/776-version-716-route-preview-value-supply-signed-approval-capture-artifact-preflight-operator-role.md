# mini-kv v716 operator role fragment
...
- Source fixture: fixtures/release/shard-readiness-v715.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-operator-role
...
One-line value: v716 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
