# mini-kv v508 route preview archive maintenance verification

## Goal

v508 prepares release packaging. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v508 stage, the frozen source fixture, source v485 maintenance chain
