# mini-kv v501 route preview archive maintenance verification

## Goal

v501 indexes walkthrough coverage. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v501 stage, the frozen source fixture, source v485 maintenance chain
