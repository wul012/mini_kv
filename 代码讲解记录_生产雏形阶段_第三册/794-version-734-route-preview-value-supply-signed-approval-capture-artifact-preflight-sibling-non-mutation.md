# mini-kv v734 sibling non-mutation lock
...
- Source fixture: fixtures/release/shard-readiness-v733.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-sibling-non-mutation
...
One-line value: v734 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
