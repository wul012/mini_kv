# mini-kv v507 route preview archive maintenance verification

## Goal

v507 records Java echo boundary semantics. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v507 stage, the frozen source fixture, source v485 maintenance chain
