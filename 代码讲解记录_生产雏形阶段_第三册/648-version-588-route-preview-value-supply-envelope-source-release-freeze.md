# mini-kv v588 route-preview-value-supply-envelope-source-release-freeze
...
One sentence: v588 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.