# mini-kv v602 route-preview-value-supply-envelope-no-manual-entry-audit
...
One sentence: v602 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.