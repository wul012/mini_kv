# mini-kv v500 route preview archive maintenance verification

## Goal

v500 audits retained evidence metadata. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v500 stage, the frozen source fixture, source v485 maintenance chain
