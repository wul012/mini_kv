# mini-kv v591 route-preview-value-supply-envelope-command-catalog-contract
...
One sentence: v591 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.