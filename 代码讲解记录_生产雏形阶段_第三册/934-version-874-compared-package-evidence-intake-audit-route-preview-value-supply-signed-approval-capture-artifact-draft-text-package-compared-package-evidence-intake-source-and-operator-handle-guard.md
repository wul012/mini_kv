# mini-kv v874 compared package evidence intake audit

## Goal

v874 publishes compared package evidence intake audit stage 14 of 20: $stage. The version freezes v873 as `fixtures/release/shard-readiness-v873.json` before rolling current evidence to v874.
...
One-line value: v874 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.