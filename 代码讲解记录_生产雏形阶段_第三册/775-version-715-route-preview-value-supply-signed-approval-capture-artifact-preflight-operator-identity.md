# mini-kv v715 operator identity fragment
...
- Source fixture: fixtures/release/shard-readiness-v714.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-operator-identity
...
One-line value: v715 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
