# mini-kv v714 review digest binding
...
- Source fixture: fixtures/release/shard-readiness-v713.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-review-digest
...
One-line value: v714 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
