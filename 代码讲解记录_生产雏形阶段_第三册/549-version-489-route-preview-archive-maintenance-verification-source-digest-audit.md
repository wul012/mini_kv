# mini-kv v489 route preview archive maintenance verification

## Goal

v489 audits the source maintenance digest marker. The version stays in the C++ mini-kv evidence plane and does not create a router, run a
...
The focused verifier test checks the exact v489 stage, the frozen source fixture, source v485 maintenance chain
