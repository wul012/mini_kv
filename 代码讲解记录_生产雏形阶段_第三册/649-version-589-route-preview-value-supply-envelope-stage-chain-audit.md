# mini-kv v589 route-preview-value-supply-envelope-stage-chain-audit
...
One sentence: v589 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.