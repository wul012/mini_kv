# mini-kv v873 compared package evidence intake audit

## Goal

v873 publishes compared package evidence intake audit stage 13 of 20: $stage. The version freezes v872 as `fixtures/release/shard-readiness-v872.json` before rolling current evidence to v873.
...
One-line value: v873 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.