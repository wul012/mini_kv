# mini-kv v610 route-preview-value-supply-envelope-release-package
...
One sentence: v610 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.