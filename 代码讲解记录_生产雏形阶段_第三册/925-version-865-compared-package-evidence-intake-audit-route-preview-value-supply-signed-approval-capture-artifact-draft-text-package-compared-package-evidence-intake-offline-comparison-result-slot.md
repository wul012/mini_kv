# mini-kv v865 compared package evidence intake audit

## Goal

v865 publishes compared package evidence intake audit stage 5 of 20: $stage. The version freezes v864 as `fixtures/release/shard-readiness-v864.json` before rolling current evidence to v865.
...
One-line value: v865 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.