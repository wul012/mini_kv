# mini-kv v872 compared package evidence intake audit

## Goal

v872 publishes compared package evidence intake audit stage 12 of 20: $stage. The version freezes v871 as `fixtures/release/shard-readiness-v871.json` before rolling current evidence to v872.
...
One-line value: v872 turns the future compared-package intake surface into versioned read-only evidence without making mini-kv an acceptance authority.