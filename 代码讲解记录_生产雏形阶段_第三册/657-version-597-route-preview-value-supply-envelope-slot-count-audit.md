# mini-kv v597 route-preview-value-supply-envelope-slot-count-audit
...
One sentence: v597 gives Node and Java a readable disabled value-supply policy layer while mini-kv remains a read-only evidence producer with no authority to import, write, route, or execute.