# mini-kv v721 signature redaction policy
...
- Source fixture: fixtures/release/shard-readiness-v720.json
- Stage: route-preview-value-supply-signed-approval-capture-artifact-preflight-signature-redaction
...
One-line value: v721 moves the artifact preflight chain forward while keeping Node, Java, and mini-kv loosely coupled through versioned, read-only evidence.
