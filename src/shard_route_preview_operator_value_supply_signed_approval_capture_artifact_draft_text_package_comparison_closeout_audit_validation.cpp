...
namespace minikv::shard_route_preview_operator_value_supply_signed_approval_capture_artifact_draft_text_package_comparison_closeout_audit_validation {
namespace {
...
std::string format_signed_approval_capture_artifact_draft_text_package_comparison_closeout_audit_validation_json(
    int check_count,
    int blocker_count,
    int profile_count,
    bool source_review_closeout_audit_chain_complete,
    ...
    const bool validation_passed = catalogs_aligned && published_checks_guarded && source_review_closeout_audit_chain_complete;

    return "{\"draftTextPackageComparisonCloseoutAuditValidationPassed\":" + json_bool(validation_passed) +
           ",\"sourceReviewCloseoutAuditChainComplete\":" + json_bool(source_review_closeout_audit_chain_complete) +
           ",\"comparisonCatalogsAligned\":" + json_bool(catalogs_aligned) +
