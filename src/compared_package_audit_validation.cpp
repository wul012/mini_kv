...
format_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_validation_json(
    int planned_slot_count, int planned_guard_count, int completed_slot_count, int completed_guard_count,
    bool source_comparison_closeout_audit_chain_complete, int published_stage_count) {
    ...
    const bool validation_passed = source_comparison_closeout_audit_chain_complete && planned_catalogs_aligned &&
                                   completed_catalogs_aligned && stage_count_valid;

    return "{\"comparedPackageEvidenceIntakeAuditValidationPassed\":" + runtime_evidence::json_bool(validation_passed) +
  ...
  // minikv::shard_route_preview_operator_value_supply_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_validation