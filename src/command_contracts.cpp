...
constexpr CommandCatalogEntry command_catalog[] = {
    ...
    {"SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTTEXTPACKAGECOMPAREDPACKAGEEVIDENCEINTAKEAUDITJSON",
     ...
     false,
     true,
     "Read route preview operator value-supply signed approval artifact draft text package compared package evidence intake audit without parsing packages or enabling execution"},    {"COMMANDS", "meta", false, false, true, "Read command catalog as text"},
