...
constexpr CommandCatalogEntry command_catalog[] = {
    ...
    {"SHARDROUTECANDIDATEINTAKEPACKETJSON",
     ...
     false,
     true,
     "Read route preview candidate intake packet handoff evidence without opening document intake"},
    {"SHARDROUTECANDIDATEMATERIALREQUESTJSON",
     "read",
     false,
     false,
     true,
     "Read route preview candidate material request closeout evidence without reading or accepting documents"},
    ...
    {"SHARDROUTECANDIDATEPROFILESECTIONJSON",
     ...
     false,
     true,
     "Read route preview candidate document profile section renderer split evidence without starting services"},
    {"SHARDROUTEVALUESUPPLYSIGNEDAPPROVALCAPTUREARTIFACTDRAFTPROFILESECTIONJSON",
     "read",
     false,
     false,
     true,
     "Read route preview signed approval artifact draft profile section renderer split evidence without starting services"},
