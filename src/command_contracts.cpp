...
constexpr CommandCatalogEntry command_catalog[] = {
    ...
    {"SHARDROUTEVERIFYREPORTARCHIVECLOSEOUTVERIFYJSON",
     ...
     false,
     true,
     "Read route preview verification report archive closeout verification evidence without enabling active routing"},    {"SHARDROUTEVERIFYREPORTARCHIVECLOSEOUTVERIFYAUDITJSON",
     "read",
     false,
     false,
     true,
