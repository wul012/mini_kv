...
constexpr std::string_view release_version = "v526";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-worksheet-verification-production-execution-blocked-read-only\"" +
