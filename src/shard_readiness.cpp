...
constexpr std::string_view release_version = "v653";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-approval-template-no-automatic-import-audit-read-only\"" +
