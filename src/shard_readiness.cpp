...
constexpr std::string_view release_version = "v616";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-precheck-command-catalog-contract-read-only\"" +
