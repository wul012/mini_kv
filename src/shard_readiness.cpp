...
constexpr std::string_view release_version = "v207";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v207",
        {
            ...
            {"historicalFallback=v206-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v207-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v207-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v207-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v207-v206-archive-verification-route-checkpoint-no-execution"},
        });
}
