...
constexpr std::string_view release_version = "v630";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-precheck-no-secret-storage-audit-read-only\"" +
