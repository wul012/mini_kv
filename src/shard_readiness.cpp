...
constexpr std::string_view release_version = "v253";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v253",
        {
            ...
            {"historicalFallback=v252-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v253-v29-node-v549-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v253-v252-continuity-continuity-node-v549-latest-sibling-clean-quality-reminder-audit-no-execution"},
        });
}
