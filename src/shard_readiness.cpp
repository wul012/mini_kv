...
constexpr std::string_view release_version = "v1601";
...
std::string format_command_catalog_quality_json() {
    return "{\"releaseRangeStart\":\"v1546\",\"releaseRangeEnd\":\"v1601\","
...
std::string evidence_digest() {
    ...
    return runtime_evidence::digest(
        digest_prefix,
        {
            ...
            {"commandCatalogSingleSourceRefactor=v1546-v1601-no-runtime-behavior-change"},
            {"commandCatalogCount=92"},
            ...
            {"shardPreviewCandidateMaterialSubmissionPrecheck=" +
             shard_preview_candidate_material_submission_precheck::candidate_material_submission_precheck_digest_marker()},
            ...
            {"shardPreviewOperatorValueSupplyProfileSection=" +
             shard_preview_operator_value_supply_profile_section::operator_value_supply_profile_section_digest_marker()},
            ...
            {"shardPreviewTypeBarrelSplitNonParticipation=" +
             shard_preview_type_barrel_split_non_participation::
                 type_barrel_split_non_participation_digest_marker()},
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"evidencePath\":" + json_string(fixture_path()) +
            ...
            json_string(
                shard_preview_production_shard_execution_mini_kv_owner_receipt_bundle::
                    production_shard_execution_mini_kv_owner_receipt_bundle_status()) +
