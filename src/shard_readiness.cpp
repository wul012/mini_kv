...
constexpr std::string_view release_version = "v260";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v260",
        {
            ...
            {"historicalFallback=v259-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v260-v29-node-v549-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v260-v259-continuity-continuity-node-v549-final-closeout-package-no-execution"},
        });
}
