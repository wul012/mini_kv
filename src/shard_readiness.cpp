...
constexpr std::string_view release_version = "v206";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v206",
        {
            ...
            {"historicalFallback=v205-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v206-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v206-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v206-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v206-v205-verification-checklist-audit-no-execution"},
        });
}
