...
constexpr std::string_view release_version = "v212";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v212",
        {
            ...
            {"historicalFallback=v211-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v212-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v212-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v212-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v212-v211-continuity-release-catalog-retention-audit-no-execution"},
        });
}
