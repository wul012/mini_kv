...
constexpr std::string_view release_version = "v205";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v205",
        {
            ...
            {"historicalFallback=v204-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v205-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v205-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v205-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v205-v204-verification-checklist-handoff-no-execution"},
        });
}
