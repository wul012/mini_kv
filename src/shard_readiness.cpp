...
constexpr std::string_view release_version = "v221";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v221",
        {
            ...
            {"historicalFallback=v220-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v221-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v221-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v221-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v221-v220-continuity-node-v505-readiness-handoff-archive-verification-route-alignment-no-execution"},
        });
}
