...
constexpr std::string_view release_version = "v523";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-worksheet-verification-operator-slot-boundary-read-only\"" +
