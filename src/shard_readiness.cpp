...
constexpr std::string_view release_version = "v211";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v211",
        {
            ...
            {"historicalFallback=v210-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v211-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v211-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v211-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v211-v210-continuity-release-catalog-retention-no-execution"},
        });
}
