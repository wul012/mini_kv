...
constexpr std::string_view release_version = "v224";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v224",
        {
            ...
            {"historicalFallback=v223-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v224-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v224-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v224-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v224-v223-continuity-node-v505-readiness-handoff-archive-verification-route-package-audit-no-execution"},
        });
}
