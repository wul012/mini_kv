...
constexpr std::string_view release_version = "v255";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v255",
        {
            ...
            {"historicalFallback=v254-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v255-v29-node-v549-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v255-v254-continuity-continuity-node-v549-live-smoke-boundary-reconfirmation-audit-no-execution"},
        });
}
