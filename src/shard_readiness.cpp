...
constexpr std::string_view release_version = "v259";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v259",
        {
            ...
            {"historicalFallback=v258-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v259-v29-node-v549-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v259-v258-continuity-continuity-node-v549-node-v550-route-exposure-readiness-audit-no-execution"},
        });
}
