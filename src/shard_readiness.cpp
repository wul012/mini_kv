...
constexpr std::string_view release_version = "v621";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-precheck-slot-requirement-contract-read-only\"" +
