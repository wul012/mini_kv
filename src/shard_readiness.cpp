...
constexpr std::string_view release_version = "v516";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-worksheet-verification-command-catalog-contract-read-only\"" +
