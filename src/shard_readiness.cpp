...
constexpr std::string_view release_version = "v217";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v217",
        {
            ...
            {"historicalFallback=v216-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v217-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v217-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v217-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v217-v216-continuity-node-v498-consumer-readiness-handshake-package-no-execution"},
        });
}
