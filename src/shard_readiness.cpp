...
constexpr std::string_view release_version = "v204";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v204",
        {
            ...
            {"historicalFallback=v203-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v204-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v204-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v204-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v204-v203-archive-readiness-audit-no-execution"},
        });
}
