...
constexpr std::string_view release_version = "v649";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-approval-template-timestamp-field-policy-read-only\"" +
