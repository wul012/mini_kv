...
constexpr std::string_view release_version = "v659";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-approval-template-release-readiness-audit-read-only\"" +
