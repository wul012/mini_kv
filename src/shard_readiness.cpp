...
constexpr std::string_view release_version = "v550";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-import-preflight-operator-slot-draft-boundary-read-only\"" +
