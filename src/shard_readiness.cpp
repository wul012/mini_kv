...
constexpr std::string_view release_version = "v715";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-preflight-operator-identity-read-only\"" +
