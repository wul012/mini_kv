...
constexpr std::string_view release_version = "v233";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v233",
        {
            ...
            {"historicalFallback=v232-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v233-v29-node-v522-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v233-v232-continuity-continuity-node-v522-twenty-version-run-closeout-alignment-no-execution"},
        });
}
