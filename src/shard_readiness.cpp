...
constexpr std::string_view release_version = "v534";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-worksheet-verification-release-readiness-audit-read-only\"" +
