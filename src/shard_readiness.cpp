...
constexpr std::string_view release_version = "v202";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v202",
        {
            ...
            {"historicalFallback=v201-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v202-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v202-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v202-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v202-v201-source-freeze-audit-no-execution"},
        });
}
