...
constexpr std::string_view release_version = "v491";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-archive-maintenance-verification-fixture-chain-audit-read-only\"" +
