...
constexpr std::string_view release_version = "v634";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-precheck-release-readiness-audit-read-only\"" +
