...
constexpr std::string_view release_version = "v251";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v251",
        {
            ...
            {"historicalFallback=v250-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v251-v29-node-v549-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v251-v250-continuity-continuity-node-v549-archive-verification-route-readiness-audit-no-execution"},
        });
}
