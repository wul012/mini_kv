...
constexpr std::string_view release_version = "v674";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-signed-approval-template-missing-value-policy-read-only\"" +
