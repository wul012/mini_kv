...
constexpr std::string_view release_version = "v201";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v201",
        {
            ...
            {"historicalFallback=v200-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v201-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v201-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v201-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v201-v200-continuity-ledger-no-execution"},
        });
}
