...
constexpr std::string_view release_version = "v604";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"evidencePath\":" + json_string(fixture_path()) +
                                                                                                                                                                                                                                       ",\"status\":\"route-preview-value-supply-envelope-no-synthetic-evidence-audit-read-only\"" +
