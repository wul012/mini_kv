...
constexpr std::string_view release_version = "v210";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v210",
        {
            ...
            {"historicalFallback=v209-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v210-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v210-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v210-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v210-v209-continuity-release-catalog-audit-no-execution"},
        });
}
