...
constexpr std::string_view release_version = "v252";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v252",
        {
            ...
            {"historicalFallback=v251-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v252-v29-node-v549-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v252-v251-continuity-continuity-node-v549-latest-sibling-clean-quality-reminder-no-execution"},
        });
}
