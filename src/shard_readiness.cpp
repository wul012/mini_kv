...
constexpr std::string_view release_version = "v636";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-approval-template-field-catalog-split-read-only\"" +
