...
constexpr std::string_view release_version = "v718";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-signed-approval-capture-artifact-preflight-channel-policy-read-only\"" +
