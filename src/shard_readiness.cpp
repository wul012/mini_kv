...
constexpr std::string_view release_version = "v247";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v247",
        {
            ...
            {"historicalFallback=v246-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v247-v29-node-v522-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v247-v246-continuity-continuity-node-v522-final-verification-route-readiness-no-execution"},
        });
}
