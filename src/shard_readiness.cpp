...
constexpr std::string_view release_version = "v676";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-signed-approval-template-signed-approval-policy-read-only\"" +
