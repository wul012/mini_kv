...
constexpr std::string_view release_version = "v507";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-archive-maintenance-verification-java-boundary-handoff-read-only\"" +
