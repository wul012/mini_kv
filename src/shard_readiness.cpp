...
constexpr std::string_view release_version = "v488";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-archive-maintenance-verification-source-ledger-contract-read-only\"" +
