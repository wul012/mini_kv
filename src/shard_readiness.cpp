...
constexpr std::string_view release_version = "v261";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v261",
        {
            ...
            {"historicalFallback=v260-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v261-v29-node-v549-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v261-v260-continuity-continuity-node-v549-final-closeout-package-audit-no-execution"},
        });
}
