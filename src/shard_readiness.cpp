...
constexpr std::string_view release_version = "v216";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v216",
        {
            ...
            {"historicalFallback=v215-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v216-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v216-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v216-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v216-v215-continuity-stage-descriptor-audit-no-execution"},
        });
}
