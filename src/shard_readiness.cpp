...
constexpr std::string_view release_version = "v232";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v232",
        {
            ...
            {"historicalFallback=v231-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v232-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v232-v231-continuity-node-v505-readiness-handoff-archive-verification-route-final-audit-no-execution"},
        });
}
