...
constexpr std::string_view release_version = "v229";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v229",
        {
            ...
            {"historicalFallback=v228-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v229-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v229-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v229-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v229-v228-continuity-node-v505-readiness-handoff-archive-verification-route-batch-package-no-execution"},
        });
}
