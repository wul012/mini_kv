...
constexpr std::string_view release_version = "v243";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v243",
        {
            ...
            {"historicalFallback=v242-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v243-v29-node-v522-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v243-v242-continuity-continuity-node-v522-downstream-consumption-handoff-no-execution"},
        });
}
