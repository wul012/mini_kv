...
constexpr std::string_view release_version = "v658";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-approval-template-no-execution-audit-read-only\"" +
