...
constexpr std::string_view release_version = "v220";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v220",
        {
            ...
            {"historicalFallback=v219-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v220-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v220-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v220-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v220-v219-continuity-v211-v219-batch-package-audit-no-execution"},
        });
}
