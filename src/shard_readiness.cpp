...
constexpr std::string_view release_version = "v246";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v246",
        {
            ...
            {"historicalFallback=v245-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v246-v29-node-v522-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v246-v245-continuity-continuity-node-v522-final-closeout-package-audit-no-execution"},
        });
}
