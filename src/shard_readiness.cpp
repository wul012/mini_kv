...
constexpr std::string_view release_version = "v234";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v234",
        {
            ...
            {"historicalFallback=v233-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v234-v29-node-v522-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v234-v233-continuity-continuity-node-v522-twenty-version-run-closeout-alignment-audit-no-execution"},
        });
}
