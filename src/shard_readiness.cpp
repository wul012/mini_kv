...
constexpr std::string_view release_version = "v228";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v228",
        {
            ...
            {"historicalFallback=v227-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v228-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v228-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v228-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v228-v227-continuity-node-v505-readiness-handoff-archive-verification-route-checkpoint-audit-no-execution"},
        });
}
