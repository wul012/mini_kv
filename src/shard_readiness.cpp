...
constexpr std::string_view release_version = "v648";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-approval-template-identity-field-policy-read-only\"" +
