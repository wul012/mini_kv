...
constexpr std::string_view release_version = "v238";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v238",
        {
            ...
            {"historicalFallback=v237-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v238-v29-node-v522-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v238-v237-continuity-continuity-node-v522-stability-archive-package-audit-no-execution"},
        });
}
