...
constexpr std::string_view release_version = "v612";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-precheck-source-envelope-contract-read-only\"" +
