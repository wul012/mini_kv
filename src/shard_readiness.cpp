...
constexpr std::string_view release_version = "v231";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v231",
        {
            ...
            {"historicalFallback=v230-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v231-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v231-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v231-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v231-v230-continuity-node-v505-readiness-handoff-archive-verification-route-closure-snapshot-no-execution"},
        });
}
