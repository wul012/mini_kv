...
constexpr std::string_view release_version = "v669";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-signed-approval-template-source-snippet-field-read-only\"" +
