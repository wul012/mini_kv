...
constexpr std::string_view release_version = "v227";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v227",
        {
            ...
            {"historicalFallback=v226-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v227-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v227-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v227-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v227-v226-continuity-node-v505-readiness-handoff-archive-verification-route-checkpoint-no-execution"},
        });
}
