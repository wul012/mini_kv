...
constexpr std::string_view release_version = "v495";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-archive-maintenance-verification-cli-smoke-contract-read-only\"" +
