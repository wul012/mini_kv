...
constexpr std::string_view release_version = "v209";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v209",
        {
            ...
            {"historicalFallback=v208-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v209-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v209-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v209-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v209-v208-continuity-release-catalog-no-execution"},
        });
}
