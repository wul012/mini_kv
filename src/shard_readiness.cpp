...
constexpr std::string_view release_version = "v242";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v242",
        {
            ...
            {"historicalFallback=v241-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v242-v29-node-v522-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v242-v241-continuity-continuity-node-v522-stability-closeout-audit-no-execution"},
        });
}
