...
constexpr std::string_view release_version = "v230";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v230",
        {
            ...
            {"historicalFallback=v229-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v230-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v230-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v230-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v230-v229-continuity-node-v505-readiness-handoff-archive-verification-route-batch-package-audit-no-execution"},
        });
}
