...
constexpr std::string_view release_version = "v195";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v195",
        {
            ...
            {"historicalFallback=v194-frozen-no-rolling-current"},
            {"archivedNodeEvidence=v370-v474-preserved"},
            ...
            {"boundaryCatalogIndex=v195-v23-route-catalog-cleanup-closeout-release-catalog-audit-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v195-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v195-window-span-count-parse-audit-no-execution"},
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           route_catalog_evidence_chain::format_route_catalog_cleanup_closeout_release_catalog_json() +
           ",\"nodeRouteCatalogCleanupCloseoutReleaseCatalogAudit\":" +
           route_catalog_evidence_chain::format_route_catalog_cleanup_closeout_release_catalog_audit_json() +
           ...
           ",\"notes\":" + json_string_array({
               ...
               "slot table is evidence, not active storage routing",
                ...
                "active shard prototype remains plan-prerequisite only",
                  "does not mutate Node v370-v474 archived evidence",
