...
constexpr std::string_view release_version = "v218";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v218",
        {
            ...
            {"historicalFallback=v217-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v218-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v218-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v218-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v218-v217-continuity-node-v498-consumer-readiness-handshake-package-audit-no-execution"},
        });
}
