...
constexpr std::string_view release_version = "v213";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v213",
        {
            ...
            {"historicalFallback=v212-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v213-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v213-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v213-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v213-v212-continuity-downstream-consumption-handshake-no-execution"},
        });
}
