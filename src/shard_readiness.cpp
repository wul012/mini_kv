...
constexpr std::string_view release_version = "v248";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v248",
        {
            ...
            {"historicalFallback=v247-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v248-v29-node-v549-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v248-v247-continuity-continuity-node-v549-archive-verification-alignment-no-execution"},
        });
}
