...
constexpr std::string_view release_version = "v655";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-approval-template-no-secret-storage-audit-read-only\"" +
