...
constexpr std::string_view release_version = "v257";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v257",
        {
            ...
            {"historicalFallback=v256-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v257-v29-node-v549-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v257-v256-continuity-continuity-node-v549-archive-files-consumption-handoff-audit-no-execution"},
        });
}
