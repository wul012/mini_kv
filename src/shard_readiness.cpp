...
constexpr std::string_view release_version = "v256";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v256",
        {
            ...
            {"historicalFallback=v255-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v256-v29-node-v549-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v256-v255-continuity-continuity-node-v549-archive-files-consumption-handoff-no-execution"},
        });
}
