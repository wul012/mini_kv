...
constexpr std::string_view release_version = "v520";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-worksheet-verification-shardjson-embedding-audit-read-only\"" +
