...
constexpr std::string_view release_version = "v611";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-precheck-requirement-catalog-split-read-only\"" +
