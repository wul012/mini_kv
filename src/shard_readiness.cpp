...
constexpr std::string_view release_version = "v512";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-worksheet-verification-source-verifier-contract-read-only\"" +
