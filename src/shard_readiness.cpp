...
constexpr std::string_view release_version = "v208";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v208",
        {
            ...
            {"historicalFallback=v207-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v208-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v208-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v208-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v208-v207-archive-verification-route-audit-no-execution"},
        });
}
