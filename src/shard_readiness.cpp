...
constexpr std::string_view release_version = "v258";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v258",
        {
            ...
            {"historicalFallback=v257-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v258-v29-node-v549-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v258-v257-continuity-continuity-node-v549-node-v550-route-exposure-readiness-no-execution"},
        });
}
