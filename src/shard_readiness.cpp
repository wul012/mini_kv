...
constexpr std::string_view release_version = "v239";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v239",
        {
            ...
            {"historicalFallback=v238-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v239-v29-node-v522-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v239-v238-continuity-continuity-node-v522-ci-catalog-health-snapshot-no-execution"},
        });
}
