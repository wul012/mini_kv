...
constexpr std::string_view release_version = "v496";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-archive-maintenance-verification-tcp-smoke-contract-read-only\"" +
