...
constexpr std::string_view release_version = "v1135";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":" +
           json_string(shard_preview_operator_value_supply_approval_profile_section::
                           operator_value_supply_approval_profile_section_status()) +
