...
constexpr std::string_view release_version = "v503";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-archive-maintenance-verification-no-router-audit-read-only\"" +
