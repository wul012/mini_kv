...
constexpr std::string_view release_version = "v500";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-archive-maintenance-verification-retention-audit-read-only\"" +
