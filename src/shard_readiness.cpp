...
constexpr std::string_view release_version = "v235";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v235",
        {
            ...
            {"historicalFallback=v234-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v235-v29-node-v522-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v235-v234-continuity-continuity-node-v522-stability-evidence-report-readiness-no-execution"},
        });
}
