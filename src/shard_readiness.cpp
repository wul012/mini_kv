...
constexpr std::string_view release_version = "v219";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v219",
        {
            ...
            {"historicalFallback=v218-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v219-v29-route-catalog-cleanup-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteSplitCompatibilityWindow=v219-node-v433-v472-route-catalog-cleanup-closeout-no-execution"},
            {"nodeRouteSplitCompatibilityWindowAudit=v219-window-span-count-parse-audit-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v219-v218-continuity-v211-v218-batch-package-no-execution"},
        });
}
