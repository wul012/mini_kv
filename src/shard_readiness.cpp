...
constexpr std::string_view release_version = "v595";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"evidencePath\":" + json_string(fixture_path()) +
                                                                                                                                    ",\"status\":\"route-preview-value-supply-envelope-shardjson-embedding-audit-read-only\"" +
