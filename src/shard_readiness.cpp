...
constexpr std::string_view release_version = "v487";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-archive-maintenance-verification-stage-chain-helper-read-only\"" +
