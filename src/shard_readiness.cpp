...
constexpr std::string_view release_version = "v672";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-signed-approval-template-redaction-policy-ack-read-only\"" +
