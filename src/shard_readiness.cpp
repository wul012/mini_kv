...
constexpr std::string_view release_version = "v640";
...
std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) +
           ...
           ",\"status\":\"route-preview-value-supply-approval-template-fixture-chain-audit-read-only\"" +
