...
constexpr std::string_view release_version = "v254";
...
std::string evidence_digest() {
    return runtime_evidence::digest(
        "mini-kv-shard-readiness-v254",
        {
            ...
            {"historicalFallback=v253-frozen-no-rolling-current"},
            ...
            {"boundaryCatalogIndex=v254-v29-node-v549-post-closeout-continuity-no-execution"},
            ...
            {"nodeRouteCatalogCleanupPostCloseoutContinuity=v254-v253-continuity-continuity-node-v549-live-smoke-boundary-reconfirmation-no-execution"},
        });
}
