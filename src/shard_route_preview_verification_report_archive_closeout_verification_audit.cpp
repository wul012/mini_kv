...
constexpr int current_archive_closeout_verification_audit_stage_count = 20;
...
constexpr std::array<StageRecord, planned_archive_closeout_verification_audit_stage_count>
...
std::string format_audit_stage_catalog_json() {
    return shard_route_preview_stage_catalog::format_stage_catalog_json(
        archive_closeout_verification_audit_stages, current_archive_closeout_verification_audit_stage_count);
}
...
std::string audit_digest_marker() {
    return shard_route_preview_stage_catalog::format_digest_marker(
        current_stage(),
        current_archive_closeout_verification_audit_stage_count,
        planned_archive_closeout_verification_audit_stage_count);
}
