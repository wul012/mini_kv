...
namespace slots =
    shard_route_preview_operator_value_supply_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_slots;
namespace stages =
...
constexpr int current_compared_package_evidence_intake_audit_stage_count = 20;
...
shard_route_preview_stage_chain::StageChainReport current_stage_chain_report() {
    return shard_route_preview_stage_chain::inspect_stage_chain(
        ...
        stages::
            planned_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_stage_count(),
        stages::
            first_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_release_number());
}

int completed_slot_count() { return (current_compared_package_evidence_intake_audit_stage_count + 1) / 2; }

int completed_guard_count() { return current_compared_package_evidence_intake_audit_stage_count / 2; }

} // namespace

std::string
format_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_stage_catalog_json() {
...
std::string format_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_json() {
    ...
    const bool source_comparison_closeout_audit_chain_complete =
        source_comparison_closeout_audit::published_stage_count() == 25;
    const int planned_slot_count = slots::
        planned_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_slot_count();
    const int planned_guard_count = guards::
    ...
    return "{\"contract\":\"shard-route-preview-operator-value-supply-signed-approval-capture-artifact-draft-text-"
           ...
           "\""
           ",\"signedApprovalCaptureArtifactDraftTextPackageComparedPackageEvidenceIntakeAuditMode\":\"controlled-read-"
           "only-disabled-compared-package-evidence-intake-audit\""
           ",\"sourceNodePlan\":" +
           json_string(source_node_plan) +
           ",\"sourceDraftTextPackageComparisonCloseoutAuditCommand\":"
           ...
           ",\"sourceDraftTextPackageComparisonCloseoutAuditFixturePath\":\"fixtures/release/"
           "shard-readiness-v860.json\""
           ...
           ",\"sourceDraftTextPackageComparisonCloseoutAuditChainComplete\":" +
           json_bool(source_comparison_closeout_audit_chain_complete) +
           ",\"sourceDraftTextPackageComparisonCloseoutAuditDigestMarker\":" +
           json_string(
               source_comparison_closeout_audit::
           ...
           ",\"draftTextPackageComparedPackageEvidenceIntakeAuditReleaseVersion\":" +
           json_string(stage.release_version) +
           ",\"sourceFrozenReleaseVersion\":" + json_string(stage.source_frozen_release_version) +
           ",\"sourceFrozenFixturePath\":" + json_string(stage.source_frozen_fixture_path) +
           ",\"signedApprovalCaptureArtifactDraftTextPackageComparedPackageEvidenceIntakeAuditReleaseRangeStart\":"
           "\"v861\""
           ...
           ",\"sourceAcceptancePrecheckEvidenceDeclared\":" +
           json_bool(slot_count >= 1) +
           ...
           ",\"moduleSplit\":[\"compared_package_evidence_intake_audit_core\",\"compared_package_evidence_intake_audit_"
           "stages\",\"compared_package_evidence_intake_audit_slots\",\"compared_package_evidence_intake_audit_"
           "guards\",\"compared_package_evidence_intake_audit_validation\"]"
           ",\"stageCatalog\":" +
           format_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_stage_catalog_json() +
           ",\"evidenceSlots\":" +
           slots::
               format_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_slots_json(
                   slot_count) +
           ",\"intakeGuards\":" +
           guards::
           ...
           validation::
               format_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_validation_json(
                   planned_slot_count, planned_guard_count, slot_count, guard_count,
                   source_comparison_closeout_audit_chain_complete,
                   current_compared_package_evidence_intake_audit_stage_count) +
           ",\"diagnostics\":" +
           json_string_array(
               {"Node v1331 compared package evidence intake plan is referenced as downstream contract context only",
...
std::string signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_digest_marker() {
    const int planned_stage_count = stages::
        planned_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit_stage_count();
    return shard_route_preview_stage_catalog::format_digest_marker(
        current_stage(), current_compared_package_evidence_intake_audit_stage_count, planned_stage_count);
}

int published_stage_count() { return current_compared_package_evidence_intake_audit_stage_count; }

} // namespace
  // minikv::shard_route_preview_operator_value_supply_signed_approval_capture_artifact_draft_text_package_compared_package_evidence_intake_audit