...
using internal::contract_version;
using internal::evidence_digest;
using internal::format_boundaries_json;
using internal::format_command_catalog_json;
using internal::format_command_catalog_quality_json;
using internal::json_string;
using internal::release_version;

} // namespace

std::string format_json() {
    return "{\"contract\":" + json_string(contract_version) + ",\"evidenceType\":\"shard_readiness\"" +
           ",\"project\":\"mini-kv\"" + ",\"version\":" + json_string(version) +
           ",\"releaseVersion\":" + json_string(release_version) + ",\"readOnly\":true" +
           ",\"executionAllowed\":false" + ",\"shardEnabled\":false" + ",\"shardCount\":1" +
           ",\"slotCount\":" + std::to_string(slot_preview::slot_count()) +
           ",\"routingMode\":\"single-shard-readiness-prototype\"" +
           ",\"evidencePath\":" + json_string(fixture_path()) + ",\"status\":" +
           json_string(
               shard_preview_f_folder_explanation_quality_closeout::f_folder_explanation_quality_closeout_status()) +
           ...
           ",\"shardRoutePreviewOperatorValueSupplySignedApprovalCaptureArtifactDraftTextPackageComparedPackageEvidence"
           "IntakeAudit\":" +
           ...
           ",\"shardPreviewCandidateDocumentRequestPackageCloseout\":" +
           ...
           ",\"shardReadinessReleaseCatalog\":" + release_catalog::format_release_catalog_json() +
           ",\"shardReadinessReleaseCatalogAudit\":" + release_catalog::format_release_catalog_audit_json() +
           ",\"boundaries\":" + format_boundaries_json() + ",\"diagnostics\":" + history::format_diagnostics_json() +
           ...
           ",\"shardReadinessHistoryMaintenance\":" + history::format_history_formatter_maintenance_json() +
           ...
           approval_inputs::format_canonical_approval_input_precheck_json() + ",\"nodeRouteGroupSplitCompatibility\":" +
           ...
           ",\"nodeRouteCatalogCloseoutSnapshot\":" + route_catalog_closeout::format_closeout_snapshot_json() +
           ",\"nodeRouteCatalogAnchorRemovalAudit\":" + route_catalog_closeout::format_anchor_removal_audit_json() +
           ...
           ",\"boundaryCatalogMaintenance\":" + boundary_fields::format_catalog_maintenance_json() +
           ",\"boundaryCatalogIndex\":" + boundary_fields::format_catalog_index_json() +
           ",\"readOnlyBoundaryFields\":" + boundary_fields::format_read_only_boundary_fields_json() +
