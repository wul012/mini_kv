...
constexpr std::string_view credential_resolver_runtime_role =
    "runtime evidence provider only";
...
std::string format_credential_resolver_non_participation_receipt_json(
    ...
    return "{\"receipt_version\":\"mini-kv-credential-resolver-non-participation-receipt.v1\","
           ...
           ",\"explicit_no_go_conditions\":[\"CREDENTIAL_VALUE_REQUIRED\","
           "\"RAW_ENDPOINT_URL_REQUIRED\",\"REAL_CONNECTION_REQUIRED\","
           "\"EXTERNAL_REQUEST_REQUIRED\",\"SCHEMA_MIGRATION_REQUIRED\","
           "\"UPSTREAM_WRITE_REQUIRED\",\"AUTO_START_REQUIRED\","
           "\"MINI_KV_BACKEND_REQUIRED\",\"PRODUCTION_WINDOW_REQUIRED\"]"
           ...
           ",\"read_only\":true,\"execution_allowed\":false,\"dry_run_only\":true,"
           "\"credential_resolver_decision_only\":true,\"credential_resolver_implemented\":false,"
           "\"credential_resolver_invoked\":false,\"secret_provider_instantiated\":false,"
           "\"node_auto_start_allowed\":false,\"java_auto_start_allowed\":false,"
           "\"mini_kv_auto_start_allowed\":false,\"external_audit_service_auto_start_allowed\":false,"
           "\"connection_execution_allowed\":false,\"write_commands_executed\":false,"
           "\"admin_commands_executed\":false,\"runtime_write_observed\":false,"
