...
std::string format_smoke_json(std::size_t live_keys,
    ...
    const std::vector<std::string> notes = {
        ...
        "credential_resolver_signed_human_approval_artifact_contract_non_participation_receipt",
        ...
        "v143 input-hardening receipt echoes mini-kv stable current receipt export and keeps runtime design blocked",
        "SMOKEJSON exposes credential_resolver_abort_rollback_semantics_contract_non_participation_receipt for Node v327",
        "v142 abort/rollback semantics contract receipt keeps rollback execution, Java SQL, mini-kv writes, and abort/rollback authority blocked",
        "SMOKEJSON exposes credential_resolver_no_network_safety_fixture_contract_non_participation_receipt for Node v324",
        "v141 no-network safety fixture contract receipt keeps HTTP/TCP/socket execution blocked and mini-kv non-authoritative",
        "read_only_aggregate",
    ...
    response += "},\"real_read\":{\"allowed\":true,\"commands\":" +
                ...
                runtime_evidence_receipts::
                    format_credential_resolver_human_approval_artifact_review_post_echo_decision_gate_non_participation_receipt_json(
                        read_commands) +
                ",\"credential_resolver_signed_human_approval_artifact_contract_non_participation_receipt\":" +
                runtime_evidence_receipts::format_credential_resolver_signed_human_approval_artifact_contract_non_participation_receipt_json(
                        read_commands) +
                ",\"credential_resolver_credential_handle_approval_contract_non_participation_receipt\":" +
                runtime_evidence_receipts::format_credential_resolver_credential_handle_approval_contract_non_participation_receipt_json(
                        read_commands) +
                ",\"credential_resolver_endpoint_handle_allowlist_approval_contract_non_participation_receipt\":" +
                runtime_evidence_receipts::format_credential_resolver_endpoint_handle_allowlist_approval_contract_non_participation_receipt_json(
                        read_commands) +
                ",\"credential_resolver_no_network_safety_fixture_contract_non_participation_receipt\":" +
                runtime_evidence_receipts::format_credential_resolver_no_network_safety_fixture_contract_non_participation_receipt_json(
                        read_commands) +
                ",\"credential_resolver_abort_rollback_semantics_contract_non_participation_receipt\":" +
                runtime_evidence_receipts::format_credential_resolver_abort_rollback_semantics_contract_non_participation_receipt_json(
                        read_commands) +
                ",\"credential_resolver_implementation_candidate_gate_input_hardening_non_participation_receipt\":" +
                runtime_evidence_receipts::
