...
- v1620: [990-version-1620-production-excellence-k5-archive-retention-inventory.md](990-version-1620-production-excellence-k5-archive-retention-inventory.md) - 完成 production-excellence K5 归档保留库存：新增 `docs/archive-retention-index.md` 和 `scripts/archive_inventory.py`，给 `a/`-`f/` 历史根建立冻结/活动状态与容量提醒，并在 CI 中以 warning-only 方式守住前向归档预算，同时撤掉 K4 后不再需要的 gcov negative-hits workaround。
