...
- `199-version-143-credential-resolver-input-hardening-candidate-gate-non-participation-receipt.md` - mini-kv v143 Node v329 implementation candidate gate input-hardening non-participation receipt, stable current receipt export, fixture, SMOKEJSON/manifest exposure, tests, CLI/TCP smoke, and `d/143` archive.
